...
Already enrolled in **Pradhan Mantri Fasal Bima Yojana (PMFBY)**? If your crop is damaged due to flood, drought, hailstorm, pest attack, or any natural calamity, you have the right to claim insurance money. But you must act fast — **crop loss must be reported within 72 hours** of the damage.
...
> **New to PMFBY?** First read our [complete guide to apply for PMFBY crop insurance](/guide/pmfby-crop-insurance-apply).
...
1. **Crop Insurance App** — Download the official app from Google Play Store. Click "Crop Loss" → fill details → upload photos of damaged crop → submit.
2. **PMFBY Portal** — Visit [pmfby.gov.in](https://pmfby.gov.in), log in with your registered mobile number, and file a crop loss intimation.
3. **Toll-Free Helpline** — Call **14447** (national PMFBY helpline) to report crop loss over phone.
4. **Insurance Company** — Contact your insurance company's local office or district branch directly.
5. **Bank Branch** — Visit the bank where your crop loan/insurance was processed.
6. **Agriculture Department** — Inform your local agriculture officer or patwari.
...
2. **Trained staff harvest a fixed area** (usually 5m × 5m) from selected plots during harvest season.
3. **Yield is measured and recorded** — this becomes the "actual yield" for that insurance unit.
4. **Actual yield is compared with threshold yield** — if actual yield is lower, ALL insured farmers in that unit get a claim.

### Threshold Yield Calculation

**Threshold Yield = Average yield of last 7 years (excluding best 2 and worst 2 years) × Indemnity Level**
...
**Example:** If threshold yield is 20 quintals/hectare, actual yield is 12 quintals, and your sum insured is ₹50,000:
- Shortfall = (20 − 12) ÷ 20 = 40%
- Claim amount = 40% × ₹50,000 = **₹20,000**
...
1. Go to [pmfby.gov.in](https://pmfby.gov.in)
...
**Reality check:** Payouts often take 3–6 months due to delayed crop cutting data submission by states. If your claim is delayed beyond 2 months, file a grievance.
...
- Visit [pmfby.gov.in/grievance](https://pmfby.gov.in/grievance)
...
- **IGMS (Insurance Grievance):** [igms.irda.gov.in](https://igms.irda.gov.in) — IRDAI's insurance complaint portal
- **CPGRAMS:** [pgportal.gov.in](https://pgportal.gov.in) — centralized public grievance system
...
1. **Late reporting** — Crop loss not reported within 72 hours. This is the most common reason.
2. **Non-notified crop** — The crop you grew wasn't notified for insurance in your area/season.
3. **Area yield above threshold** — For standing crops, if the area-level yield is above threshold, no individual claim is payable even if your personal farm had losses.
4. **Incorrect land records** — Mismatch between Khasra details in the application and actual records.
5. **Premium not paid** — Insurance premium was deducted but not remitted by the bank to the insurance company.
6. **Duplicate application** — Multiple applications for the same land parcel.
7. **Excluded peril** — Damage caused by war, nuclear risks, theft, or malicious acts isn't covered.
...
For other states, call the national helpline **14447** or check [pmfby.gov.in](https://pmfby.gov.in) for your state's insurance company contact.

---

## Tips to Ensure Your PMFBY Claim Succeeds

- **Save your enrollment receipt** — Keep the SMS/printout with your application number safe.
- **Report immediately** — Don't wait. Call 14447 or use the app within 72 hours.
- **Take photos** — Photograph damaged crops with date stamp. This is strong evidence.
- **Attend crop cutting** — If crop cutting happens on your field, be present and ensure fair recording.
- **Keep bank account active** — Claims are paid directly to your bank account. Ensure it's not frozen or dormant.
- **Follow up** — Check status every 2 weeks. If delayed beyond 2 months, file a grievance.

---

## Related Guides

- [How to Apply for PMFBY Crop Insurance](/guide/pmfby-crop-insurance-apply) — Enrollment process, premium rates, eligibility
- [PM-KISAN Samman Nidhi](/guide/pm-kisan-samman-nidhi) — Get ₹6,000/year direct benefit
- [Kisan Credit Card (KCC)](/guide/kisan-credit-card-apply) — Low-interest crop loans for farmers
- [Soil Health Card](/guide/soil-health-card-apply) — Free soil testing and crop recommendations
...
For standing crops, the claim is calculated using the formula: **(Threshold Yield − Actual Yield) ÷ Threshold Yield × Sum Insured**. The actual yield is determined through Crop Cutting Experiments at the insurance unit (village) level.

### How can I check my PMFBY claim status online?

Visit [pmfby.gov.in](https://pmfby.gov.in) and click "Claim Status." Enter your application number or registered mobile number. You can also check via the Crop Insurance mobile app or by visiting your bank branch.
