---
title: "GST TDS & TCS: Rules, Rates & Filing Guide for India"
description: >-
  Complete guide to GST TDS and TCS provisions covering who deducts, rates of
  2% and 1%, GSTR-7 and GSTR-8 filing, refund claims, and e-commerce rules.
...
> **Disclaimer:** CitizenNest is an independent informational platform and is not affiliated with or endorsed by the Government of India. Verify details on the [official GST portal](https://www.gst.gov.in/).

## GST TDS — Tax Deducted at Source (Section 51)

### Who Must Deduct GST TDS?

The following entities must deduct TDS when the **total contract value exceeds ₹2.5 lakh**:
...
> TDS is deducted on the **taxable value** (excluding GST amount). For example, if the invoice value is ₹1,18,000 (₹1,00,000 + ₹18,000 GST), TDS is deducted on ₹1,00,000 only.

### When to Deduct GST TDS

- Value of supply under a **single contract exceeds ₹2.5 lakh** (excluding tax)
...
| **Filing GSTR-7** | Monthly — due by **10th of the following month** |

#### How to File GSTR-7

1. Log in to [GST Portal](https://services.gst.gov.in/services/login)
2. Go to **Services → Returns → Returns Dashboard**
3. Select the return period and click **GSTR-7**
4. Fill **Table 3** — TDS details (GSTIN of deductee, invoice details, amount)
5. Fill **Table 4** — Amendments to previously filed details
...
| **Deposit** | Within **10 days** of the next month |
| **Filing GSTR-8** | Monthly — due by **10th of the following month** |
...
### E-Commerce TCS Provisions — Key Points

1. **Mandatory registration** — E-commerce operators must register under GST regardless of turnover
2. **Suppliers on platforms** — Must register under GST if selling through e-commerce (no threshold exemption for inter-state supplies)
3. **Net value calculation** — TCS = 1% of (total sales - returns) for the month
4. **TCS credit** — Suppliers can claim TCS credit in their **electronic cash ledger** after the e-commerce operator files GSTR-8
5. **Mismatch resolution** — If TCS details don't match supplier records, the supplier should raise the issue with the operator
...
2. Select refund type — "Excess balance in electronic cash ledger"
...
1. **Deductors: File GSTR-7 on time** — Late filing attracts interest at 18% per annum plus late fee
2. **Suppliers: Verify TDS/TCS credits** — Check your electronic cash ledger regularly for credited amounts
3. **E-commerce sellers: Reconcile TCS** — Match TCS shown in GSTR-8 with your sales records monthly
4. **Separate registration** — TDS deductors need registration under a specific TDS category (not regular GST)
5. **Keep contract records** — The ₹2.5 lakh threshold for TDS is per contract, not per invoice
