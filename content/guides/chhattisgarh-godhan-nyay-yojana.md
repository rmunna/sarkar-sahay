...
- **No income or caste restriction** — any cattle owner can participate
...
5. **Payment of ₹2 per kg** is credited to the seller's bank account via DBT
...
2. **Register as a cow dung seller** — provide your name, address, Aadhaar number, and cattle details
3. **Submit bank account details** for DBT payments
4. **Get a registration card/receipt** — this enables you to sell cow dung at the Gauthan
...
4. **Start operations** — procure cow dung, produce vermicompost, and sell organic products

## Documents Required

### For Cattle Owners
- **Aadhaar Card** (see our [Aadhaar guide](/guide/aadhaar-card-apply-online))
- **Bank account passbook** — Aadhaar-linked account for DBT
- **Address proof** — voter ID, ration card, or Aadhaar
...
| Item | Rate |
|---|---|
| Cow dung (from cattle owners) | ₹2 per kg |
| Vermicompost (sold to farmers) | ₹10 per kg (subsidized) |
...
- **Payment cycle:** Typically within 15–30 days of cow dung delivery
- **Minimum quantity:** No minimum — even small quantities are accepted
- **Payment tracking:** Through the Gauthan centre or online portal

## Benefits of Godhan Nyay Yojana

- **Additional income** for cattle owners — regular income from selling cow dung
- **Reduces stray cattle problem** — encourages owners to keep cattle rather than abandoning them
- **Promotes organic farming** — vermicompost improves soil health and reduces chemical fertilizer use
- **Women's empowerment** — SHGs earn income from Gauthan management and vermicompost sales
- **Environmental benefits** — reduces open dumping of cow dung and promotes sustainable agriculture
- **Rural employment** — creates jobs in vermicompost production, Gauthan management, and organic farming

## Important Tips

1. **Link your Aadhaar to your bank account** — all payments are through DBT; without Aadhaar-bank linking, you won't receive payment (see our [Aadhaar linking guide](/guide/aadhaar-linking-guide))
2. **Sell cow dung regularly** — the more you sell, the more you earn; maintain a routine collection schedule
3. **Check Gauthan collection days** — each Gauthan has specific days for cow dung procurement; confirm with your local centre
4. **Keep your registration active** — inform the Gauthan if you change address or bank account
5. **Women SHGs can earn more** — by managing Gauthans and selling vermicompost, SHGs can earn significantly beyond just cow dung sales

## Frequently Asked Questions

### Q1. How much do cattle owners get paid for cow dung?
Cattle owners receive ₹2 per kg of cow dung sold at the designated Gauthan centre. Payment is credited directly to their bank account via DBT.
...
Payment is typically credited within 15–30 days of selling cow dung at the Gauthan. Ensure your bank account is active and Aadhaar-linked for timely payments.

---

*Last updated: February 2026. Information is based on officially available data. Always verify current details on the [Godhan Nyay Yojana portal](https://godhannyay.cgstate.gov.in) before registering.*
