...
# Banking Exam Preparation Guide — IBPS, SBI, RBI
...
## RBI Grade B — The Premium Banking Exam
...
Starting salary is approximately ₹77,208 per month (as per 2024 revision). This is one of the highest among banking jobs.
...
**Topics to focus on:**
1. Number Series, Simplification, Approximation
2. Data Interpretation (tables, pie charts, bar graphs, line graphs)
3. Arithmetic — Percentage, Profit & Loss, SI/CI, Time & Work, Time & Distance
4. Quadratic Equations, Inequalities

**Tips:**
- Learn shortcuts and tricks for calculation
- Practice 30-50 DI sets before the exam
- Speed is key — aim for 70-80% accuracy with full attempts
- Use approximation techniques for large calculations

### Reasoning Ability

**Key topics:**
1. Seating Arrangement (linear and circular)
2. Puzzles (floor-based, scheduling, comparison)
3. Syllogism, Blood Relations, Direction Sense
4. Coding-Decoding, Input-Output
5. Inequality, Order and Ranking
...
- Time yourself — reasoning is the most time-consuming section

### English Language

**Key areas:**
1. Reading Comprehension (most questions come from RC)
...
**What to cover:**
1. Current affairs of last 3-6 months
2. Banking terms and concepts (CRR, SLR, Repo Rate, MCLR, etc.)
3. Important financial organisations (IMF, World Bank, ADB, etc.)
4. Government schemes and policies
5. Static GK — headquarters, currencies, national parks, awards

**Tips:**
- Read monthly banking awareness compilations
- Follow RBI policy announcements
- Make short notes of current affairs monthly
- Banking awareness is a high-scoring section — don't neglect it
...
| General Awareness | Monthly magazines + newspapers | — |
...
- **Testbook** — Mock tests and practice questions
- **Oliveboard** — Banking-specific mock tests
- **Adda247 (Bankersadda)** — Study material and test series
- **Gradeup (BYJU'S Exam Prep)** — Free and paid resources
- **YouTube channels** — Study IQ, Adda247, Unacademy for free lectures

## How to Apply for Banking Exams

1. Visit the official website (ibps.in, sbi.co.in/careers, or rbi.org.in)
2. Register when the notification is released
3. Fill application form with personal and educational details
4. Upload photo and signature
5. Pay application fee (₹175-850 depending on exam and category)
6. Submit and save confirmation page

For detailed application steps, see our [guide to applying for government jobs online](/guide/how-to-apply-government-jobs-online).

## Frequently Asked Questions

### What is the salary of a bank PO?

IBPS PO starting salary is approximately ₹52,000-₹55,000 per month (including DA and HRA in metro cities). SBI PO starting salary is slightly higher at ₹56,000-₹60,000 per month.
...
*Banking exams offer excellent career opportunities with good salary and growth. Start early, practice mock tests, and stay updated with current affairs. Explore [SSC exams](/guide/ssc-exam-complete-guide) and [UPSC preparation](/guide/upsc-civil-services-preparation-guide) for more government job options.*
