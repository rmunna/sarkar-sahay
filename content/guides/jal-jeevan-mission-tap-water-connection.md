...
keywords:
  ...
  - "har ghar jal tap water connection"
  - "jal jeevan mission rural household"
  - "jaljeevanmission.gov.in"
  - "free water connection rural india"
  - "jal jeevan mission eligibility"
  - "tap water connection gram panchayat"
  - "jjm water supply village"
  - "nal jal yojana apply"
...
**Jal Jeevan Mission (JJM)** — also called **Har Ghar Jal (Water to Every Home)** — is the Government of India's flagship scheme to provide **tap water (piped water supply)** to every rural household by 2024. It provides a **Functional Household Tap Connection (FHTC)** with at least **55 litres per person per day** of potable water.
...
1. Go to **[jaljeevanmission.gov.in](https://jaljeevanmission.gov.in)**
2. Click **"Dashboard"**
3. Select your state → district → block → village (Gram Panchayat)
...
JJM connections are provided **by the state government / district administration** — there is no individual online application. Here's how to get one:

### Step 1: Check Village Status

Verify if water supply infrastructure has been built in your village via [jaljeevanmission.gov.in](https://jaljeevanmission.gov.in).
...
File a grievance at [jaljeevanmission.gov.in](https://jaljeevanmission.gov.in) → "Feedback / Grievance" section.
...
- Connection is **free** — no connection fee for BPL households; nominal fee in some states for non-BPL

## Gram Panchayat Water User Fees

After the connection is given, **minor water usage charges** (called "water tariff") may be collected by the Gram Panchayat to maintain the water supply system. Rates are very nominal — typically **₹30–₹100/month**. This is not a scheme fee but a maintenance contribution.
...
- Results uploaded to [ejalshakti.gov.in](https://ejalshakti.gov.in)
...
Contact the **District Jal Jeevan Mission Coordinator** — tribal habitations have explicit priority under JJM. You can also register a complaint on the JJM portal.

### Is JJM only for rural areas?
Yes — JJM-Gramin is for rural areas. Urban water supply is handled under **AMRUT 2.0** by the Ministry of Housing and Urban Affairs.
...
- Village-level status: [jaljeevanmission.gov.in](https://jaljeevanmission.gov.in)
- eJal Shakti portal: [ejalshakti.gov.in](https://ejalshakti.gov.in)
- Ministry of Jal Shakti: [jalshakti.gov.in](https://jalshakti.gov.in)
- Helpline: 1916 (Jal Shakti Ministry helpline)
- Contact: Gram Panchayat → BDO → District JJM Coordinator
