---
title: "Rainwater Harvesting Subsidy — Government Incentives & How to Apply"
description: "Learn about rainwater harvesting subsidies and government incentives in India. Step-by-step guide to apply for RWH schemes and save on water bills."
category: "Utilities"
keywords:
  - rainwater harvesting subsidy
  - rain water harvesting scheme
  - water conservation incentive india
...
# Rainwater Harvesting Subsidy — Government Incentives & How to Apply
...
This guide covers everything you need to know about rainwater harvesting subsidies in India — who is eligible, how much you can save, and how to apply.

> **Disclaimer:** CitizenNest is an independent informational website and is not affiliated with any government department or agency. Subsidy schemes vary by state and municipality — always verify with your local authorities.
...
- **Rooftop rainwater harvesting** — collecting rain from your building's roof through pipes, filters, and storage tanks
- **Groundwater recharge** — directing rainwater into recharge pits, bore wells, or percolation tanks to replenish underground aquifers
...
- **Jal Shakti Abhiyan** — promotes water conservation including RWH in water-stressed districts
- **Atal Bhujal Yojana** — focuses on groundwater management with community-based RWH in 7 states
- **AMRUT 2.0** — encourages RWH in urban areas as part of water supply planning
- **MGNREGA** — funds can be used for constructing RWH structures in rural areas
...
- Property tax rebates (5–30% discount)
...
### Rajasthan
- Subsidy of up to **₹50,000–₹1,00,000** for constructing RWH structures in rural areas (under various state schemes)
...
- The system must be **functional and maintained** — subsidies may be revoked for non-functional installations
...
|---|---|
| Basic rooftop RWH (filter + storage tank) for small house | ₹5,000–₹15,000 |
| Medium system with underground sump (2,000–5,000 litres) | ₹15,000–₹50,000 |
| Large system for apartment complex or institution | ₹50,000–₹3,00,000 |
| Recharge pit or bore well recharge system | ₹10,000–₹30,000 |

### Government Support

- **Direct subsidies:** ₹5,000 to ₹1,00,000 depending on state and scheme
- **Property tax rebate:** 5–30% annual discount
- **Water bill rebate:** 5–10% discount on monthly water charges
...
- Some municipalities charge a nominal inspection fee of ₹100–₹500
...
| Technical inspection | 1–2 weeks |
| Subsidy approval | 2–6 weeks |
| Subsidy credit to bank | 30–60 days |
...
1. **Start small** — even a basic filter and storage tank system costs under ₹10,000 and can save thousands in water bills annually.

2. **Get a professional design** — a well-designed system based on your roof area and local rainfall will be much more effective. Many municipalities offer free design consultations.

3. **Use quality filters** — the first-flush diverter and filter are crucial. Without them, your stored water will contain debris and pollutants.

4. **Maintain regularly** — clean filters, gutters, and tanks at least twice a year (before and after monsoon). A neglected system stops working.

5. **Combine with bore well recharge** — if you have a bore well, connecting your RWH system to recharge the bore well improves groundwater levels and ensures long-term water availability.

6. **Document everything** — take before and after photos, keep all invoices, and get a completion certificate. These are needed for subsidy claims.

7. **Check mandatory requirements** — in many cities, RWH is already mandatory. Installing it proactively avoids penalties and earns you rebates.

8. **Involve your housing society** — for apartments, a society-level RWH system is more cost-effective and has higher impact. Many subsidies are specifically for group housing.
...
A basic rooftop RWH system for a small house costs ₹5,000 to ₹15,000. Medium systems with underground storage tanks cost ₹15,000 to ₹50,000. Government subsidies can cover 30–100% of the cost depending on your location and scheme.
...
Yes, many municipalities offer property tax rebates of 5–30% for buildings with functional RWH systems. Chennai, Bangalore, Delhi, Pune, and Ahmedabad are among the cities that offer this benefit. Check with your local municipal corporation.
