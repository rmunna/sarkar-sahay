...
readingTime: "8 min"
officialLinks:
  - https://mmsy.hp.gov.in
  - https://emerginghimachal.hp.gov.in
  - https://hpindustries.nic.in
---
...
> **Note:** A unit can avail subsidy under only one scheme — either state or central. You cannot claim MMSY subsidy if you have already received a subsidy under [PM MUDRA Yojana](/guide/pm-mudra-yojana-loan) or [Startup India Seed Fund](/guide/startup-india-seed-fund) for the same project.
...
> The government periodically adds new activities to the list. Check the [official MMSY portal](https://mmsy.hp.gov.in) for the latest list.

## How to Apply — Step-by-Step

### Online Application (Recommended)

1. **Visit** the official portal at [mmsy.hp.gov.in](https://mmsy.hp.gov.in)
2. **Register** using your Aadhaar number and mobile number
3. **Fill** the online application form with personal and business details
4. **Upload** required documents (scanned copies)
5. **Prepare** a Preliminary Project Report (PPR) showing capital expenditure, machinery cost, and working capital
6. **Submit** the application online
7. **Track** your application status through the same portal

### Offline Application

1. Visit the **District Industries Centre (DIC)** in your district
2. Collect the application form from the General Manager (GM) office
3. Fill the form and attach all required documents
4. Submit the completed form at the DIC office
5. The DIC will sponsor your proposal to the bank for loan sanction
...
1. **Application** → You apply online or through DIC
2. **Screening** → DIC reviews your project report
3. **Bank Sponsorship** → DIC forwards proposal to the bank
4. **Loan Sanction** → Bank sanctions the loan
5. **First Subsidy (60%)** → Released after loan sanction
6. **Start Business** → Set up your unit and begin production
7. **Verification** → DIC verifies unit and production
8. **Second Subsidy (40%)** → Released after successful verification
9. **Interest Subsidy** → 5% interest refund for 3 years on the loan
...
| **Official Portal** | [mmsy.hp.gov.in](https://mmsy.hp.gov.in) |
...
You cannot claim MMSY subsidy if you have already availed a subsidy under another government scheme for the **same business unit**. However, if it is a different enterprise, you may be eligible. Check with your District Industries Centre for clarity. Also see our [PM MUDRA Yojana guide](/guide/pm-mudra-yojana-loan) for details.
...
No. A unit can avail subsidy under only **one scheme** — either a state government or central government scheme. You need to choose between MMSY and schemes like [Startup India Seed Fund](/guide/startup-india-seed-fund).

## Related Schemes

If MMSY does not fit your needs, explore these alternatives:

- **[PM MUDRA Yojana](/guide/pm-mudra-yojana-loan)** — Collateral-free loans up to ₹20 lakh for micro and small businesses across India
- **[Startup India Seed Fund](/guide/startup-india-seed-fund)** — Up to ₹50 lakh for startups for proof of concept and prototype development

---

*Disclaimer: This guide is for informational purposes only. Scheme rules, subsidy rates, and eligibility criteria may change. Always verify the latest details on the [official MMSY portal](https://mmsy.hp.gov.in) or contact your nearest District Industries Centre before applying. CitizenNest is not affiliated with the Government of Himachal Pradesh.*
