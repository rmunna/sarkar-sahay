...
1. Aadhaar card of all family members — [apply for Aadhaar](/guide/aadhaar-card-apply-online) if you don't have one
2. Income certificate from Tehsildar or local authority
3. Address proof (voter ID, electricity bill, or rent agreement)
4. Passport-size photographs of the head of the family
5. Caste certificate (if applicable)
6. Bank passbook copy
7. Self-declaration of assets and income
...
2. Navigate to "Apply for Ration Card" or "New Ration Card" section
3. Select card type as "BPL" or "Priority Household (PHH)"
4. Fill in family details — head of household, members, income, address
5. Upload scanned copies of required documents
6. Submit the application and note down the reference number
7. A field officer will visit your home for verification
8. Once verified, the BPL card is issued within 15–30 days

### Offline Process

1. Visit your nearest Tehsil office, Block Development Office, or Food & Civil Supplies office
...
6. After verification, your BPL card will be issued

## How to Check BPL List

You can check whether your name appears in the BPL list:

1. **Online:** Visit [nfsa.gov.in](https://nfsa.gov.in) → click on "Know Your Ration Card Details" → select state, district, and block → search your name
2. **By Ration Card Number:** Enter your existing ration card number on your state PDS portal
3. **Offline:** Visit the Gram Panchayat office or Block office and check the BPL list displayed on the notice board

## Benefits of BPL Card

- **Subsidised food grains** — rice, wheat, sugar, kerosene at very low prices
- **Free ration** under [PM Garib Kalyan Anna Yojana](/guide/pm-garib-kalyan-anna-yojana) during special schemes
...
- Ensure your [Aadhaar card](/guide/aadhaar-card-apply-online) is linked to your ration card for seamless benefits
- If you migrate to another state, you can use [One Nation One Ration Card (ONORC)](/guide/one-nation-one-ration-card-onorc) to collect rations anywhere in India
...
Aadhaar is required for authentication and to receive rations through PDS. If you don't have Aadhaar, [apply for it first](/guide/aadhaar-card-apply-online).
