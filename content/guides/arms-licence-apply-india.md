...
Owning a firearm in India is a regulated privilege, not a right. The **Arms Act, 1959** and **Arms Rules, 2016** govern the possession, carrying, and use of firearms across the country. Every individual who wishes to own a gun must obtain an arms licence from the licensing authority — typically the **District Magistrate (DM)** or **Commissioner of Police (CP)** in metropolitan areas. This guide covers everything you need to know about applying for an arms licence in India.
...
- **Shotguns** — 12 bore single barrel or double barrel (DBBL)
- **Rifles** — .22 LR, .315, .30-06
- **Revolvers/Pistols** — .32 revolver, .22 pistol (when classified as NPB)
...
- **Possession Licence** — Allows you to keep the firearm at your registered address only. You cannot carry it outside.
- **Carrying Licence** — Allows you to carry the firearm on your person within the jurisdictions specified on the licence.
...
- **Mental fitness:** Must be of sound mind — no history of mental illness
- **Criminal record:** No criminal conviction or pending criminal cases. A clean [police clearance certificate](/guide/police-clearance-certificate-apply) strengthens your application.
- **No prohibition order:** Must not be prohibited from owning arms under any court order
- **Genuine reason:** Must demonstrate a valid need — self-defence, crop protection, sport shooting, or professional requirement
...
1. **Application form** — Available at the DM/CP office or downloadable from your state's ALIS portal
2. **[Aadhaar Card](/guide/aadhaar-card-apply-online)** — For identity and address verification
3. **Address proof** — Voter ID, utility bill, ration card, or passport
4. **Age proof** — Birth certificate, 10th marksheet, or passport
5. **Passport-size photographs** — 4 to 6 recent photos
6. **[Income certificate](/guide/income-certificate-online)** or IT return — To demonstrate financial capacity
7. **Affidavit** — Self-declaration on non-judicial stamp paper stating:
   - No criminal record
   - No mental illness
   - Genuine reason for requiring a firearm
8. **Threat perception report** (if applying on self-defence grounds) — FIR copies or police complaints as evidence
...
## Arms Licence Application Process — Step by Step

### Step 1: Obtain the Application Form

- Download from the **National Database of Arms Licences (NDAL-ALIS)** portal at [ndal-alis.gov.in](https://ndal-alis.gov.in/)
...
- **Character and antecedent verification** — Police visit your residence and neighbourhood
- **Criminal record check** — Verification through CCTNS (Crime and Criminal Tracking Network and Systems)
...
|---|---|---|
| **Fresh licence application** | ₹100 – ₹500 | ₹500 – ₹1,000 |
| **Licence grant fee** | ₹500 – ₹2,000 | ₹2,000 – ₹5,000 |
| **Renewal fee** | ₹200 – ₹500 | ₹500 – ₹1,500 |
| **Duplicate licence** | ₹500 | ₹500 – ₹1,000 |
| **Endorsement / variation** | ₹200 – ₹500 | ₹500 |
...
- **Use only at designated locations** — do not fire in public places
- **Report change of address** to the licensing authority within 30 days
- **Carry ammunition within limits** — the licence specifies maximum ammunition you can possess
...
1. **Apply 90 days before expiry** — Submit renewal application to the licensing authority
2. **Attach documents:**
   - Original licence
...
3. **Police verification** — A fresh verification may be conducted
4. **Renewed licence issued** — Usually within 30 to 60 days
...
## Prohibited Bore (PB) Licence — Special Procedure

PB licence applications follow a more stringent process:

1. **Apply to the DM/CP** with all standard documents plus additional threat perception evidence
2. The DM/CP forwards the application with their recommendation to the **Home Department of the State Government**
3. The State Government forwards it to the **Ministry of Home Affairs (MHA)**, New Delhi
4. MHA reviews and either **approves or rejects** the application
5. If approved, the MHA issues an authorisation and the DM/CP grants the licence
...
- Accessible at [ndal-alis.gov.in](https://ndal-alis.gov.in/)

---

## Important Tips for Applicants

- **Genuine reason matters most** — Vague reasons like "hobby" may lead to rejection. Be specific about threat perception or crop protection needs.
- **Clean record is essential** — Even dismissed cases may cause delays. Obtain your [police clearance certificate](/guide/police-clearance-certificate-apply) beforehand.
- **Proper storage setup** — Have your gun safe installed before the police verification visit.
- **Ammunition limit** — You can typically possess 25 cartridges at any time (varies by licence conditions).
- **Maximum weapons** — An individual can hold licences for a maximum of **2 firearms** (reduced from 3 after the 2019 Arms Amendment Act).
- **Arms Amendment Act, 2019** — Increased penalties for illegal arms, reduced weapon limit to 2, and added stricter provisions for arms trafficking.
...
Yes, many states have enabled online applications through the **NDAL-ALIS portal** at [ndal-alis.gov.in](https://ndal-alis.gov.in/). However, document submission and verification still require physical visits in most districts.
