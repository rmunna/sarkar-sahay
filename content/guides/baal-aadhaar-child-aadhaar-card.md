...
- **No biometrics** (fingerprints or iris scan) are collected — only a **facial photograph** of the child is taken
...
### For the Parent
- **Aadhaar card of one parent** (mother or father) — this is mandatory
- The parent whose Aadhaar is provided **must be physically present** at the centre

### Important Points
- No address proof of the child is needed — the address is taken from the parent's Aadhaar
- If neither parent has Aadhaar, the parent must first get their own Aadhaar card. See: [How to apply for Aadhaar card](/guide/aadhaar-card-apply-online)
...
**Step 1: Find Your Nearest Aadhaar Enrolment Centre**
Visit [https://appointments.uidai.gov.in](https://appointments.uidai.gov.in) to locate an Aadhaar centre near you. You can also book an appointment online to avoid long queues.

**Step 2: Visit the Centre with Your Child**
Carry the child along with the required documents (birth certificate + parent's Aadhaar). The parent whose Aadhaar is being linked **must be present**.

**Step 3: Fill the Enrolment Form**
At the centre, you will be given an Aadhaar Enrolment/Update Form. Fill in the child's details:
...
The operator will verify the birth certificate and parent's Aadhaar.

**Step 5: Photo Capture**
Only a **facial photograph** of the child will be taken. No fingerprint or iris scan is done for children below 5 years.

**Step 6: Collect Acknowledgement Slip**
You will receive an **Enrolment ID (EID)** on the acknowledgement slip. Keep this safe — you will need it to track your Aadhaar status and download e-Aadhaar.

**Step 7: Receive Aadhaar**
Your child's Baal Aadhaar will be generated and sent to the registered address within **60–90 days**. You can also download it online once it's ready.

### Fees

- **First-time enrolment: FREE** (no charges at all)
- Any update after enrolment: ₹50 (for demographic or biometric updates)
...
3. Enter the child's **Aadhaar number, Enrolment ID, or Virtual ID**
4. Enter the **OTP** sent to the parent's registered mobile number
5. Download the e-Aadhaar PDF

**Password to open the PDF:** First 4 letters of the child's name (in CAPS) + year of birth (YYYY).
For example, if the child's name is ARJUN and birth year is 2024, the password is **ARJU2024**.

You can also download Aadhaar using the **mAadhaar mobile app** available on Android and iOS.

> **Related:** For detailed download steps, see [Download e-Aadhaar](/guide/download-e-aadhaar-card-online).
...
- The Aadhaar number **remains the same** — only the biometrics are added

### How to Update at Age 5
1. Visit any Aadhaar Enrolment Centre
2. Carry the child's existing Aadhaar card
3. The operator will capture biometrics and update the photo
4. **Fee:** ₹50 for biometric update

> ⚠️ **If you don't update biometrics at age 5, the child's Aadhaar may stop working for authentication-based services.**
...
- **All biometrics are recaptured** — fingerprints, iris, and photograph
...
1. The child (now a teenager) can visit the Aadhaar centre themselves
2. Carry the existing Aadhaar card
3. **Fee:** ₹50 for biometric update
...
### Online Correction
1. Visit [https://myaadhaar.uidai.gov.in](https://myaadhaar.uidai.gov.in)
2. Log in using the child's Aadhaar number and OTP (sent to parent's mobile)
3. Select **"Update Demographics"**
4. Upload supporting documents (birth certificate for name/DOB correction)
5. Pay ₹50 online
6. Submit and track the status
...
> **Related:** For name corrections, see our detailed guide on [Aadhaar name correction](/guide/aadhaar-name-correction-online).
...
You can correct it online at [myaadhaar.uidai.gov.in](https://myaadhaar.uidai.gov.in) or visit an Aadhaar centre. You'll need to submit the birth certificate as proof. Fee: ₹50.
...
Typically **60 to 90 days**. You can track the status using your Enrolment ID at [myaadhaar.uidai.gov.in](https://myaadhaar.uidai.gov.in). The e-Aadhaar is usually available for download within 2–3 weeks.
