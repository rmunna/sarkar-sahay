...
# Kerala PSC Exam Guide — Kerala Public Service Commission
...
- **Kerala Administrative Service (KAS)** — The premier state civil service exam
- **Secretariat Assistant / Auditor** — Popular graduate-level posts
- **Village Field Assistant / Last Grade Servant** — Entry-level government posts
- **Police Constable / SI** — Kerala Police recruitment
- **Teacher Recruitment** — PSC conducts teacher appointments for government schools
- **Technical Posts** — Engineers, doctors, and specialists
...
**Note:** KAS has an upper age limit of 40 years (General). Some posts like Last Grade Servant have 18–36 years.
...
- Descriptive type — Total: 1000 marks
- Interview: 50 marks
...
- 100 questions — 100 marks — 1.25 hours
...
- Kerala history — from Chera dynasty to modern state
- Kerala geography, backwaters, Western Ghats
- Kerala development model — literacy, health indicators
- State government schemes and programmes
- Kerala art, culture, and festivals

## How to Apply

1. Visit [thulasi.psc.kerala.gov.in](https://thulasi.psc.kerala.gov.in) — the one-time registration portal
...
4. Once profile is verified, browse current notifications on [keralapsc.gov.in](https://www.keralapsc.gov.in)
5. Click "Apply Now" against the desired notification
6. Confirm your application — no separate fee payment needed
...
- **Application Window:** Usually 30–45 days from notification
- **Exam Date:** 3–12 months after notification (varies by post)
- **Results:** 2–6 months after exam
...
| Kerala Renaissance | A Sreedhara Menon — Kerala History |
| Indian Polity | M. Laxmikanth — Indian Polity |
| General Science | Lucent's General Knowledge |
| Mental Ability | R.S. Aggarwal — Reasoning |
...
For most posts, you need to be a native of Kerala or have resided in Kerala for a specified period. Some posts may be open to all Indian citizens — check the specific notification.
