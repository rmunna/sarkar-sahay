...
> **Related:** Check our guides on [UPSC Civil Services](/guide/upsc-civil-services-preparation-guide) and [SSC CGL](/guide/ssc-exam-complete-guide) for other competitive exams.
...
The questions cover the entire MBBS curriculum across all 19 subjects. There is no sectional time limit — candidates can navigate freely between questions during the exam.
...
1. **Visit the official website** — Go to [nbe.edu.in](https://nbe.edu.in) when the notification is released.
2. **Register** — Create an account with your email and mobile number.
3. **Fill the application form** — Enter personal details, MBBS qualification details, and internship information.
4. **Upload documents** — Upload photograph, signature, and required certificates as per specifications.
5. **Pay the application fee** — General/OBC candidates pay around ₹4,250; SC/ST/PwD candidates pay around ₹3,250 (fees may vary each year).
6. **Download admit card** — The admit card is released 1-2 weeks before the exam on the NBEMS website.
...
- **A dedicated MCQ preparation resource** — platforms like Marrow, PrepLadder, or DAMS provide structured video lectures and question banks.
- **Previous year questions** — solving past NEET PG papers is essential.
...
- Analyse every test — focus on weak areas and repeated mistakes.
...
- Conducted by the **Medical Counselling Committee (MCC)** at [mcc.nic.in](https://mcc.nic.in).
...
- Usually conducted in **4 rounds** — Round 1, Round 2, Mop-Up, and Stray Vacancy.
...
2. **Fill choices** — Select colleges and branches in order of preference.
3. **Seat allotment** — Based on NEET PG rank, category, and preferences.
4. **Report to allotted college** — Pay fees and complete admission within the given deadline.

**Tip:** Fill as many choices as possible during counselling. Be strategic — research college reputation, location, and branch availability before locking preferences.

## Important Tips

1. **Start early** — Begin preparation during internship itself. Even 1-2 hours daily during internship builds a strong foundation.
2. **Focus on revision over new topics** — In the last 2 months, do not start any new subject. Revise what you already know.
3. **Master high-yield subjects first** — Medicine, Surgery, OBG, Pharmacology, and PSM together account for a large chunk of questions.
4. **Don't skip negative-marking strategy** — In the exam, skip questions you are completely unsure about. Even a 50-50 guess is statistically worth attempting.
5. **Keep your documents ready** — Ensure your internship completion certificate, NMC/state registration, and other documents are ready well before counselling starts.
6. **Stay updated on notifications** — Follow the NBEMS website and MCC portal regularly for schedule changes and updates.
7. **Take care of your health** — Eat well, sleep 7+ hours, and exercise. PG preparation is a marathon, not a sprint.
...
*Disclaimer: This guide is for informational purposes only. Exam patterns, eligibility criteria, and counselling rules may change. Always refer to the official NBEMS website ([nbe.edu.in](https://nbe.edu.in)) and MCC portal ([mcc.nic.in](https://mcc.nic.in)) for the latest and most accurate information.*
