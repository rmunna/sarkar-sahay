...
## Why Surrender a Ration Card?

There are several situations where you may need to surrender your ration card:

- **Economic improvement** — your family no longer qualifies for subsidized rations
- **Duplicate card** — you have more than one ration card (which is illegal)
- **Migration** — you've permanently moved to another state and want a new card there
- **Family split** — household has divided and members need separate cards
- **Death of all members** — all listed members have passed away
- **Voluntary surrender** — you no longer wish to use PDS services
- **Government directive** — ineligible persons asked to surrender during verification drives

Surrendering a ration card you don't need or aren't eligible for is a **civic responsibility** — it frees up resources for genuinely needy families.

## Step-by-Step Surrender Process

### Online Surrender (Available in Most States)

1. **Visit your state's PDS portal** (search "[your state] ration card surrender online")
2. Log in or register on the portal
3. Navigate to **"Surrender Ration Card"** or **"Cancel Ration Card"** option
4. Enter your ration card number
5. Select the reason for surrender from the dropdown
6. Upload required documents (Aadhaar, ration card copy)
7. Submit the application
8. Note the acknowledgment number
9. Your card will be deactivated after verification (usually within 15-30 days)

### Offline Surrender

1. Visit your **Tehsil / Taluk Food & Civil Supplies Office**
2. Collect the **ration card surrender form** (or write a plain application)
3. Fill in the form with:
   - Ration card number
   - Names of all family members on the card
   - Reason for surrender
   - Your contact details
4. Attach a **photocopy of the ration card**
5. Attach **Aadhaar card copy** of the head of family
6. Submit the **original ration card** (physical card)
7. Collect the **acknowledgment receipt**
8. The card is cancelled and removed from the PDS database
...
| State | Portal |
|-------|--------|
| Tamil Nadu | [tnpds.gov.in](https://tnpds.gov.in) |
| Karnataka | [ahara.kar.nic.in](https://ahara.kar.nic.in) |
| Maharashtra | [mahafood.gov.in](https://mahafood.gov.in) |
| Uttar Pradesh | [fcs.up.gov.in](https://fcs.up.gov.in) |
| Kerala | [civilsupplieskerala.gov.in](https://civilsupplieskerala.gov.in) |
| Andhra Pradesh | [epdsap.ap.gov.in](https://epdsap.ap.gov.in) |
| Telangana | [epds.telangana.gov.in](https://epds.telangana.gov.in) |
| West Bengal | [wbpds.gov.in](https://wbpds.gov.in) |
| Rajasthan | [food.rajasthan.gov.in](https://food.rajasthan.gov.in) |
...
- If one member dies, **don't surrender** — instead, apply for name deletion
...
- **Keep the acknowledgment receipt** — this is proof that you surrendered; important if questions arise later
- **Surrender before applying for a new card** — most states require no existing card when applying for a new one
- **Don't sell or transfer your card** — this is illegal; surrender through proper channels only
- **Check your FPS allocation is cancelled** — after surrender, verify that your name no longer appears at the FPS
- **Inform your family** — ensure all members know the card has been surrendered so no one attempts to use it
