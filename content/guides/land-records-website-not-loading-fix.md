...
keywords:
  ...
  - bhulekh not working
  - bhoomi portal error
  - land records portal down
  - land records website fix
  - state land records error
  - bhulekh server error
  - land records not opening
  - land mutation website problem
  - land records search not working
readingTime: 8 min
officialLinks:
  - "https://dilrmp.gov.in/"
  - "https://nlrmp.gov.in/"
...
# Land Records Website Not Loading: How to Fix
...
- **"Server error — please try again later"** — website is overloaded
- **"404 Not Found"** — page or service not available
- **"Connection timed out"** — server not responding
- **"Service unavailable"** — portal is under maintenance
...
1. Visit [downforeveryoneorjustme.com](https://downforeveryoneorjustme.com/) and enter the portal URL
2. Or try [isitdown.site](https://isitdown.site/)
3. If the portal is down for everyone, wait and try later
4. Check if the state has an alternative URL — many states have both old and new portal links
...
2. If the site shows a security warning:
   - Click **"Advanced"** → **"Proceed to site"** (the site is a government portal, safe to proceed)
...
3. Month-end and financial year-end are peak times — avoid if possible

### Step 5: Fix Search Result Issues

If the portal loads but search returns no results:
1. **Check your inputs** — survey number, khasra number, village name, etc. must match exactly
2. **Try different search methods** — search by name, survey number, or khasra number
3. **Select the correct district, tehsil, and village** from dropdowns
4. **Use local language** — some portals require name search in the state's official language (Hindi, Marathi, etc.)
5. **Try partial search** — enter only a few characters of the name or number
...
2. Some states have **mirror sites** — search for "[state] land records mirror" on Google
...
4. Fee: ₹10-50 per copy in most states
5. Certified copies from the revenue office are more authoritative than online printouts

### Use DILRMP National Portal

1. Visit [dilrmp.gov.in](https://dilrmp.gov.in/) — Digital India Land Records Modernization Programme
...
3. Fee: ₹10 per application
4. Response within 30 days is mandatory

### Use CSC (Common Service Centre)

1. Visit your nearest CSC — find at [locator.csc.gov.in](https://locator.csc.gov.in/)
...
| Contact | Details |
|---------|---------|
| **DILRMP Portal** | [dilrmp.gov.in](https://dilrmp.gov.in/) |
...
1. **Save/download records** — whenever the portal works, download and save PDFs of your land records
2. **Note survey numbers** — keep a record of your property's survey number, khasra number, and khata number
3. **Bookmark working URLs** — state portal URLs change; bookmark the one that currently works
4. **Check records periodically** — verify your land records online every 6 months to catch any unauthorized changes early
5. **Keep certified copies** — maintain physical certified copies from the tehsil office as legal backup
6. **Use DigiLocker** — some states push land records to DigiLocker; check if yours does
