...
keywords:
  - "up bc sakhi yojana"
  - "banking sakhi yojana up"
  - "up bc sakhi apply"
  - "bc sakhi selection process"
  - "up banking correspondent sakhi"
  - "up bc sakhi eligibility"
  - "up sakhi yojana 4000 stipend"
  - "bc sakhi income"
  - "up rural women banking scheme"
  - "up sakhi digital banking"
officialLinks:
  - "https://upsrlm.org"
...
1. Go to **[upsrlm.org](https://upsrlm.org)**
...
- Apply: [upsrlm.org](https://upsrlm.org)
- UP CMO scheme info: [upcmo.up.nic.in](https://upcmo.up.nic.in)
