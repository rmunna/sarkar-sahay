---
title: "How to Register on GeM (Government e-Marketplace) — Seller & Buyer Guide"
...
- **Mandatory for government procurement** — Central government organisations must use GeM for listed categories
- **Transparent and competitive** — Equal opportunity for all registered sellers
- **Paperless and efficient** — End-to-end digital process from listing to payment
- **Massive market** — Over ₹4 lakh crore worth of orders processed on GeM
- **Direct access** — No middlemen between sellers and government buyers
- **Timely payments** — Payment tracking through the platform
...
| Document | Details |
|----------|---------|
| **PAN Card** | Mandatory for all sellers ([Apply for PAN](/guide/pan-card-apply-online)) |
| **Aadhaar Card** | For identity verification |
| **GST Registration** | GSTIN mandatory for goods sellers ([GST registration guide](/guide/gst-registration-online)) |
| **Bank Account Details** | Active current account with IFSC code |
| **Business Registration** | Incorporation certificate or [Udyam/MSME registration](/guide/udyam-msme-registration-online) |
...
> **Note:** For [company registration](/guide/company-registration-mca-online), you'll need a valid incorporation certificate from MCA.

## Seller Registration Process — Step by Step

### Step 1: Visit the GeM Portal

Go to [gem.gov.in](https://gem.gov.in) and click **"Register"** or go directly to the seller signup page.
...
Add your bank account details. GeM verifies the account through a penny-drop transaction (₹1 credit to your account).
...
GeM reviews your profile. Once approved, you can start listing products and services. Approval typically takes **2–3 working days**.

## Buyer (Government Department) Registration

Buyer registration on GeM is restricted to **government organisations** — central ministries, state departments, PSUs, and autonomous bodies.

### Buyer Registration Steps

1. **Visit GeM portal** and select **"Buyer"** registration
2. **Enter official email** — Must be a government email (nic.in or official domain)
3. **Organisation verification** — Select your ministry/department from the dropdown
4. **Authorisation** — The primary admin of your organisation must approve your registration
5. **Role assignment** — Buyers get roles like Consignee, Paying Authority, or Procurement Officer based on approval
6. **Training** — GeM provides free online training modules for buyers
...
> **Tip:** If you're a manufacturer, always register as OEM — it builds trust and can give you a competitive edge.

## Product & Service Listing on GeM

Once registered, sellers must list their offerings:

1. **Search the catalogue** — Find the relevant product/service category on GeM
2. **Select specifications** — GeM has standardised specifications for common items
3. **Enter pricing** — Set your offered price (inclusive of GST, delivery, and installation if applicable)
4. **Upload documents** — Product images, test reports, certifications
5. **Quality compliance** — Some categories require BIS certification or specific standards
6. **Go live** — Once listed, your product is visible to all government buyers

### GeM Categories

GeM covers a wide range of categories:
- **Products** — IT hardware, office supplies, furniture, electrical equipment, vehicles, medical equipment, safety gear, and more
- **Services** — Manpower services, cloud hosting, transportation, facility management, training, consulting, and more
- **GeM categories are continuously expanding** — New product and service categories are added regularly
...
### Direct Purchase
- For orders up to **₹25,000** — Single item purchase from any available seller at listed price
- **No bidding required** — Buyer selects directly from the marketplace
...
### Bidding / e-Tender (RA)
- **Reverse Auction (RA)** — Sellers bid competitively; lowest bid wins
...
- Transparent — all bids visible in real-time
...
- **No advance payment** — Payment is made after delivery and inspection
...
- **Relaxed eligibility** — Prior turnover and experience criteria waived for DPIIT-recognised startups
- **No EMD (Earnest Money Deposit)** required for bidding
- **No prior experience** — Startups can participate in bids without past supply records
- **Startup Runway** — Dedicated section on GeM showcasing innovative startup products
- **Category creation** — Startups can request new categories for innovative products

> To avail startup benefits, ensure your startup is registered on the [Startup India portal](https://www.startupindia.gov.in) and has a valid DPIIT recognition number.
...
The registration process takes about **30–60 minutes** to complete. Profile approval by GeM takes **2–3 working days** after submission.
...
*GeM has transformed government procurement in India by making it transparent, efficient, and accessible to businesses of all sizes. Whether you're a manufacturer, trader, service provider, or startup — registering on GeM opens up a massive government market for your business.*
