...
- **Senior Citizen** — 60 years or above but below 80 years (during the financial year)
- **Super Senior Citizen** — 80 years or above (during the financial year)
- **Resident status** is required — NRIs don't get senior citizen benefits even if age-eligible
...
### New Tax Regime
Under the new regime, the basic exemption is **₹3,00,000** for all taxpayers regardless of age (as per the latest budget). Senior citizens lose the higher exemption advantage under the new regime.
...
- Deduction up to **₹50,000** on interest income from banks, post offices, and cooperative societies
- Covers savings account interest, FD interest, and RD interest
- **Replaces Section 80TTA** (which gives only ₹10,000 for non-seniors)
- Available only under the old tax regime
- See our [tax saving FD guide](/guide/tax-saving-fixed-deposit) for maximising FD returns

### 2. Section 80D — Health Insurance Premium
| Premium Paid For | Senior Citizen Deduction |
|-----------------|------------------------|
| Self & spouse (senior) | Up to ₹50,000 |
| Parents (senior) | Additional ₹50,000 |
| **Total maximum** | **₹1,00,000** |

For non-seniors, the limit is ₹25,000 for self and ₹25,000 for parents — seniors get double.

Includes: Health insurance premium + preventive health check-up (up to ₹5,000) + medical expenses for uninsured seniors.
...
- Senior citizens: up to **₹1,00,000** (vs ₹40,000 for others)
...
- See our [advance tax guide](/guide/advance-tax-payment-guide) for details

### 5. Higher TDS Threshold
- TDS on interest: threshold is **₹50,000** (vs ₹40,000 for non-seniors) under Section 194A
...
- Full rebate on tax if total income is up to **₹5,00,000**
- Maximum rebate: ₹12,500

Under the new regime:
- Rebate if total income up to **₹7,00,000** (same for all ages)
...
### Which ITR Form?
- **ITR-1 (Sahaj)** — If income is only from pension, one house property, and other sources (interest) up to ₹50 lakh
- **ITR-2** — If capital gains are involved
...
1. **Maximise Section 80TTB** — Spread FDs across banks to stay within the ₹50,000 deduction efficiently
2. **Invest in SCSS** — Gets double benefit: 80C deduction on investment + 80TTB on interest
3. **Submit Form 15H** at every bank where you have FDs to avoid unnecessary TDS
4. **Compare old vs new regime** — Most seniors benefit from old regime due to 80TTB, 80D, and higher exemption
5. **Claim medical expenses** — Even without health insurance, seniors can claim up to ₹50,000 under 80D for medical expenses
6. **Use Section 80C fully** — Through SCSS, tax-saving FDs, life insurance, and PPF contributions

## Frequently Asked Questions

### Do senior citizens need to file income tax returns?
Yes, if total income exceeds the basic exemption limit (₹3,00,000 under old regime for seniors, ₹5,00,000 for super seniors). Even below these limits, filing is recommended for claiming TDS refunds.
...
Yes, pension is fully taxable under "Income from Salary" (for government pensions) or "Income from Other Sources" (for family pension). Standard deduction of ₹50,000 applies to pension from employer.
...
Medical reimbursement from employer is taxable as part of salary. However, senior citizens can claim deduction under Section 80D for medical expenditure (up to ₹50,000) if not covered by health insurance.
