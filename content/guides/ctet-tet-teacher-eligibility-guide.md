...
# CTET and TET Guide — Teacher Eligibility Test
...
Go to [ctet.nic.in](https://ctet.nic.in) when the notification is released (usually published in newspapers and the CBSE website).
...
- Photo: 3.5 cm × 4.5 cm, JPEG, 10-100 KB
...
For general application tips, see our [guide on applying for government jobs online](/guide/how-to-apply-government-jobs-online).
...
**Paper 1 (Primary level):** Basic arithmetic, geometry, patterns, data handling — focus on NCERT Class 1-5 level
**Paper 2 (Upper Primary):** Algebra, geometry, statistics, number system — NCERT Class 6-8 level
...
*Teaching is a noble and stable career with good work-life balance. Qualify CTET first, then apply for teaching positions in KVS, NVS, or state schools. Check out [SSC exam guide](/guide/ssc-exam-complete-guide) and [state PSC guide](/guide/state-psc-exam-guide) for other government career options.*
