---
title: "Bank Account Aadhaar Link Not Working — How to Fix"
description: "Bank account Aadhaar linking failed? Fix seeding errors, NPCI mapper issues, OTP failures, and DBT payment problems with step-by-step solutions."
category: "Utilities"
lastUpdated: 2025-07-05
keywords:
  - bank account aadhaar link not working
  - aadhaar seeding failed
  - aadhaar bank linking problem
  - npci mapper aadhaar check
  - aadhaar already linked to another bank
  - dbt payment failed aadhaar
  - aadhaar link bank account online
  - bank aadhaar otp not received
  - aadhaar seeding status check
  - link aadhaar to bank account
readingTime: "10 min"
officialLinks:
  - "https://resident.uidai.gov.in/aadhaar-linked-bank-check"
  - "https://npci.org.in/what-we-do/aadhar-payment-bridge/aadhaar-seeding-status"
  - "https://myaadhaar.uidai.gov.in/"
  - "https://www.npci.org.in/"
---

# Bank Account Aadhaar Link Not Working — How to Fix

Linking your Aadhaar to a bank account is mandatory for receiving government subsidies, LPG benefits, scholarships, MGNREGA wages, and other Direct Benefit Transfer (DBT) payments. If your Aadhaar is not seeded (linked) with your bank account — or is linked to the wrong account — your payments will fail silently or get credited to someone else's account.
...
1. **Bank-side seeding** — Your bank maps your Aadhaar number to your account internally.
2. **NPCI mapper update** — The National Payments Corporation of India (NPCI) maintains a central mapper that connects your Aadhaar to one specific bank account for receiving DBT payments.
...
1. Visit [UIDAI Aadhaar-Bank Check](https://resident.uidai.gov.in/aadhaar-linked-bank-check) or dial **\*99\*99\*1#** from your registered mobile.
2. Enter your Aadhaar number.
3. The system shows which bank account your Aadhaar is currently mapped to in the NPCI mapper.

> **Important:** This shows the NPCI mapper entry — the single account that receives all DBT payments. Your Aadhaar can be seeded at multiple banks, but only one bank holds the active NPCI mapper link.

### Check via Your Bank

- Log in to your net banking portal → look for "Aadhaar Seeding Status" or "DBT Registration."
...
- Update whichever document has the error:
  - **Aadhaar correction:** Visit [myAadhaar portal](https://myaadhaar.uidai.gov.in/) or an Aadhaar Enrolment Centre.
...
- If your Aadhaar is locked, unlock it on the [myAadhaar portal](https://myaadhaar.uidai.gov.in/) before attempting again.

### Cause 3: Technical Glitch

**Solution:** Wait 24–48 hours and retry. Bank servers sometimes fail to connect with the UIDAI/NPCI system during peak hours.
...
4. The bank sends a mapper change request to NPCI — this takes **1–7 working days**.

**Option B: Use Net Banking / Mobile Banking**

Many banks allow NPCI mapper change online:
1. Log in to net banking → search for "Aadhaar Seeding" or "Update Aadhaar."
2. Enter your 12-digit Aadhaar number.
3. Authenticate with OTP sent to your Aadhaar-registered mobile.
4. Confirm — the NPCI mapper updates within a few days.

**Option C: Use ATM (Select Banks)**

At SBI, PNB, BOB, and some other banks:
1. Insert your debit card at the ATM.
2. Go to **Services → Aadhaar Registration / Aadhaar Seeding**.
3. Enter your 12-digit Aadhaar number.
4. Confirm the linking.

> **Tip:** After changing the mapper, re-check after 3–7 days using the UIDAI link or USSD code mentioned in Fix 1.
...
- You exceeded the maximum OTP attempts (usually 5–10 per day).

### Solutions

1. **Verify your Aadhaar-registered mobile:** Visit [myAadhaar portal](https://myaadhaar.uidai.gov.in/) → check which mobile number is linked.
...
### Step 1: Confirm Aadhaar-Bank Link
...
After fixing the link, the next scheduled payment cycle will use the updated mapping. This may take **1–2 payment cycles** depending on the scheme.

---

## How to Link Aadhaar to Bank Account — All Methods
...
4. The bank processes it within **1–5 working days**.

### Method 2: Net Banking / Mobile Banking

1. Log in to your bank's net banking or mobile app.
2. Navigate to **Profile → Aadhaar Linking / Update Aadhaar / PAN & Aadhaar**.
3. Enter your Aadhaar number and verify with OTP.
4. Linking confirms within 24–72 hours.

### Method 3: ATM

1. Insert debit card → enter PIN.
2. Select **Services → Aadhaar Registration**.
...
|---|---|---|---|
| SBI | Accounts → Aadhaar Linking | Yes | UID to 567676 |
| PNB | e-Services → Aadhaar Seeding | Yes | — |
| BOB | Self Service → Link Aadhaar | Yes | — |
| HDFC | Accounts → Update Aadhaar | No | — |
| ICICI | Service Requests → Aadhaar Update | No | — |
| Canara Bank | e-Services → Aadhaar Linking | Yes | — |
...
1. **File a complaint with your bank** — use the bank's grievance portal or visit the branch manager.
2. **NPCI complaint** — Email mapper-related issues to npci@npci.org.in.
3. **Banking Ombudsman** — File a complaint at [RBI CMS portal](https://cms.rbi.org.in/) if the bank doesn't resolve within 30 days.
4. **UIDAI complaint** — For Aadhaar-side issues, contact UIDAI at 1947 (toll-free) or visit [UIDAI Contact Support](https://uidai.gov.in/en/contact-support.html).
...
Online (net banking/ATM): **24–72 hours.** Branch visit: **1–5 working days.** NPCI mapper update: **1–7 working days.**
...
### My Aadhaar mobile number is old. Can I still link?
