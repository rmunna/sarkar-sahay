...
keywords:
  ...
  - academic bank of credits not available
  - abc account not linked
  - digilocker abc missing
...
ABC is a digital storehouse managed by the Ministry of Education that:

- Stores academic credits earned from registered universities and institutions
- Allows credit transfer between institutions
- Maintains a lifelong academic record accessible via DigiLocker
- Is linked to your Aadhaar and DigiLocker account

## Why ABC Is Not Showing in DigiLocker

Your ABC records may not appear in DigiLocker for these reasons:

- **Your university is not registered with ABC** — Not all universities have joined the ABC ecosystem yet
...
3. You will be redirected to DigiLocker for authentication
4. Log in with your DigiLocker credentials (Aadhaar-linked mobile number)
5. Complete your profile with correct details:
...
Not all universities have registered with ABC. To check:

1. Visit [abc.gov.in](https://www.abc.gov.in/)
2. Look for the **Registered Institutions** or **Partner Universities** list
...
ABC pulls academic records from NAD. If your NAD account is not linked:

1. Visit [nad.digilocker.gov.in](https://nad.digilocker.gov.in/)
2. Log in with your DigiLocker credentials
3. Search for your university/institution
4. Enter your **enrollment number** or **registration number** as provided by your university
5. If your records are found, they will be linked to your DigiLocker account
6. ABC will then pull these records automatically

## Fix 4: Fix Enrollment Number Mismatch

A mismatch between your university enrollment number and what's in the system is a common cause:

1. Check your **university enrollment/registration number** from your physical ID card or admit card
2. Compare it with what you entered during ABC registration
3. If there's a mismatch:
   - Log in to [abc.gov.in](https://www.abc.gov.in/)
   - Update your enrollment details in your profile
   - Make sure the format matches exactly (including any slashes, hyphens, or year prefixes)
4. Wait 24–48 hours for the system to re-sync

## Fix 5: Request Your University to Upload Records

If your university is registered with ABC but your records are missing:

1. Contact your university's **Controller of Examinations** or **Academic Section**
2. Ask them to upload your academic records to NAD/ABC
3. Provide your:
...
Sometimes ABC records are available but not visible on the main dashboard:

1. Open DigiLocker app or visit [digilocker.gov.in](https://www.digilocker.gov.in/)
2. Go to **Issued Documents** section
3. Look for documents from **Academic Bank of Credits** or **National Academic Depository**
4. If not found, go to **Search Documents** → Search for **Academic Bank of Credits**
5. Try fetching your documents manually by entering your ABC ID
...
### How do I contact ABC support?
Visit [abc.gov.in](https://www.abc.gov.in/) and use the **Contact Us** or **Grievance** section. You can also raise an issue through DigiLocker's [help page](https://www.digilocker.gov.in/help).

---

*Disclaimer: CitizenNest is an independent informational platform and is not affiliated with or endorsed by the Government of India, DigiLocker, or the Academic Bank of Credits. Information is based on publicly available official sources and may change. Always verify details on [abc.gov.in](https://www.abc.gov.in/) and [digilocker.gov.in](https://www.digilocker.gov.in/).*
