...
> **Already know the basics?** Check our [step-by-step application walkthrough](/guide/pm-awas-yojana-apply) for a quick how-to.
...
5. Upload scanned documents — Aadhaar, income proof, bank details, [land records](/guide/land-records-bhulekh-online) if applicable
...
> **Tip:** Ensure your [Aadhaar is active and linked](/guide/aadhaar-card-apply-online) to your bank account before applying.
...
1. Visit [pmayuclap.gov.in](https://pmayuclap.gov.in)
...
1. Go to [rhreporting.nic.in](https://rhreporting.nic.in)
2. Select your state → district → block → panchayat
3. Browse the beneficiary list to find your name and sanction status

**Method 3 — Awaas+ App:**
Download the Awaas+ app from Google Play Store. Login with your registered mobile number to check status and upload geo-tagged construction photos.
...
2. **Aadhaar mismatch** — Name, date of birth, or address mismatch between Aadhaar and application form. Update your [Aadhaar details](/guide/aadhaar-card-apply-online) first.
...
- **Address proof** — voter ID, utility bill, or [property documents](/guide/property-registration-online)
...
- [How to Apply for PMAY — Step-by-Step](/guide/pm-awas-yojana-apply)
...
- [Aadhaar Card — Apply & Update Online](/guide/aadhaar-card-apply-online)
