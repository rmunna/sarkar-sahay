...
description: "Complete guide to converting your PIO card to OCI card including documents required, fees, application process, and important deadlines."
category: "Identity Documents"
keywords: ["PIO to OCI conversion", "PIO card conversion", "convert PIO to OCI", "PIO card replacement", "OCI card for PIO holders"]
readingTime: "7 min"
officialLinks:
...
### Step 1: Apply Online
1. Visit [ociservices.gov.in](https://ociservices.gov.in)
...
**Note:** These are approximate and may have changed. Check the Indian embassy in your country or [ociservices.gov.in](https://ociservices.gov.in) for current fees. VFS/BLS service charges are additional.
...
You can still apply for an OCI card. Instead of submitting the PIO card, provide a police report (FIR) for the lost card and apply for a fresh OCI with your Indian origin documents. See our [OCI card guide](/guide/oci-card-apply-guide) for the full process.
...
*Disclaimer: This guide is for informational purposes only. CitizenNest is not affiliated with MHA or Indian missions abroad. Visit [ociservices.gov.in](https://ociservices.gov.in) for official information.*
