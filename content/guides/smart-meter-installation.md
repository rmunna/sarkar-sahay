...
# Smart Electricity Meter Installation — Process, Benefits & Status
...
This guide explains everything you need to know about smart meter installation — how it works, whether you are eligible, what the benefits are, and how to check your installation status.
...
- **Real-time consumption tracking** — see exactly how much electricity you are using
- **Remote meter reading** — no more waiting for the meter reader to visit
- **Prepaid and postpaid modes** — recharge your electricity like a mobile phone
- **Tamper detection** — alerts the DISCOM if someone tries to tamper with the meter
- **Time-of-day billing** — different rates for peak and off-peak hours (where applicable)
...
Smart meter installation is being done **zone by zone** and **area by area** by your local DISCOM. You do not need to "apply" for a smart meter in most cases — your DISCOM will schedule the installation based on their rollout plan.
...
- **Prepaid recharge:** If your meter operates in prepaid mode, you recharge through the DISCOM app, UPI, or authorised recharge centres. Minimum recharge is usually ₹100–₹200.
...
|---|---|
| Area notification to installation | 1–4 weeks |
| Actual installation per household | 30–60 minutes |
| Meter activation after installation | 24–48 hours |
| App access and online features | 1–3 days |
...
1. **Accurate billing** — no more estimated bills or inflated readings
2. **Prepaid option** — pay for electricity before you use it, like a mobile recharge
3. **Real-time monitoring** — track your consumption hourly and daily
4. **Reduced power theft** — tamper detection and remote monitoring
5. **Faster outage detection** — DISCOMs know immediately when your meter goes offline
6. **Budget control** — set alerts when you cross a certain usage or spending limit
7. **Environment-friendly** — encourages conscious electricity usage and conservation

---

## Tips for Consumers

1. **Do not refuse installation** — smart meter installation is mandatory under the government scheme. Refusing may lead to disconnection notices in some states.

2. **Note your old meter reading** — before the team removes your old meter, take a photo of the final reading for your records.

3. **Keep your mobile updated** — all notifications, recharge alerts, and low-balance warnings come via SMS and the app.

4. **Understand prepaid mode** — if your area is on prepaid billing, your power will be cut when the balance reaches zero. Always keep a buffer balance.

5. **Report issues early** — if your smart meter display shows errors or the communication fails, report it to your DISCOM immediately.

6. **Check for subsidies** — some states still provide subsidised electricity units. These subsidies will reflect in your smart meter account automatically.

7. **Compare with old bills** — for the first few months, compare your smart meter readings with your old billing pattern to understand your actual consumption.
...
If your balance reaches zero, the smart meter will disconnect your electricity supply automatically. You need to recharge to restore power. Most DISCOMs provide a small emergency credit (₹50–₹100) before complete disconnection.
