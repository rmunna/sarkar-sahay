---
title: "HRA Exemption — How to Calculate HRA Tax Exemption (with Examples)"
description: "Learn how to calculate HRA tax exemption under Section 10(13A). Step-by-step formula, metro and non-metro examples, documents needed."
category: "Tax & Finance"
keywords: ["HRA exemption calculation", "HRA tax exemption", "Section 10(13A)", "house rent allowance", "HRA exemption formula", "HRA claim documents"]
readingTime: "8 min"
officialLinks:
...
**Formula:** 50% × (Basic + DA) for metro OR 40% × (Basic + DA) for non-metro

### 3. Rent Paid Minus 10% of Basic Salary

The actual rent you pay, minus 10% of your basic salary (plus DA, if applicable).

**Formula:** Actual Rent Paid − 10% × (Basic + DA)
...
| Condition | Formula | Amount (per year) |
|---|---|---|
| Actual HRA received | ₹16,000 × 12 | **₹1,92,000** |
| 40% of Basic (non-metro) | 40% × ₹4,80,000 | **₹1,92,000** |
| Rent − 10% of Basic | ₹1,44,000 − ₹48,000 | **₹96,000** |
...
For more on claiming HRA without rent receipts, see our guide on [HRA claim without rent receipts](/guide/hra-claim-without-rent-receipt).
