...
# State PSC Exam Guide — Complete State Civil Services Overview
...
|---|-------|----------|-----------------|-----------|
| 1 | Andhra Pradesh | APPSC | psc.ap.gov.in | — |
| 2 | Arunachal Pradesh | APPSC | appsc.gov.in | — |
| 3 | Assam | APSC | apsc.nic.in | [APSC Exam Guide](/guide/apsc-exam-guide) |
| 4 | Bihar | BPSC | bpsc.bih.nic.in | [BPSC PCS Exam Guide](/guide/bpsc-pcs-exam-guide) |
| 5 | Chhattisgarh | CGPSC | psc.cg.gov.in | — |
| 6 | Goa | Goa PSC | gpsc.goa.gov.in | [Goa PSC Exam Guide](/guide/goa-psc-exam-guide) |
| 7 | Gujarat | GPSC | gpsc.gujarat.gov.in | — |
| 8 | Haryana | HPSC | hpsc.gov.in | [HPSC Exam Guide](/guide/hpsc-exam-guide) |
| 9 | Himachal Pradesh | HPPSC | hppsc.hp.gov.in | [HPPSC Exam Guide](/guide/hppsc-exam-guide) |
| 10 | Jharkhand | JPSC | jpsc.gov.in | — |
| 11 | Karnataka | KPSC | kpsc.kar.nic.in | [KPSC KAS Exam Guide](/guide/kpsc-kas-exam-guide) |
| 12 | Kerala | KPSC | keralapsc.gov.in | — |
| 13 | Madhya Pradesh | MPPSC | mppsc.mp.gov.in | — |
| 14 | Maharashtra | MPSC | mpsc.gov.in | [MPSC Exam Guide](/guide/mpsc-exam-guide) |
| 15 | Manipur | MPSC | mpscmanipur.gov.in | — |
| 16 | Meghalaya | MPSC | mpsc.nic.in | — |
| 17 | Mizoram | MPSC | mpsc.mizoram.gov.in | — |
| 18 | Nagaland | NPSC | npsc.nagaland.gov.in | — |
| 19 | Odisha | OPSC | opsc.gov.in | — |
| 20 | Punjab | PPSC | ppsc.gov.in | — |
| 21 | Rajasthan | RPSC | rpsc.rajasthan.gov.in | — |
| 22 | Sikkim | SPSC | spscskm.gov.in | — |
...
> **Karnataka aspirants:** Also check our [KPSC FDA SDA Exam Guide](/guide/kpsc-fda-sda-exam-guide) for subordinate service exams conducted by Karnataka PSC.

## Top 10 State PSCs — Comparison by Difficulty, Vacancies & Salary

| State PSC | Exam | Approx. Vacancies/Year | Approx. Applicants | Competition Ratio | Starting Salary (₹) | Difficulty |
|-----------|------|----------------------|-------------------|-------------------|---------------------|------------|
...
- **MPPSC Mains:** 6 papers — GS 1-4 + Hindi Essay + Hindi Language
- **RPSC (RAS) Mains:** 4 papers — GS 1-3 + General Hindi & English
- **MPSC Mains:** 6 papers — GS 1-4 + Marathi + English
...
- **CSAT basics** — common across most exams
...
- Analyse question patterns — state PSCs tend to repeat themes
...
1. **UPSC Prelims** (May-June) — primary target
2. **State PSC Prelims** (spread across the year) — secondary targets
3. Use the gap between prelims and mains of one exam to prepare for another

## State-Specific Syllabus Focus

While the general syllabus overlaps with UPSC, state PSCs give more weightage to:

1. **State history and culture** — Freedom movement in the state, art, architecture, literature
2. **State geography** — Rivers, forests, minerals, climate, agriculture
3. **State economy** — Major industries, economic indicators, government schemes
4. **State polity** — Governor, state legislature, Panchayati Raj, local governance
5. **State current affairs** — Government policies, budget, and recent developments
...
| Salary | ₹56,100 (Level 10) | ₹56,100 (Level 10) |
| Posting | All-India | Within the state |

## How to Apply for State PSC Exams

1. Visit your state PSC's official website
2. Register when the notification is published
3. Fill the application form with personal and educational details
4. Upload photo and signature as per guidelines
5. Pay the application fee (varies: ₹40-₹200 typically)
6. Submit and download confirmation

For general application tips, read our [guide on applying for government jobs online](/guide/how-to-apply-government-jobs-online).
...
Absolutely — this is one of the most common and effective strategies. About 70-80% of the syllabus overlaps between UPSC and most state PSCs. Add state-specific content on top of your UPSC preparation. Many UPSC aspirants clear state PSCs as backup.
...
Starting salary for state PCS officers is approximately **₹56,100 (Pay Level 10)** for SDM-level posts under the 7th Pay Commission. With DA, HRA, and allowances, the gross monthly salary is typically ₹80,000-₹1,00,000 at entry level.
...
Most state PSCs have an interview/personality test as the final stage. However, the weightage varies — some states give 200 marks to the interview while others have reduced it significantly. **TNPSC** is notable for minimising interview weightage in recent years.
