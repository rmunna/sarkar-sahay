...
**Pro tip:** Term insurance should be your base. If you want investment returns, consider [PPF](/guide/ppf-public-provident-fund-account), [NPS](/guide/nps-national-pension-system-account), or mutual funds separately — this "buy term, invest the rest" approach usually outperforms bundled products.
...
- **LIC** — [licindia.in](https://licindia.in)
- **HDFC Life** — [hdfclife.com](https://www.hdfclife.com)
- **SBI Life** — [sbilife.co.in](https://www.sbilife.co.in)
- **ICICI Prudential** — [iciciprulife.com](https://www.iciciprulife.com)
...
For comprehensive tax-saving strategies, also explore [filing your income tax return online](/guide/income-tax-return-file-online) and tax-saving instruments like [PPF](/guide/ppf-public-provident-fund-account) and [Atal Pension Yojana](/guide/atal-pension-yojana-apy).

## Life Insurance Claim Process

### Death Claim

1. **Intimate the insurer** — The nominee or legal heir must inform the insurance company as soon as possible. Most insurers have a toll-free number and online claim registration.
2. **Submit claim form** — Download the death claim form from the insurer's website or collect it from the nearest branch.
3. **Provide documents** (see list below).
4. **Insurer investigates** — For claims within 3 years of policy issuance, the insurer may investigate (as per Section 45 of the Insurance Act). Claims after 3 years cannot be questioned on grounds of misstatement.
5. **Claim settlement** — IRDAI mandates that claims must be settled within 30 days of receiving all documents. If investigation is needed, the decision must come within 6 months.
...
**The verdict:** For most people, the optimal approach is to buy a term plan for pure protection and invest separately in [NPS](/guide/nps-national-pension-system-account), [PPF](/guide/ppf-public-provident-fund-account), or mutual funds for wealth building. This gives you both higher coverage and better long-term returns.
