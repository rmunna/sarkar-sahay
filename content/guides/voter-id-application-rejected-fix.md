...
keywords:
  ...
  - voter id rejected
  - voter id card application rejected reason
  - epic card application rejected
  - voter id form 6 rejected
  - voter id verification failed
  - voter id blo verification rejected
  - fix voter id rejection
  - voter id reapply after rejection
  - voter id application status rejected
readingTime: 8 min
officialLinks:
...
# Voter ID Application Rejected: How to Fix

Your Voter ID (EPIC — Electors Photo Identity Card) application can be rejected at various stages — during BLO (Booth Level Officer) verification, ERO (Electoral Registration Officer) review, or during document scrutiny. This guide explains every common rejection reason and how to fix it so you can successfully get your [voter ID card](/guide/voter-id-card-apply-online).

## Common Rejection Reasons

You may receive a rejection notification via SMS, email, or see it on the [NVSP portal](https://www.nvsp.in/) with reasons such as:

- **"Incomplete or incorrect form"** — missing fields or wrong information in Form 6
- **"Address proof not sufficient"** — submitted document doesn't prove residence in the constituency
- **"BLO could not verify"** — Booth Level Officer visited but couldn't confirm your residence
- **"Applicant not found at address"** — you weren't home during BLO visit
- **"Duplicate entry found"** — your name already exists in the voter list (same or different constituency)
- **"Age proof insufficient"** — unable to verify you are 18 years or older
- **"Photo not clear or not matching"** — blurry or mismatched photograph
- **"Document quality poor"** — uploaded documents are unreadable
- **"Objection raised during listing"** — someone objected to your inclusion in the voter list
...
3. **Reapply online** at [voters.eci.gov.in](https://voters.eci.gov.in/) with corrected information
...
- Utility bill (electricity, water, gas, phone) — recent, within 3 months
...
1. **Be available at your address** — BLOs visit during working hours (usually 10 AM – 5 PM)
2. If you missed the visit:
   - Contact your BLO directly — find BLO details on [voters.eci.gov.in](https://voters.eci.gov.in/) → **Know Your BLO**
...
1. First, check your existing registration at [voters.eci.gov.in](https://voters.eci.gov.in/) → **Search in Electoral Roll**
...
1. **Contact the ERO** (Electoral Registration Officer) of your constituency
   - Find ERO details on [eci.gov.in](https://eci.gov.in/) or your state election commission website
...
4. You can also file a complaint on the [ECI Citizen Services Portal](https://eci.gov.in/)
...
- **NVSP Portal:** [nvsp.in](https://www.nvsp.in/)
...
1. **Apply well before elections** — don't wait for election announcements; apply as soon as you turn 18 or move to a new address
2. **Double-check your constituency** — use [voters.eci.gov.in](https://voters.eci.gov.in/) to find the correct assembly constituency for your address
3. **Keep original documents ready** for BLO verification
4. **Provide your mobile number** — BLOs often call before visiting
5. **Upload high-quality documents** — clear, readable scans in the correct format
...
Normal processing takes **30–45 days** including BLO verification. During special revision drives or election periods, it may be faster. Track status regularly on the NVSP portal.

### Can I apply for voter ID online after rejection?

Yes. You can reapply online at [voters.eci.gov.in](https://voters.eci.gov.in/) by submitting a fresh Form 6. There is no penalty or waiting period for reapplication after rejection.
