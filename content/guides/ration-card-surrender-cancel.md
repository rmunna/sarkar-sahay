...
keywords:
  ...
  - how to cancel ration card
  - ration card cancellation form
  - ration card surrender certificate
  - cancel ration card online
  - ration card cancellation documents
  - surrender ration card India
readingTime: 7 min
officialLinks:
  - 'https://nfsa.gov.in/'
  - 'https://services.india.gov.in/service/detail/surrender-of-ration-card-application-form'
  - 'https://services.india.gov.in/service/detail/application-form-for-cancellation-of-ration-card'
  - 'https://epds.nic.in/'
---

# How to Surrender or Cancel a Ration Card in India

If you no longer need your ration card — maybe you are moving to another state, your income has increased, or a family member has passed away — you can surrender or cancel it. This guide explains the full process for ration card surrender and cancellation, both online and offline, with documents needed and state-wise portal links.
...
## Surrender vs Cancellation — What's the Difference?

Many people use "surrender" and "cancellation" interchangeably, but there is a small difference:

- **Surrender** — You voluntarily give up your ration card. You get a **Surrender Certificate** which you can use to apply for a new ration card at another location (useful when migrating).
- **Cancellation** — The ration card is permanently cancelled. This can be voluntary (you no longer need it) or involuntary (government cancels it for fraud, duplicate card, death of all members, etc.).

In both cases, the card becomes inactive and you stop receiving subsidised rations from the [Public Distribution System (PDS)](/guide/one-nation-one-ration-card).
...
1. **Moving to another state or district** — You must surrender your old card before applying for a new one at your new location.
2. **Income increase** — If your household income crosses the eligibility limit for [BPL/AAY/APH categories](/guide/ration-card-types-aph-bpl-aay), you should surrender the card.
3. **Death of the cardholder** — If the head of the family (card holder) passes away and no eligible members remain.
4. **Duplicate ration card** — If you have more than one ration card, the extra must be cancelled.
5. **Family members already covered** — If all members are added to another ration card.
6. **Government employee or high-income household** — Not eligible for subsidised rations under NFSA.
7. **Voluntary surrender** — You simply don't want to use PDS services anymore.
8. **Non-usage for 6+ months** — As per the 2025 TPDS amendment, cards inactive for 6 months may be automatically deactivated by the government.
...
## How to Surrender or Cancel Ration Card — Online Process
...
Go to your state's official ration card portal (see links below) or the [National Services Portal](https://services.india.gov.in/).
...
Once processed (usually 15–30 days), you will receive a **Surrender Certificate** online or via SMS. This certificate is needed if you want to apply for a new ration card elsewhere.
...
## How to Surrender or Cancel Ration Card — Offline Process
...
You will get an acknowledgement receipt. The office will verify your application and process the cancellation within 15–30 working days.
...
Some states collect a small **security deposit** (₹2 to ₹25) when issuing a ration card. If your state collected a deposit:
...
For other states, visit the [National Food Security Portal (NFSA)](https://nfsa.gov.in/) and select your state.
...
- Under the [One Nation One Ration Card (ONORC)](/guide/one-nation-one-ration-card) scheme, portability is available — but if you permanently move, surrendering and getting a new card is still recommended.

---

## Important Tips

- **Always get a Surrender Certificate** — Without it, you may face problems applying for a new ration card.
- **Inform all family members** — Once cancelled, no member can draw rations on that card.
- **Check for pending rations** — Draw any pending month's ration before surrendering.
- **Keep copies** — Photocopy your ration card and all submitted documents before handing over the original.
- **Track your application** — Use the reference number to track status on the state portal.
...
It is recommended. While the [ONORC scheme](/guide/one-nation-one-ration-card) allows you to draw rations anywhere in India, if you have permanently moved, you should surrender the old card and apply for a new one in your new state for long-term convenience.

---

*Last updated: 18 February 2026. Information is based on publicly available government guidelines. Rules and processes may vary by state — always check your state's official portal for the latest details.*
