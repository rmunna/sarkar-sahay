...
A Recurring Deposit (RD) is one of the simplest ways to build savings in India. Instead of investing a lump sum like a [Fixed Deposit](/guide/fixed-deposit-fd-interest-rates), you deposit a fixed amount every month and earn interest on the accumulated balance. It's ideal for salaried individuals, students, and anyone who wants to cultivate a disciplined savings habit.
...
**Maturity Amount = P × [(1 + r/4)^n – 1] / [1 – (1 + r/4)^(-1/3)]**
...
**Approximate maturity value: ₹3,58,000**
(Total deposits: ₹3,00,000 | Interest earned: ~₹58,000)
...
> Need to [open a bank account](/guide/open-bank-account-online) first? Check our step-by-step guide.
...
- RD deposits do **not** qualify for Section 80C deduction (unlike 5-year Tax Saving FD or [PPF](/guide/ppf-public-provident-fund-account))
- If your total income is below the taxable limit, submit Form 15G/15H to avoid TDS
- Consider tax-free alternatives like [PPF](/guide/ppf-public-provident-fund-account) or [Sukanya Samriddhi Yojana](/guide/sukanya-samriddhi-yojana) if tax efficiency is a priority

## RD vs FD vs SIP — Which Is Better?

| Feature | Recurring Deposit (RD) | [Fixed Deposit (FD)](/guide/fixed-deposit-fd-interest-rates) | SIP (Mutual Fund) |
|---|---|---|---|
...
For higher returns with tax benefits, also explore [PPF](/guide/ppf-public-provident-fund-account) and [Sukanya Samriddhi Yojana](/guide/sukanya-samriddhi-yojana). If you need to [open a bank account](/guide/open-bank-account-online) first, we've got you covered.
