---
title: "Electricity Meter Reading Wrong or Inflated Bill — How to Fix"
description: "Got a wrong meter reading or inflated electricity bill? Learn how to dispute, request meter testing, complain to DISCOM, and escalate to CGRF or Ombudsman."
keywords: ["wrong meter reading", "inflated electricity bill", "electricity bill dispute", "defective meter replacement", "meter testing request", "average billing complaint", "DISCOM complaint", "CGRF electricity", "Electricity Ombudsman", "high electricity bill India"]
slug: electricity-meter-reading-wrong-fix
category: "Utilities"
tags:
  - electricity bill
  - meter reading
...
officialLinks:
  consumerHelpline: "https://consumerhelpline.gov.in"
  cgrf: "https://cercind.gov.in/consumer.html"
  electricityOmbudsman: "https://cercind.gov.in"
  beeIndia: "https://beeindia.gov.in"
---

# Electricity Meter Reading Wrong or Inflated Bill — How to Fix

Received an electricity bill that's shockingly high — or noticed the meter reading doesn't match what you see on your meter? You're not alone. Wrong meter readings, defective meters, and inflated bills are among the most common electricity complaints in India.

This guide walks you through **every step** — from verifying the reading yourself to filing a formal complaint with your DISCOM, requesting a meter test, and escalating to the **Consumer Grievance Redressal Forum (CGRF)** or **Electricity Ombudsman** if your complaint isn't resolved.
...
1. **Go to your meter** and note down the current reading (all digits, left to right)
2. **Compare with the bill** — check the "Current Reading" and "Previous Reading" fields
3. **Calculate units consumed** — subtract previous from current reading
4. **Match with billed units** — if there's a significant mismatch, you have a valid dispute

> 💡 **Tip:** Take a **photo of your meter with a timestamp** every month. This serves as evidence if you need to dispute later.
...
1. **Call your DISCOM helpline** and request an actual reading
2. **Submit a self-reading** through the DISCOM app or portal (most DISCOMs now allow this)
3. **Request a revised bill** based on the actual meter reading
4. If overcharged, the excess amount will be **adjusted in your next bill**
...
| **Email** | Send complaint email with bill copy and meter photo attached |
...
1. **File a written application** at your DISCOM's subdivision office requesting meter testing
2. **Pay the meter testing fee** (usually ₹200–₹500, varies by state; refunded if meter is found defective)
3. DISCOM will **remove your meter** and send it to a government-authorized testing lab
4. You'll get a **test report** within 15–30 days
...
> ⚖️ **Your Right:** Under the Electricity Act 2003 and state supply codes, the DISCOM **must test your meter** if you request it. They cannot refuse.
...
1. **DISCOM must replace the meter free of charge** (the meter is their property)
2. A **new meter** will be installed within 7–15 days of the test report
3. **Revised billing** should be done from the date the meter was found faulty
4. During the replacement period, you'll receive an **average bill** based on your consumption history
...
1. **Ensure you've first complained to DISCOM** — CGRF won't accept complaints without a prior DISCOM complaint
2. **Collect your DISCOM complaint number** and proof that it wasn't resolved
3. **File a petition** with the CGRF of your DISCOM (online or in person)
4. **Attach documents:** bill copies, meter photos, complaint acknowledgments, meter test report
5. CGRF must hear your case and pass an order within **45 days**

### CGRF is Free

There is **no fee** to file a complaint with CGRF. You don't need a lawyer either — you can represent yourself.
...
1. **File within 30 days** of the CGRF order (or 30 days after the CGRF deadline expired)
2. **Submit a representation** to the Electricity Ombudsman of your state
3. **Attach:** CGRF order (if any), original complaint, all supporting documents
4. Ombudsman must pass an order within **90 days**
5. The Ombudsman's decision is **binding on the DISCOM**

> 📌 **Important:** The Ombudsman is your last stop within the electricity regulatory framework. Beyond this, your only option is approaching the **Consumer Court (District Consumer Forum)** or the **High Court**.

---

## Escalation Ladder — Quick Reference

```
Step 1: DISCOM Helpline / App / Office
         ↓ (if unresolved in 15-30 days)
...
1. **Take monthly meter photos** with timestamps — your best evidence in any dispute
2. **Submit self-readings** via DISCOM app to avoid average billing
3. **Keep your meter accessible** — don't block it behind locked gates
4. **Check your bill immediately** when it arrives — dispute within the billing cycle
5. **Compare month-on-month consumption** — sudden spikes may indicate a fault
6. **Get your internal wiring checked** if bills are consistently high — earth leakage wastes electricity and inflates bills
7. **Use a plug-in energy meter** (₹200–₹500 on Amazon) to check individual appliance consumption
