...
keywords:
  ...
  - bpl card vs apl card difference
  - ration card types india
  ...
  - bpl card apply
  - difference between apl and bpl
readingTime: 9 min
officialLinks:
  - 'https://nfsa.gov.in/'
  - 'https://dfpd.gov.in/'
...
# APL vs BPL Ration Card – Complete Guide to Differences and Benefits

India's Public Distribution System (PDS) provides subsidised food grains through [ration cards](/guide/ration-card-apply-online). The two main categories are APL (Above Poverty Line) and BPL (Below Poverty Line). After the National Food Security Act (NFSA) 2013, the system was reorganised into Priority and Non-Priority households, but the APL/BPL terminology is still widely used. This guide explains all the differences.
...
**APL Ration Card** is for families above the poverty line who do not qualify for [BPL](/guide/bpl-card-apply-eligibility) or AAY (Antyodaya Anna Yojana) categories but still want a ration card for identity/address proof and limited food grain access.
...
- **[E-Shram registration](/guide/e-shram-card-registration)** benefits
...
*Colours vary by state. Under [One Nation One Ration Card](/guide/one-nation-one-ration-card), portability is enabled regardless of card colour.*
...
4. Or check on [One Nation One Ration Card portal](https://nfsa.gov.in/)

You can also [check ration card status and download](/guide/ration-card-status-download-update) online in most states.
...
Apply through your state's food department portal or visit the local [ration card office](/guide/ration-card-apply-online). You need income certificate, Aadhaar, and family details.

### Can I use my ration card in another state?
Yes, under [One Nation One Ration Card (ONORC)](/guide/one-nation-one-ration-card) scheme, BPL/PHH card holders can buy subsidised rations from any fair price shop across India.
...
Yes. You can [add or remove members](/guide/ration-card-add-remove-member) by applying through your state's food portal or local PDS office.
...
- [BPL Card Apply – Eligibility Guide](/guide/bpl-card-apply-eligibility)
- [Ration Card Types and Priorities](/guide/ration-card-types-priorities)
- [One Nation One Ration Card](/guide/one-nation-one-ration-card)
- [Ration Card Add/Remove Member](/guide/ration-card-add-remove-member)
- [Ration Card Status Download](/guide/ration-card-status-download-update)
