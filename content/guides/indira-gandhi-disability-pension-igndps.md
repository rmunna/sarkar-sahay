...
keywords:
  ...
  - "igndps apply"
  - "nsap disability pension 300"
  - "bpl disabled person pension"
  - "viklang pension central scheme"
  - "indira gandhi disability pension documents"
  - "igndps eligibility age 18"
  - "nsap disability pension state"
  - "divyang pension central government"
  - "igndps gram panchayat apply"
officialLinks:
  - "https://nsap.nic.in"
  - "https://rural.nic.in"
readingTime: "5 min"
...
- **UP:** [sspy-up.gov.in](https://sspy-up.gov.in) → Divyang Pension
...
5. Also apply for **UDID card** (Unique Disability ID) at [swavlambancard.gov.in](https://swavlambancard.gov.in) — national disability identity used across all states
