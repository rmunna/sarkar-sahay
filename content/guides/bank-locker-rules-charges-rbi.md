---
title: "How to Get Bank Locker — Rules, Charges, Nomination & RBI Guidelines"
description: "Complete guide to bank locker rules in India. Learn about RBI revised guidelines, locker charges by SBI, HDFC & ICICI, nomination, security deposit, and more."
category: "Tax & Finance"
keywords:
  - "bank locker rules"
  - "bank locker charges"
  - "RBI locker guidelines"
  - "bank locker nomination"
  - "SBI locker rent"
  - "HDFC locker charges"
  - "ICICI bank locker"
  - "bank locker security deposit"
  - "bank locker agreement"
  - "how to get bank locker"
readingTime: "9 min"
lastUpdated: "2026-02-16"
officialLinks:
  - "https://www.rbi.org.in/Scripts/NotificationUser.aspx?Id=12187"
  - "https://sbi.co.in"
  - "https://www.hdfcbank.com"
  - "https://www.icicibank.com"
---

# How to Get Bank Locker — Rules, Charges, Nomination & RBI Guidelines

A bank locker (safe deposit locker) lets you store valuables like jewellery, property documents, and important certificates in a secure vault maintained by the bank. With the RBI issuing revised guidelines in 2022, the rules around bank lockers have changed significantly — covering agreements, bank liability, insurance, and customer rights.
...
1. **Visit your bank branch** — Lockers are available only at branches that have a vault. Not all branches offer this facility.
2. **Submit an application** — Fill out the locker application form. You will need to provide KYC documents (Aadhaar, PAN, address proof, passport-size photographs).
3. **Open a savings account** — Most banks require you to have a [savings account](/guide/open-bank-account-online) at the same branch.
4. **Pay the security deposit and first year's rent** — The bank will collect a one-time security deposit and the annual locker rent in advance.
5. **Sign the locker agreement** — As per the 2022 RBI guidelines, the agreement must be on a stamped paper and must clearly mention the bank's liability, rent revision terms, and nomination details.
6. **Collect your locker key** — Once allotted, you receive a key. The locker requires both your key and the bank's master key to open.
...
- Banks **cannot insist on a fixed deposit (FD)** as a condition for allotting a locker. However, they can collect a security deposit equivalent to **3 years' rent** (earlier some banks demanded FDs of ₹10,000–₹50,000).
...
|------|----------------------|----------|
| **Small** | 5" × 5" × 21" | Documents, small jewellery, pen drives |
| **Medium** | 5" × 10" × 21" | Jewellery sets, gold coins, bundles of documents |
| **Large** | 10" × 10" × 21" | Large jewellery collections, silverware |
| **Extra Large** | 15" × 10" × 21" | Bulky items, art pieces, large collections |
...
|------|-------------|------------------|
| Small | ₹2,000 + GST | ₹1,500 + GST |
| Medium | ₹4,000 + GST | ₹3,000 + GST |
| Large | ₹8,000 + GST | ₹6,000 + GST |
| Extra Large | ₹12,000 + GST | ₹10,000 + GST |

### HDFC Bank

| Size | Metro/Urban | Semi-Urban/Rural |
|------|-------------|------------------|
| Small | ₹2,500 + GST | ₹1,500 + GST |
| Medium | ₹5,000 + GST | ₹3,500 + GST |
| Large | ₹10,000 + GST | ₹7,000 + GST |
| Extra Large | ₹14,000 + GST | ₹10,500 + GST |
...
| Small | ₹2,500 + GST | ₹1,500 + GST |
| Medium | ₹5,000 + GST | ₹3,500 + GST |
| Large | ₹10,000 + GST | ₹7,500 + GST |
| Extra Large | ₹15,000 + GST | ₹11,000 + GST |

> **Note:** GST at 18% is applicable on locker rent. Banks may revise charges periodically. Consider a [fixed deposit](/guide/fixed-deposit-fd-interest-rates) to earn interest on the security deposit amount.
...
- **Cash** — It is illegal to store large amounts of cash; the Income Tax department can investigate
- **Perishable items** — Food, plants, or anything that can decay
- **Hazardous materials** — Chemicals, explosives, flammable substances
- **Illegal items** — Contraband, drugs, unlicensed firearms
- **Items prohibited by the bank** — Check your locker agreement for specific exclusions
...
- You are entitled to **privacy** — bank staff should not be present while you access the contents.
...
1. **Non-payment of rent** — If rent is unpaid for **3 consecutive years**, the bank can send a notice and break open the locker after giving adequate notice (at least 6 months).
2. **Due process** — The bank must send a registered letter to the locker holder and nominee at their last known address.
3. **Inventory** — The contents must be listed in the presence of **two independent witnesses** and the branch manager.
4. **Storage** — The contents are kept in a sealed packet in the bank's custody until claimed.
5. **Court order** — In certain legal situations, a court may order the bank to break open a locker.
...
- Locker allotment is **non-transferable** — you cannot sell, sublet, or transfer your locker to another person.
...
- In case of **death**, the nominee or legal heir can access the locker but the locker itself is not automatically transferred — a fresh application is required.
...
While the physical bank locker requires an in-person visit, India's [DigiLocker](/guide/digilocker-guide) platform offers a digital alternative for documents:
...
If a nominee is registered, the nominee can access the locker in the presence of a bank official and remove the contents. Without a nominee, legal heirs need to submit a succession certificate or legal heir certificate issued by a court. The locker is not automatically inherited — a fresh application is needed.

### How much compensation will the bank pay if my locker is robbed?
Under the 2022 RBI guidelines, if the contents are lost due to the bank's negligence (theft, fire, fraud by staff, building collapse), the bank must pay compensation up to 100 times the annual locker rent. For a locker with ₹5,000 annual rent, this means up to ₹5,00,000 in compensation.
