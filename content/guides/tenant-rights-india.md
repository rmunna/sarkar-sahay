...
keywords:
  - tenant rights india
  - renter protections india
  - tenant eviction rules
  - security deposit limit india
  - Model Tenancy Act 2021
  - Rent Control Act india
  - rent increase rules india
...
# Tenant Rights in India — Complete Guide to Renter Protections

Renting a home in India can feel overwhelming — tenants often face arbitrary evictions, excessive security deposits, and sudden rent hikes. But Indian law provides significant protections for renters. Whether you live in a metro city or a small town, understanding your rights as a tenant is essential to protect yourself from exploitation.
...
- **Right to privacy** — landlords cannot enter the property without notice
...
The **Model Tenancy Act 2021** was approved by the Union Cabinet on 2 June 2021. It is a model law — states can adopt it fully, partially, or with modifications. Key features:
...
1. **Non-payment of rent** — Failure to pay rent for a specified period (usually 2–3 months)
2. **Misuse of property** — Using residential property for commercial purposes without consent
3. **Subletting without permission** — Renting out the property (or part of it) to a third party without the landlord's written consent
4. **Causing damage** — Intentional damage to the property beyond normal wear and tear
5. **Personal use by landlord** — Landlord needs the property for genuine personal use (must prove the need in court)
6. **Reconstruction or demolition** — Property needs to be demolished or substantially repaired
7. **Agreement expiry** — Tenant refuses to vacate after the lease period ends (with proper notice)
...
- **No forceful eviction** is allowed — the landlord must obtain a court order
...
- **Under Rent Control Acts:** Rent increases are restricted — typically landlords can raise rent only by **5–10% annually** depending on the state
...
| Maharashtra | 4–5% for controlled premises |
...
- **Structural repairs** — walls, roof, foundation, plumbing lines, electrical wiring
- **Major repairs** that affect habitability
- Maintaining the property in a **livable condition**
- Ensuring **essential services** — water supply, sewage, electricity connections
...
1. Give a **written notice** to the landlord
2. If not addressed within a reasonable time, get the repair done and **deduct the cost from rent** (with proper documentation)
...
- File complaints online at [https://edaakhil.nic.in/](https://edaakhil.nic.in/)
...
5. **Know your state's Rent Control Act** — Laws vary significantly across states
6. **Never pay excessive security deposits** — Negotiate and cite the MTA's 2-month cap
7. **Get police verification done** — Many cities require tenant police verification; this also protects you
8. **Don't vacate without notice** — Follow the notice period in your agreement to avoid forfeiting your deposit
...
No. A landlord cannot forcefully evict a tenant. Eviction requires a valid legal ground and a **court order** (or Rent Court order under the MTA). Forceful eviction — such as changing locks, cutting electricity, or removing belongings — is illegal and the tenant can file a police complaint.
...
- File a complaint in the **Consumer Disputes Redressal Forum** ([edaakhil.nic.in](https://edaakhil.nic.in/))
...
No. Merely living in a rented property — even for decades — does **not** give the tenant ownership rights. The concept of "adverse possession" requires specific legal conditions (hostile, open, continuous possession for 12 years) and does not typically apply to tenants who acknowledge the landlord's ownership by paying rent.
