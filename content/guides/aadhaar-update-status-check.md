---
title: "How to Check Aadhaar Card Update Status Online"
description: "Step-by-step guide to check your Aadhaar update status online using URN or SRN on myAadhaar portal. Know status meanings, timelines, and what to do if rejected."
category: "Identity Documents"
keywords:
  - "aadhaar update status"
  - "aadhaar card update status check"
  - "aadhaar URN status"
  - "check aadhaar update"
  - "aadhaar update request number"
  - "aadhaar SRN status check"
  - "myaadhaar update status"
...
You can check this status anytime through the official **myAadhaar** portal at [myaadhaar.uidai.gov.in](https://myaadhaar.uidai.gov.in).
...
### Method 1: Using myAadhaar Portal (Recommended)

1. Open your browser and go to [myaadhaar.uidai.gov.in](https://myaadhaar.uidai.gov.in).
...
3. **Re-apply for the update:**
   - **Online:** Go to [myaadhaar.uidai.gov.in](https://myaadhaar.uidai.gov.in), log in, and submit a fresh update request with the correct documents.
   - **Offline:** Visit your nearest Aadhaar Seva Kendra with the correct original documents and submit a new request.
4. **Use valid Proof of Identity (POI) and Proof of Address (POA) documents** from the UIDAI-approved list. Check the valid documents list at [uidai.gov.in](https://uidai.gov.in).
...
You can still check your update status by logging into the myAadhaar portal ([myaadhaar.uidai.gov.in](https://myaadhaar.uidai.gov.in)) using your Aadhaar number and OTP. The portal shows your recent update requests even without the URN/SRN.
