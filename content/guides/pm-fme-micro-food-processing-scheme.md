...
keywords:
  ...
  - "pm fme micro food processing"
  - "fme scheme 10 lakh subsidy"
  - "food processing unit subsidy india"
  - "pm fme apply state"
  - "odop food processing subsidy"
  - "micro food processing scheme eligibility"
  - "pm fme 35 percent subsidy"
  - "food processing government grant india"
  - "pm fme 2024 apply"
officialLinks:
...
1. Go to **[pmfme.mofpi.gov.in](https://pmfme.mofpi.gov.in)**
...
ODOP (One District One Product) identifies one key agricultural/food product for each district that will be promoted as the local specialty. PM FME gives **priority approval** to units processing the ODOP product of their district. Check your district's ODOP at [www.onedistrict oneproduct.gov.in](https://odop.gov.in).
...
- Apply: [pmfme.mofpi.gov.in](https://pmfme.mofpi.gov.in)
- Ministry of Food Processing: [mofpi.gov.in](https://mofpi.gov.in)
