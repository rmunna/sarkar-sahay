...
Every pensioner in India — whether drawing Central Government, State Government, defence, or EPFO pension — must submit an annual **life certificate** (also called "proof of life" or जीवन प्रमाण पत्र) to continue receiving pension. Missing the deadline can lead to **pension stoppage without prior notice**.
...
If you've already read about Jeevan Pramaan basics, see our detailed [Jeevan Pramaan Digital Life Certificate guide](/guide/jeevan-pramaan-life-certificate-online) for app setup and biometric registration.
...
- **Grace period:** Some banks allow submission until December, but this is not guaranteed — pension may be held from December itself
...
**Steps:**
1. Download the **Jeevan Pramaan app** from Google Play Store or visit [jeevanpramaan.gov.in](https://jeevanpramaan.gov.in)
2. Enter your Aadhaar number, PPO number, pension account number, bank name, and mobile number
3. Authenticate using fingerprint or iris scan via a connected biometric device
4. On successful authentication, a **Pramaan ID** is generated
5. The digital life certificate is automatically sent to your pension-disbursing authority

You can also submit at any **Common Service Centre (CSC)** near you if you don't have a biometric device at home. CSC operators charge a nominal fee (typically ₹50–70).

For the full step-by-step walkthrough with screenshots, refer to our [Jeevan Pramaan guide](/guide/jeevan-pramaan-life-certificate-online).
...
**How it works:**
1. Open the **Jeevan Pramaan app** (latest version required)
2. Select **Face Authentication** as the biometric method
3. Enter Aadhaar, PPO, and pension details as usual
4. An OTP is sent to your Aadhaar-linked mobile number — enter it
5. The app captures your face using the front camera and matches it against your Aadhaar photo
6. On successful match, the digital life certificate is generated
...
- Lighting conditions matter — use in a well-lit room
...
The traditional method — visit your pension-disbursing bank branch in person.

**Process:**
1. Visit the bank branch where your pension account is held
2. Carry your **pension ID/PPO book**, **Aadhaar card**, and a **passport-size photograph**
3. The bank officer will verify your identity and record your life certificate
4. You'll receive an acknowledgment — keep it safe
...
Some banks have started accepting **video call-based** life certificates where the pensioner connects via a video call with a bank officer who verifies identity. Check with your specific bank whether this facility is available — it's not universally implemented yet.
...
| **Late penalty** | Pension held from December | Varies — some states issue notices before stopping |
...
If you're checking your pension status, see our [pension benefits and status guide](/guide/pension-benefits-status-online).

## Penalty for Late or Missed Submission

If you fail to submit your life certificate by the deadline:

- **Pension disbursement is stopped** — typically from December onward for central pensioners
- **No formal monetary penalty**, but you lose monthly pension payments until you submit
- **Arrears are paid** once you submit the life certificate — no pension amount is forfeited permanently
...
> **Tip:** If you're travelling abroad during November, submit your life certificate early (October for 80+ pensioners) or use the Jeevan Pramaan app from abroad — it works internationally as long as you have internet and a biometric device.
...
- Visit your nearest Aadhaar centre to update your mobile number — see our [Aadhaar card guide](/guide/aadhaar-card-apply-online)
...
- It takes **3–7 working days** for the digital certificate to reflect in bank records
...
- Peak load occurs in the last week of November — try early morning (6–9 AM) or late evening
- Update the app to the latest version
- Clear app cache and retry
- Use the web portal as a backup: [jeevanpramaan.gov.in](https://jeevanpramaan.gov.in)
...
Yes. Pensioners aged 80 and above can submit from 1st October. Others can submit anytime — the certificate is valid for 12 months from the date of generation. However, many banks specifically process certificates submitted during the November window.

### Is Jeevan Pramaan mandatory or can I submit physically?
Physical submission at your bank branch remains valid. Jeevan Pramaan is an additional digital option — not a replacement for physical submission. You can use whichever method is convenient.
...
Submit the certificate as soon as you are able. Carry hospital discharge documents to your bank — most banks will process a late submission and release pending pension with arrears. Some banks accept a medical certificate for temporary exemption.
...
Yes, if using Jeevan Pramaan with a biometric device. Face authentication also works abroad with an internet connection. Alternatively, some Indian embassies and consulates accept life certificates — check with your nearest Indian mission.
...
- [Jeevan Pramaan — Digital Life Certificate Online](/guide/jeevan-pramaan-life-certificate-online)
- [Old Age Pension (Vridha Pension) — How to Apply](/guide/old-age-pension-vridha-pension-apply)
- [Check Pension Benefits & Status Online](/guide/pension-benefits-status-online)
