...
description: "Track Indian passport application status online via Passport Seva Portal, mPassport app, and SMS. Understand status meanings and delivery tracking."
category: "Identity Documents"
keywords:
  - "passport status check"
  - "passport application status"
  - "track passport online"
  - "passport status by file number"
  - "passport seva status"
  - "mPassport Seva app"
  - "passport police verification status"
  - "passport delivery tracking"
  - "passport application tracking India"
  - "passport status check online India"
readingTime: "8 min"
officialLinks:
...
## Method 1: Track Online via Passport Seva Portal (Recommended)
...
1. Download **mPassport Seva** from [Google Play Store](https://play.google.com/store/apps/details?id=com.tcs.passport) or [Apple App Store](https://apps.apple.com/in/app/mpassport-seva/id586498104)
...
1. Go to **[portal2.passportindia.gov.in](https://portal2.passportindia.gov.in)**
...
1. Go to **[rtionline.gov.in](https://rtionline.gov.in)**
