...
# Mid-Day Meal Scheme (PM POSHAN) — Eligibility, Benefits, How It Works

The Mid-Day Meal (MDM) Scheme, now called **PM POSHAN Shakti Nirman** (PM POSHAN), is one of the world's largest school feeding programmes. It provides free cooked meals to children studying in government and government-aided schools across India. The goal is simple — no child should go hungry at school, and nutrition should support learning.

> **Related guide:** If your child is below 6 years, check the [Anganwadi Services (ICDS) Scheme](/guide/anganwadi-services-icds) for supplementary nutrition and pre-school education.

---

## Scheme Overview

The Mid-Day Meal programme started in 1995 as a national initiative. In September 2021, the Government of India renamed and expanded it as **PM POSHAN Shakti Nirman** for the period 2021–2026.
...
- **Tithi Bhojan** — community and private participation encouraged, where individuals or organisations can sponsor a meal on special occasions
- **School Nutrition Gardens** — schools are encouraged to grow vegetables and fruits in their premises to supplement meals
- **Use of fortified foods** — fortified rice, salt, and oil are being introduced to address micronutrient deficiencies
- **Digital monitoring** — Automated systems and Aadhaar-based tracking for transparency
- **Convergence with Ayushman Bharat** — health check-ups and nutrition tracking linked with school health programmes
...
| Category | Eligible? |
|---|---|
| Students of Classes 1 to 5 in government schools | ✅ Yes |
| Students of Classes 6 to 8 in government schools | ✅ Yes |
| Government-aided schools | ✅ Yes |
| Schools run by local bodies | ✅ Yes |
| Madrasas and Maqtabs supported under SSA/Samagra Shiksha | ✅ Yes |
| Private unaided schools | ❌ No |
| Students in classes 9 and above | ❌ No |
...
- States are required to provide **variety** — the same meal should not repeat daily
...
1. **Ask the school** — The headmaster or teacher can confirm if MDM/PM POSHAN is running
2. **Visit the PM POSHAN portal** — Go to [pmposhan.education.gov.in](https://pmposhan.education.gov.in) and search by state, district, and school
3. **Check UDISE+ portal** — School data on [udiseplus.gov.in](https://udiseplus.gov.in) includes MDM status
4. **Look for the kitchen/meal area** — Participating schools have a designated cooking area and mid-day meal display board
...
- **CPGRAMS Portal:** File a grievance at [pgportal.gov.in](https://pgportal.gov.in) — select Ministry of Education → Mid-Day Meal
...
- **Toll-free helpline:** Many states have their own MDM helpline numbers — check your state education department website
...
| Year | Budget (approx.) |
|---|---|
| 2024–25 | ₹12,467 crore |
| 2025–26 | ₹12,800 crore (estimated) |

The cooking cost per child per day (Central share) is approximately:

- **Primary:** ₹5.45 per child per day
- **Upper Primary:** ₹8.17 per child per day
