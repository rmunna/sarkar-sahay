...
keywords:
  ...
  - "obc scholarship post matric"
  - "obc scholarship scholarships.gov.in"
  - "central obc scholarship apply"
  - "dr ambedkar scholarship eligibility income"
  - "obc scholarship 1 lakh income limit"
  - "obc scholarship maintenance allowance"
  - "post matric scholarship obc documents"
  - "ministry social justice obc scholarship"
  - "obc scholarship 2024 apply"
officialLinks:
...
## What is Dr. Ambedkar Post Matric Scholarship for OBC?
...
3. Choose your state → find **"Post Matric Scholarship for OBC — Dr. Ambedkar"** under Central/State schemes
4. Fill in: personal details, OBC category details, income details, institution and course details
5. Upload documents and submit
6. Note your **Application ID**

### Renewal (Continuing Students)

Log in to [scholarships.gov.in](https://scholarships.gov.in) → "Renewal Application" → upload new marksheet + fee receipt → submit.

Apply/renew before the **October–November deadline** each academic year.

## Documents Required

1. **OBC caste certificate** — from Tehsildar / SDM / competent authority
2. **Income certificate** — annual family income **below ₹1 lakh** (from competent authority)
3. **Aadhaar card**
4. **Previous year marksheet** (or Class 10 marksheet for fresh applicants)
