---
title: "ATM Transaction Failed But Money Debited — How to Get Refund"
description: "ATM cash not dispensed but money debited? Learn RBI auto-reversal rules, how to complain to your bank, and get your refund step by step."
category: "Tax & Finance"
keywords: ["atm failed money debited", "atm cash not dispensed", "atm transaction failed refund", "atm money deducted not received", "atm complaint", "atm reversal time", "banking ombudsman complaint"]
readingTime: "9 min"
...
You withdrew cash at an ATM, the machine didn't dispense money (or dispensed less), but your bank account shows the full amount debited. This is called a **failed ATM transaction** or **unsuccessful transaction** — and it's more common than you think.

This guide explains **why it happens**, what **RBI rules** protect you, and exactly **how to get your refund** — whether the ATM belongs to your bank or a different bank.

## Why Does This Happen?

ATM cash-not-dispensed errors occur due to:

1. **Network timeout** — The transaction timed out between the ATM, switch (NPCI/NFS), and your bank's server. Your account got debited but the ATM didn't get confirmation to release cash.
2. **Cash jam or mechanical error** — The ATM's cash dispenser jammed mid-transaction. Money was counted internally but got stuck.
3. **Power failure** — Electricity cut during the transaction.
4. **Low cash in ATM** — The cassette ran out mid-dispensing.
5. **Software glitch** — The ATM software crashed after debiting your account.
...
- If the bank **fails to reverse** within T+5 days, you are entitled to **₹100 per day** as compensation for each day of delay.
- This compensation is **automatic** — you don't need to ask for it. The bank must credit it to your account.
...
## Immediate Steps — What to Do at the ATM
...
- If the receipt says **"Transaction Successful"** but you didn't get cash, keep that too — it proves a mismatch.
...
| **ICICI Bank** | 1800 1080 (toll-free) | — |
| **PNB** | 1800 180 2222 (toll-free) | — |
| **Bank of Baroda** | 1800 5700 (toll-free) | — |
| **Axis Bank** | 1860 419 5555 | — |
| **Canara Bank** | 1800 425 0018 (toll-free) | — |
| **Union Bank** | 1800 222 244 (toll-free) | — |
| **IDBI Bank** | 1800 209 4324 (toll-free) | — |
...
- **SBI:** Login → Services → ATM Transaction Dispute
- **HDFC:** Login → Help → Raise a Complaint → ATM/Debit Card
- **ICICI:** Login → Customer Service → Service Requests → ATM Transaction
- **PNB:** Login → Complaints → ATM Related
...
1. **Your complaint goes to your bank (Bank A)** — the card-issuing bank.
...
**Important:** This process can take slightly longer (7-10 days) because two banks are involved. But the T+5 auto-reversal rule and ₹100/day compensation still apply.
...
**Online (Recommended):**
1. Visit **[RBI CMS Portal](https://cms.rbi.org.in)** (Complaint Management System)
...
5. Select complaint category: **"ATM/Debit Card"** → **"Amount debited but cash not dispensed"**
...
10. Submit — note down the **Complaint Reference Number**
11. Track status anytime at the same portal using your reference number

## Important Tips

1. **Always collect ATM receipts** — they are your primary evidence. If the ATM doesn't print one, note the ATM ID from the machine.
2. **Enable SMS/push alerts** on your bank account so you get instant debit notifications.
3. **Don't panic** — RBI rules ensure you'll get your money back. Most reversals happen automatically within 3-5 days.
4. **Keep records** — Save complaint numbers, emails, and screenshots. You'll need them if you escalate.
5. **Check your statement after 5 days** — If the reversal hasn't happened, immediately contact your bank and mention the T+5 RBI rule and ₹100/day compensation.
...
### Q3: How do I get the ₹100/day compensation?
...
*This guide is for informational purposes only. CitizenNest is an independent platform and is not affiliated with any bank or the Reserve Bank of India. Always verify details on official bank websites and [RBI's website](https://rbi.org.in). Information is accurate as of March 2026.*
