...
2. **Ensure Aadhaar-bank linking** — the DBT goes to the bride's Aadhaar-linked account. See our [Aadhaar linking guide](/guide/aadhaar-linking-guide).
...
**A:** Yes, these are separate schemes with different purposes. You can apply for both if you meet the respective eligibility criteria. See our [Assam Orunodoi guide](/guide/assam-orunodoi-scheme) for details.
