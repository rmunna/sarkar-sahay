---
title: "How to Get Duplicate PAN Card — Lost, Damaged or Name Correction After Marriage"
...
For name correction after marriage, you must apply for **correction**, not reprint. See our detailed guide on [PAN card correction online](/guide/pan-card-correction-online).
...
1. Visit the [Protean PAN portal](https://www.onlineservices.nsdl.com/paam/endUserRegisterContact.html)
...
1. Go to [UTIITSL PAN portal](https://www.pan.utiitsl.com)
...
1. Visit the [e-Filing portal](https://eportal.incometax.gov.in/iec/foservices/#/pre-login/instant-e-pan)
...
This is the fastest method if you only need a digital PAN card. You can also [download your e-PAN card](/guide/download-e-pan-card-online) anytime from the portal.
...
You can check the status of your application anytime. See our guide on [how to check PAN card status](/guide/pan-card-status-check).
...
> **Tip:** Before surrendering, ensure your [Aadhaar is linked](/guide/aadhaar-pan-link) to the PAN you want to retain.
...
For a complete walkthrough, refer to our guide on [PAN card correction online](/guide/pan-card-correction-online).
...
- [Check PAN Card Application Status](/guide/pan-card-status-check)
