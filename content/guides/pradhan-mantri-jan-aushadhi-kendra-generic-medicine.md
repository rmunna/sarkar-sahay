...
1. Download **"Jan Aushadhi Sugam"** app:
   - [Google Play Store](https://play.google.com/store/apps/details?id=jan.aushadhi) (Android)
   - [App Store](https://apps.apple.com/in/app/janaushadhi-sugam/id1442082454) (iOS)
2. The app shows:
...
> For the complete searchable list, use the **Jan Aushadhi Sugam app** or visit [janaushadhi.gov.in](https://janaushadhi.gov.in).
