---
title: "Indian Forest Service (IFoS) Exam Guide — Eligibility, Pattern, Syllabus & Tips"
description: "Complete guide to UPSC IFoS exam 2026 with eligibility, exam pattern, optional subjects, application process, fees, and preparation tips."
category: "Jobs & Exams"
keywords: ["IFoS exam", "Indian Forest Service exam", "UPSC IFoS", "IFoS eligibility", "IFoS syllabus", "IFoS optional subjects", "forest service exam India"]
readingTime: "10 min"
lastUpdated: "2026-02-18"
officialLinks:
  - "https://upsc.gov.in"
  - "https://upsconline.nic.in"
  - "https://upsc.gov.in/examinations/indian-forest-service"
---

# Indian Forest Service (IFoS) Exam Guide — Eligibility, Pattern, Syllabus & Tips
...
This guide covers everything you need to know about the IFoS exam — eligibility, exam pattern, optional subjects, how to apply, fees, and preparation strategy.
...
The IFoS exam has three stages. Only Mains + Interview marks count for final merit — Prelims is purely a screening test.
...
| Paper II | CSAT (Aptitude) | 200 | 2 hours | Objective (MCQ) — Qualifying only (33% needed) |
...
| Paper III | Optional Subject 1 — Paper 1 | 200 |
| Paper IV | Optional Subject 1 — Paper 2 | 200 |
| Paper V | Optional Subject 2 — Paper 1 | 200 |
| Paper VI | Optional Subject 2 — Paper 2 | 200 |
| **Total** | | **1,400** |
...
1. **Register on UPSC portal** — Visit [upsconline.nic.in](https://upsconline.nic.in) and complete the One-Time Registration (OTR) if you haven't already.
2. **Apply for Civil Services (Preliminary) Examination** — IFoS Prelims is conducted through CSE Prelims. In the application form, indicate your preference for IFoS.
3. **Fill personal and educational details** — Enter your name, date of birth, qualifications, and preferred exam centres.
4. **Upload documents** — Upload your photograph, signature, and ID proof as per specified dimensions.
5. **Pay application fee** — Pay online (UPI/debit/credit card/net banking) or offline at SBI.
6. **Download confirmation** — Save your application receipt and registration number.
7. **After qualifying Prelims** — Apply separately for IFoS Mains through the UPSC portal and pay the additional Mains fee.
...
|-------|---------------------------|----------------------|
| Prelims (CSE application) | ₹100 | Exempted |
| Mains (additional fee) | ₹200 | Exempted |
...
1. **Focus on Environment & Ecology** — This topic carries high weightage and directly relates to IFoS. Study Shankar IAS Environment book thoroughly.
2. **Cover standard UPSC GS syllabus** — Use NCERTs (Class 6–12) for History, Geography, Polity, and Economy.
3. **Practice previous year papers** — Solve at least 10 years of CSE Prelims papers.
4. **Don't neglect CSAT** — Score at least 33% to avoid disqualification. Practice basic maths and comprehension.
5. **Read current affairs regularly** — Follow one newspaper and a monthly current affairs magazine.

### For Mains

1. **Choose optional subjects wisely** — Pick subjects you studied in graduation. Overlap between optionals helps.
2. **Study optional subjects deeply** — Use standard textbooks at Honours/BSc level. Engineering optionals are at Bachelor's level.
3. **Practice answer writing** — Mains requires descriptive answers. Write practice answers within time limits.
4. **General English matters** — Practice essay writing, precis, and comprehension. This paper carries 300 marks.
5. **General Knowledge paper** — Study environment, Indian history, geography, polity, and science analytically (not just facts).
...
1. **Start early** — IFoS preparation overlaps with IAS Prelims. Begin at least 12–14 months before the exam.
2. **Choose optionals from your graduation subjects** — This saves time and gives you a natural advantage.
3. **Don't ignore General English** — At 300 marks, it can make or break your rank. Practice essay and precis writing weekly.
4. **Study environment & ecology in depth** — This is relevant for both Prelims GS and your career as a forest officer.
5. **Make notes from Day 1** — Short, revision-friendly notes for each subject save enormous time before the exam.
6. **Attempt mock tests regularly** — For Prelims, take weekly full-length tests. For Mains, write timed answers.
7. **Stay updated on forest & wildlife news** — Follow MoEFCC notifications, Project Tiger updates, and international environmental agreements.
...
No. IFoS (Indian Forest Service) and IAS (Indian Administrative Service) are different services. However, both share the same Prelims exam (Civil Services Preliminary Examination). The Mains exams are completely different — IFoS Mains is science/technical-focused.
...
IFoS officers start at **Pay Level 10** (₹56,100 – ₹1,77,500 per month) under the 7th Pay Commission. With allowances, the starting in-hand salary is approximately ₹80,000–₹1,00,000 per month, depending on posting location.

### 5. How many vacancies are there in IFoS every year?

The number varies each year. For IFoS 2026, UPSC has announced **80 vacancies**. In recent years, vacancies have ranged between 80–150 posts.
...
- UPSC Official Website: [https://upsc.gov.in](https://upsc.gov.in)
- Online Application Portal: [https://upsconline.nic.in](https://upsconline.nic.in)

---

> **Disclaimer:** CitizenNest is an independent informational platform. We are **not affiliated** with UPSC or any government body. Always verify details from the official UPSC website before applying. Information is accurate as of the last updated date.
