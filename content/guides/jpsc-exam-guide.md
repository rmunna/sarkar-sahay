...
# JPSC Exam Guide — Jharkhand Public Service Commission
...
- **Civil Services (Combined)** — Deputy Collector, DSP, Planning Officer, Block Development Officer
- **Other Posts** — Assistant Engineer, Medical Officer, and various departmental posts
...
- Paper 2 is qualifying (minimum 33%) — only Paper 1 marks count for cutoff
...
- **Total Merit Marks:** 800 (Papers 3–6)
...
1. Visit [www.jpsc.gov.in](https://www.jpsc.gov.in)
...
Prelims has 1/3 negative marking — avoid random guessing. Attempt only questions you are reasonably confident about.
...
Mains is descriptive — practice writing structured essays and answers with proper introduction, body, and conclusion.
...
No, JPSC does not have a fixed annual schedule. Exams are notified based on vacancy positions, and there can be gaps of 1–2 years between notifications.
...
JPSC combined civil services typically advertises 150–300 posts per notification, though this varies significantly.
...
Selected candidates in civil services start at Pay Level 9–10 (₹44,900–₹56,100 basic) with DA, HRA, and other allowances. Total initial take-home ranges from ₹55,000–₹75,000.
