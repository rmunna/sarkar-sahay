...
> **Important:** Most deductions listed here apply only under the **Old Tax Regime**. The New Tax Regime (default from FY 2023-24) offers lower slab rates but very few deductions. Read the [Old vs New Tax Regime comparison](/guide/old-tax-regime-vs-new-tax-regime) to decide which one suits you.

## Section 80C — The Most Popular Deduction (₹1.5 Lakh Limit)

[Section 80C](/guide/section-80c-deductions-guide) is the most widely used tax-saving section. You can claim deductions up to **₹1,50,000** per financial year on eligible investments and expenses.
...
1. **Check your EPF contribution first** — If your basic salary is ₹50,000/month, your EPF contribution is ₹6,000/month = ₹72,000/year already under 80C
2. **Invest the remaining** in [PPF](/guide/ppf-account-open-guide) or ELSS to fill the ₹1.5 lakh limit
3. **Tuition fees** for your children's education also count — don't forget to claim this
4. **Home loan principal** repayment is automatically eligible

## Section 80D — Health Insurance Premium (₹25,000–₹1,00,000)

[Section 80D](/guide/health-insurance-buy-claim-process) allows deduction on health insurance premiums paid for yourself, family, and parents.
...
The [National Pension System (NPS)](/guide/national-pension-scheme-nps) offers an **additional deduction of ₹50,000** under Section 80CCD(1B), over and above the ₹1.5 lakh limit of Section 80C.
...
> **No HRA in salary?** Self-employed or salaried people without HRA can claim deduction under **Section 80GG** (up to ₹5,000/month or ₹60,000/year). Read more in our [HRA claim guide](/guide/hra-claim-without-rent-receipt).
...
> **Tip:** Calculate tax under both regimes using the [Income Tax Department portal](https://eportal.incometax.gov.in) or any online calculator before choosing. Read our detailed [Old vs New Tax Regime guide](/guide/old-tax-regime-vs-new-tax-regime).
...
- Learn more: [PPF Account Guide](/guide/ppf-account-open-guide)
...
- Learn more: [NPS Guide](/guide/national-pension-scheme-nps)
...
- Learn more: [Tax Saving FD Guide](/guide/tax-saving-fixed-deposit)
...
- [ ] **Check your Form 26AS/AIS** on the [IT portal](https://eportal.incometax.gov.in) for TDS already deducted
...
Keep all investment proofs, rent receipts, premium receipts, and donation receipts safely. You may need them during [ITR filing](/guide/income-tax-return-file-online) or if you receive a [tax notice](/guide/income-tax-notice-response).
...
Collect all investment proofs and premium receipts, download Form 16 from your employer, and file your [Income Tax Return online](/guide/income-tax-return-file-online) on the IT portal before July 31.
