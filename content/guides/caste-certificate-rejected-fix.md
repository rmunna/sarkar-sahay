...
keywords:
  ...
  - "caste certificate application rejected reason"
  - "how to fix rejected caste certificate"
  - "caste certificate re-apply"
  - "jati praman patra rejected"
  - "caste certificate appeal process"
  - "eSathi caste certificate rejected"
  - "caste certificate wrong documents"
  - "caste certificate verification failed"
  - "जाति प्रमाण पत्र रिजेक्ट"
  - "caste certificate rejected solution"
  - "caste certificate resubmit online"
readingTime: "9 min"
...
> Already familiar with the application process? Jump to [How to Re-Apply](#how-to-re-apply-after-rejection) or [Appeal Process](#appeal-process-if-re-application-fails).
...
> **Related:** [How to Apply for OBC / EWS Certificate Online](/guide/obc-ews-certificate-apply-online) — covers income limits and creamy layer rules in detail.
...
1. Go to [esathi.up.gov.in](https://esathi.up.gov.in)
...
> **Detailed guide:** [UP Caste Certificate via eSathi — Complete Guide](/guide/up-caste-certificate-esathi)
...
- **UP:** [jansunwai.up.nic.in](https://jansunwai.up.nic.in) — file a complaint online
- **Central:** [pgportal.gov.in](https://pgportal.gov.in) — Public Grievance Portal
...
> **Related Guides:**
> - [OBC / EWS Certificate — Apply Online](/guide/obc-ews-certificate-apply-online)
> - [UP Caste Certificate via eSathi Portal](/guide/up-caste-certificate-esathi)
