...
keywords:
  ...
  - free school meal india
  - mid day meal eligibility
  - pm poshan shakti nirman
  - school nutrition programme
  - midday meal scheme 2024
  - government school free food
  - pm poshan benefits
readingTime: "7 min"
officialLinks:
...
# PM POSHAN Mid-Day Meal Scheme: Benefits, Eligibility, and How It Works
...
### Key Points
- No separate application or registration is needed — all enrolled children automatically benefit
- The scheme applies across all states and union territories
- Both boys and girls are equally eligible
- No income or caste criteria — every child enrolled in an eligible school receives the meal
...
### Meal Components
- **Rice/Wheat** — as the primary cereal
- **Dal/Pulses** — for protein
- **Vegetables** — seasonal and locally available
- **Oil and fat** — for cooking
- **Micronutrients** — fortified rice is being supplied in many states
- **Supplementary nutrition** — milk, eggs, fruits, or additional items as per state government norms
...
2. **No separate application** is required — meals are automatically provided to all enrolled students
...
3. Schools engage **cook-cum-helpers** — 1 cook for up to 25 students, 2 cooks for 26-100 students
4. Schools must maintain hygiene standards and follow FSSAI guidelines
5. **Tithi Bhojan** — community participation is encouraged where individuals/organizations can sponsor special meals on occasions

### Cooking Cost (per child per day)

| Category | Central Share | State Share |
|----------|--------------|-------------|
| Primary (Class 1-5) | ₹5.45 | As per state norms |
| Upper Primary (Class 6-8) | ₹8.17 | As per state norms |
...
- **Tithhi Bhojan** — community and corporate participation in providing special meals
- **School Nutrition Gardens** — schools are encouraged to develop kitchen gardens for fresh vegetables
- **Fortified Rice** — supply of iron, folic acid, and Vitamin B12 fortified rice to improve nutrition
- **Direct Benefit Transfer (DBT)** — cooking cost is transferred directly to school accounts
- **Social audit** — mandatory social audits for transparency
- **MERA (Monitoring and Evaluation of Reforms through AI)** — use of technology for monitoring meal quality and delivery

---

## Important Tips

1. **Check your child's school** — confirm with the school if they are covered under PM POSHAN
2. **Report quality issues** — if the food quality is poor or meals are not being served, report to the school management committee (SMC)
3. **Participate in Tithi Bhojan** — community members can contribute to enhancing the meal experience
4. **School Nutrition Garden** — encourage the school to maintain a kitchen garden for fresh vegetables
5. **Grievance redressal** — complaints can be filed on the PM POSHAN portal or through the state education department
...
Report the issue to the School Management Committee (SMC), Block Education Officer (BEO), or file a complaint on the PM POSHAN portal at [pmposhan.education.gov.in](https://pmposhan.education.gov.in/).
...
*Disclaimer: This guide is for informational purposes only and is not affiliated with the Government of India. For official information, visit [pmposhan.education.gov.in](https://pmposhan.education.gov.in/).*
