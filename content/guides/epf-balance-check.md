...
- **UAN activated** — activate once at [unifiedportal-mem.epfindia.gov.in](https://unifiedportal-mem.epfindia.gov.in/memberinterface/) if not already done
...
**URL:** [passbook.epfindia.gov.in](https://passbook.epfindia.gov.in/MemberPassBook/Login)

**Steps:**
1. Go to the passbook portal
2. Enter your **UAN** and **password**
3. Click **Login**
4. Select your **Member ID** (if you have worked at multiple employers, you'll see multiple IDs)
5. Click **View Passbook**
6. The passbook shows:
...
**Steps:**
1. Download **UMANG** from Google Play or App Store
...
6. Enter your UAN → authenticate with OTP on your registered mobile
7. View your balance and passbook
...
**URL:** [unifiedportal-mem.epfindia.gov.in](https://unifiedportal-mem.epfindia.gov.in/memberinterface/)

**Steps:**
1. Log in with UAN and password
2. Go to **"View" → "Passbook"** — redirects to the passbook portal (Method 1)
3. Also accessible here:
...
| Grievances online | [epfigms.gov.in](https://epfigms.gov.in) |
...
Your UAN is on your payslip. You can also ask HR — employers are obligated to share it. Alternatively, search by PF account number at [unifiedportal-mem.epfindia.gov.in](https://unifiedportal-mem.epfindia.gov.in/memberinterface/) under "Know Your UAN."
...
Check if the contribution month shows in the passbook. If absent after 45 days of salary, the employer may not have filed the ECR. Raise a grievance at [epfigms.gov.in](https://epfigms.gov.in) or call 14470.
