...
A special zero balance account under the [PM Jan Dhan Yojana](/guide/pm-jan-dhan-yojana) scheme launched by the Government of India. Benefits include:
...
> **Tip:** Keep your documents uploaded on [DigiLocker](/guide/digilocker-guide) for quick verification during the online process.
...
The [PM Jan Dhan Yojana](/guide/pm-jan-dhan-yojana) (PMJDY) account can be opened:

### Online
- Through bank's website/app (SBI YONO, etc.) — select "BSBD" or "Jan Dhan" option

### Offline (Recommended for first-time users)
