...
officialLinks:
  ...
  - "https://megsocialwelfare.gov.in"
---

# Focus+ Scheme Meghalaya – Complete Guide 2026
...
| Component | Details |
|-----------|---------|
| Monthly cash support | ₹1,000-2,000 per family |
...
1. The programme is **not open-application** — families are identified through **community-level participatory exercises**
2. **Village Dorbars (councils)** conduct wealth ranking and identify the poorest families
3. Identified families are verified by the **Block Development Office** and **MBDA**
4. Selected families are enrolled and **assigned a community facilitator**
5. Families receive livelihood plans, cash support, and training

### Self-Referral / Application

1. If you believe your family qualifies, visit the **Block Development Office** or **Community & Rural Development (C&RD) Department**
2. Express interest in the Focus+ programme
3. Your family details will be verified against the poverty identification database
4. If eligible, you will be included in the next programme cycle
...
1. **Engage with your village Dorbar** — selection happens at the community level
2. **Participate actively in training** — livelihood assets are provided after skill training
3. **Join or form an SHG** — group-based support is a key component
4. **Save regularly** — the programme encourages savings habits
5. **Maintain records** of all support received for future reference
...
**A:** Assets include **livestock (pigs, poultry), agricultural inputs, weaving equipment, small business tools** — based on the family's chosen livelihood path.
...
**A:** **No cost**. All support — cash, assets, training — is provided free of charge.

---

*Disclaimer: This guide is published by CitizenNest for informational purposes only. We are not affiliated with the Government of Meghalaya. Visit [meghalaya.gov.in](https://meghalaya.gov.in) for official information. Current as of March 2026.*
