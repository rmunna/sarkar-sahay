...
description: >-
  Complete guide to applying for an International Driving Permit in India —
  online via Parivahan Sarathi and offline at RTO. Documents, fees, validity,
  and...
...
keywords:
  ...
  - IDP documents required
  - international driving permit RTO
  - IDP India validity
...
Planning to drive abroad? You'll most likely need an **International Driving Permit (IDP)** — a document that translates your Indian driving licence into multiple languages so foreign authorities can understand it. Here's everything you need to know about getting one.

> **Already have a driving licence?** If not, first check our guide on [how to apply for a driving licence](/guide/driving-license-apply-online). If your licence has expired, see [how to renew your driving licence](/guide/driving-license-renewal-online).

## What is an International Driving Permit?

An International Driving Permit (IDP) — sometimes called an International Driving Licence — is an official document issued by the Regional Transport Office (RTO) that allows you to drive in foreign countries. It is essentially a **translation of your Indian driving licence** into several international languages as per the Geneva and Vienna conventions.
...
| Detail | Info |
|--------|------|
| **Validity** | 1 year from date of issue, or until your Indian DL expires — whichever is earlier |
| **Can be renewed?** | No — you must apply fresh each time |
...
1. **Valid Indian Driving Licence** (original + photocopy)
2. **Valid Passport** (original + photocopy of first and last page)
3. **Valid Visa** of the country you're visiting (photocopy)
4. **Passport-size photographs** — 4 to 6 recent colour photos (as per RTO requirement)
5. **Address proof** — Aadhaar card, utility bill, or bank statement
6. **Application form** (Form 4-A) — available at RTO or downloadable from Parivahan

### Additional Documents (may be required at some RTOs)

- **Air ticket** or travel itinerary (proof of travel)
- **Medical certificate** (Form 1-A) — required for certain vehicle categories or if your DL doesn't have one
- **Age proof** — if not mentioned on your driving licence
...
Go to [sarathi.parivahan.gov.in](https://sarathi.parivahan.gov.in/) and select your **state**.
...
Pay the IDP fee of approximately **₹1,000** via net banking, debit/credit card, or UPI.
...
1. **Visit your nearest RTO** during working hours
2. **Collect Form 4-A** (Application for International Driving Permit) from the counter or download it from the Parivahan website
3. **Fill the form** completely and attach passport-size photographs
4. **Submit the form** along with photocopies of all required documents
5. **Pay the fee** at the RTO counter (₹1,000 approximately)
6. **Document verification** — the RTO officer will verify your original documents
7. **Collect your IDP** — usually issued on the **same day** or within 2-3 working days
...
| Service/processing charge (online) | ₹50–₹100 |
| **Total** | **₹1,000–₹1,100** |
...
| **Online + RTO visit** | 3–7 working days (including appointment wait) |
...
1. **Carrying IDP without your Indian DL** — The IDP is not valid on its own. Always carry both.
2. **Applying with an expired driving licence** — Your DL must be valid. [Renew it first](/guide/driving-license-renewal-online) if needed.
3. **Not checking destination country rules** — Some countries have specific requirements beyond just the IDP.
4. **Wrong vehicle category** — Make sure your IDP covers the vehicle type you plan to drive abroad.
5. **Applying too late** — Apply at least 2-3 weeks before your travel date to be safe.
6. **Not carrying passport-size photos** — RTOs often need extra photos. Carry 6 to be safe.
7. **Assuming IDP works everywhere** — A few countries don't recognise IDP and require their own licence or permit.
