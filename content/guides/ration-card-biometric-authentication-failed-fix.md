...
keywords:
  ...
  - epos machine fingerprint not matching
  - ration shop biometric error
  - fingerprint not working ration card
  - epos machine not working
  - ration card aadhar authentication failed
  - ration biometric verification failed
  - epos server down ration
  - ration card fingerprint problem
  - alternative verification ration shop
readingTime: "7 min"
...
# Ration Card Biometric Authentication Failed at ePoS Machine — How to Fix
...
- Press your finger firmly but gently on the scanner — don't press too hard or too lightly
- Try different fingers — the ePoS machine usually accepts any finger
...
- Many states allow dealers to distribute ration through **OTP-based verification** — an OTP is sent to the registered mobile number
...
- Rules vary by state — ask the dealer about the exception process
...
4. Fee: ₹100 for biometric update (if not free under government scheme)
5. Updated biometrics take **7-10 days** to reflect in the system

You can find the nearest Aadhaar centre at [https://uidai.gov.in/](https://uidai.gov.in/) → "Locate Aadhaar Centre".
...
- **This is not your fault** — the UIDAI server or state server is temporarily down
...
- **State helplines** vary — search "[your state] ration card complaint number"

### Step 4: File Online Complaint
- Visit [https://pgportal.gov.in/](https://pgportal.gov.in/) (Centralized Public Grievance Portal)
...
1. **Try iris scanning** if fingerprints consistently fail — it's more reliable for manual laborers and elderly
...
4. **Visit during off-peak hours** — server load is lower early morning and after 3 PM
5. **Know your rights** — Dealers cannot refuse ration if the server is down. They must use alternative methods.
...
*Related: See our [Aadhaar biometric update guide](/guide/aadhaar-card-apply-online) for updating your fingerprints and iris data.*

> **Disclaimer:** CitizenNest is an independent platform and is not affiliated with any government body. Information is provided for educational purposes. Rules vary by state — always verify with your local food department.
