---
title: "CLAT Exam — How to Apply, Eligibility & Benefits"
...
# CLAT 2026 — Common Law Admission Test Complete Guide
...
- **Minimum Marks:** General/OBC/PWD — 45% aggregate. SC/ST — 40% aggregate.
...
- **Minimum Marks:** General/OBC/PWD — 50% aggregate. SC/ST — 45% aggregate.
...
1. **English Language** — Reading comprehension passages covering vocabulary, grammar, and sentence correction. No direct grammar questions — everything is passage-based.

2. **Current Affairs & General Knowledge** — News, events, and developments from the past 12 months. Covers national/international affairs, sports, awards, government schemes, and legal news.

3. **Legal Reasoning** — Passage-based questions testing your ability to read legal rules, apply them to fact situations, and draw conclusions. No prior legal knowledge required.

4. **Logical Reasoning** — Identifying patterns, drawing inferences, analogies, syllogisms, and critical reasoning from passages.

5. **Quantitative Techniques** — Basic maths up to Class 10 level — percentages, ratios, averages, data interpretation, and simple arithmetic.
...
1. **Visit** the official CLAT website: [consortiumofnlus.ac.in](https://consortiumofnlus.ac.in)
...
- Focus on legal reasoning — read passages carefully and practise applying rules to facts
...
- **Maths:** RS Aggarwal (Quantitative Aptitude) — Class 10 level chapters only
...
1. **Merit List** — A common merit list is prepared based on CLAT scores
2. **Preference Filling** — Candidates fill their NLU and course preferences online
3. **Seat Allotment** — Seats are allotted in multiple rounds based on rank and preference
4. **Fee Payment & Reporting** — Accepted candidates pay the fee and report to the allotted NLU
5. **Spot Round** — Vacant seats are filled in a final spot counselling round
...
- NLU Jodhpur (NLUJ)
- WBNUJS Kolkata (NUJS)
- NLU Delhi (issues its own AILET exam — does NOT accept CLAT)
- GNLU Gandhinagar
- RMLNLU Lucknow
- HNLU Raipur
- CNLU Patna
...
1. **Read the newspaper daily** — At least 30 minutes. Current affairs carry the highest weightage in CLAT UG.

2. **Focus on passage-based practice** — CLAT is entirely passage-based now. Direct knowledge questions are rare. Train yourself to read and analyse passages quickly.

3. **Time management is everything** — You get just 1 minute per question. Practice with a timer from day one.

4. **Don't skip Maths** — Quantitative Techniques is the easiest section to score full marks. Basic Class 10 maths is enough.

5. **Take at least 30 mock tests** — Mock tests are the single best way to improve your score. Analyse every test thoroughly.

6. **Avoid negative marking traps** — With −0.25 penalty, random guessing hurts. Skip questions you have no clue about.

7. **Stay updated on exam notifications** — Follow the official CLAT website and set alerts for important dates.
...
The application fee is ₹4,000 for General/OBC/PWD candidates and ₹3,500 for SC/ST candidates.
...
Results are usually declared within 2–3 weeks after the exam. Check the [official CLAT website](https://consortiumofnlus.ac.in) for exact dates.
...
- [UPSC Civil Services Exam Guide](/guide/upsc-civil-services-preparation-guide)
- [SSC CGL Exam Guide](/guide/ssc-cgl-vs-ssc-chsl-comparison)
- [Government Jobs After Graduation](/guide/government-jobs-apply-online)

---

*This guide is for informational purposes only. Always verify details from the [official CLAT website](https://consortiumofnlus.ac.in) before applying. Exam patterns, fees, and dates may change — check the latest notifications regularly.*
