---
title: "GST Registration Application Rejected — How to Fix"
description: >-
...
keywords:
  ...
  - gst aadhaar authentication failed
  - gst registration reapply
  - gst place of business verification failed
  - gst registration appeal
  - gst reg-03
  - gst reg-05
  - gst registration document rejected
...
# GST Registration Application Rejected — How to Fix

Your GST registration application (REG-01) can be rejected by the tax officer after scrutiny. Before outright rejection, the officer issues a **Show Cause Notice (SCN) in Form REG-03**, giving you a chance to respond. If your response is unsatisfactory — or you miss the deadline — the application is rejected via **Form REG-05**.
...
**How to fix:**
- Ensure your Aadhaar has an active mobile number linked — check at [myaadhaar.uidai.gov.in](https://myaadhaar.uidai.gov.in/)
...
- Bank proof must show account holder name, account number, IFSC, and branch — a cancelled cheque or bank statement first page works
...
1. **Log in** to the GST portal → [services.gst.gov.in](https://services.gst.gov.in/services/login)
2. Go to **Services → Registration → Application for Filing Clarifications**
3. Your pending SCN (REG-03) will be displayed — click on it
...
- **Address every point** raised in the SCN — don't skip any
...
You can re-apply immediately — there is **no cooling-off period** for fresh GST registration applications.
...
1. Go to [gst.gov.in](https://www.gst.gov.in/) → **Services → Registration → New Registration**
...
4. Upload **APL-01** with:
   ...
   - Grounds of appeal — explain why the rejection was wrong
...
| Total time (if approved after clarification) | ~15–25 working days |
| Appeal filing deadline (APL-01) | 3 months from rejection |
| Appeal disposal | Up to 6 months |
| Fresh re-application processing | 7–15 working days |
...
### Aadhaar authentication keeps failing — can I skip it?
...
The rejection order (REG-05) mentions the issuing authority. You can also check under **Services → Track Application Status** on the GST portal.

### My documents are correct but still rejected — what should I do?
...
- **GST Login:** [services.gst.gov.in](https://services.gst.gov.in/services/login)
- **GST Tutorials:** [tutorial.gst.gov.in](https://tutorial.gst.gov.in/)
- **CBIC GST:** [cbic-gst.gov.in](https://cbic-gst.gov.in/)
