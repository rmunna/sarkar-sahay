...
- **Identity proof**: [Aadhaar card](/guide/aadhaar-card-apply-online), voter ID, or [ration card](/guide/ration-card-type-priority-antyodaya)
...
File a complaint with the food inspector or call the **1967 helpline**. You can also file a written complaint with the District Supply Officer. See our [ration complaint guide](/guide/ration-not-received-complaint) for detailed steps.
...
*Disclaimer: CitizenNest is an independent informational platform and is not affiliated with any government body. Information is sourced from official government websites and may change. Always verify with your local district administration for the latest details.*
