...
> **Note:** If you have a [PM Jan Dhan Yojana](/guide/pm-jan-dhan-yojana) account, you can directly enrol in APY through the same bank.
...
2. Fill the **APY registration form** (available at the branch or download from [jansuraksha.gov.in](https://jansuraksha.gov.in))
...
- **AadhaarPay** and bank mobile apps
- **eNPS portal** at [enps.nsdl.com](https://enps.nsdl.com/eNPS/NationalPensionSystem.html)

### For Jan Dhan Account Holders

If you opened an account under [PM Jan Dhan Yojana](/guide/pm-jan-dhan-yojana), you can enrol in APY at the same branch. Auto-debit will be set up on your Jan Dhan account. This was one of the key design features — linking social security to financial inclusion.
...
1. Visit the **NPS/APY portal** at [npscra.nsdl.co.in](https://npscra.nsdl.co.in)
...
If you also contribute to [EPF/PF](/guide/epf-pf-withdrawal-online), your combined deduction under Section 80C applies. Plan your investments accordingly.
...
You can still join APY. It is separate from [EPF/PF](/guide/epf-pf-withdrawal-online). Both can run in parallel.
...
*Last updated: February 2026. Always verify details on [jansuraksha.gov.in](https://jansuraksha.gov.in) before applying.*
