---
title: "How to Find Nearest Aadhaar Centre — Google Maps, UIDAI Portal, Aadhaar Seva Kendra"
description: "Find the nearest Aadhaar centre using Google Maps, UIDAI portal, or Aadhaar Seva Kendra. Step-by-step methods to locate centres near you."
category: "Identity Documents"
keywords: ["aadhaar centre near me", "find aadhaar centre", "aadhaar enrolment centre", "aadhaar seva kendra", "UIDAI centre locator", "aadhaar centre google maps"]
readingTime: "7 min"
officialLinks:
  - https://uidai.gov.in
  - https://appointments.uidai.gov.in
  - https://baal.uidai.gov.in
---

## Types of Aadhaar Centres in India
...
Aadhaar Seva Kendras are dedicated, government-run centres set up by UIDAI in **78 districts** across India. These are the most well-equipped centres offering the full range of Aadhaar services — new enrolment, biometric update, demographic update, and address change. ASKs typically support walk-in visits, though booking an appointment is recommended.
...
|---|---|---|---|
| Aadhaar Seva Kendra (ASK) | ✅ Yes | ✅ Yes | Recommended |
| Permanent Enrolment Centre (PEC) | ✅ Yes | ✅ Yes | Required |
| Bank Branch | ❌ Usually No | ✅ Yes | Varies |
| Post Office | ❌ Usually No | ✅ Yes | Varies |

---

## Method 1: Google Maps (NEW — UIDAI Partnership)
...
- **Authorized centres only** — verified by UIDAI, reducing the risk of visiting fraudulent centres
- **Services available** — whether a centre offers new enrolment, updates, or both
- **Operating hours** — exact timings so you can plan your visit
- **Accessibility information** — wheelchair access and other facilities
- **Real-time directions** — navigate directly to the centre
...
1. Go to [uidai.gov.in](https://uidai.gov.in)
2. Navigate to **"My Aadhaar"** → **"Locate an Enrolment Centre"**
...
- **Full range of services** — new enrolment, biometric update, demographic update, address change, mobile/email update
- **Walk-in friendly** — most ASKs accept walk-in visitors, though appointments are preferred
- **Professional setup** — dedicated staff, better equipment, and shorter processing times
- **Accessible** — designed to be accessible to persons with disabilities
...
- Some centres may have different timings — verify before visiting
...
4. Some banks list this on [appointments.uidai.gov.in](https://appointments.uidai.gov.in)
...
1. Go to [appointments.uidai.gov.in](https://appointments.uidai.gov.in)
2. Click **"Book Appointment"**
3. Enter your **mobile number** — an OTP will be sent
4. Verify the OTP
...
8. Confirm your appointment — you'll receive an **appointment slip** via SMS
9. **Save or print** the appointment slip — carry it when you visit
...
| Biometric Update | ✅ | ✅ | ✅ | ✅ |
| Photo Update | ✅ | ✅ | ❌ | ❌ |
| [Baal Aadhaar Enrolment](/guide/baal-aadhaar-child-aadhaar-card) | ✅ | ✅ | ❌ | ❌ |
...
**Proof of Address:** Passport, Bank Statement (last 3 months), Utility Bill (electricity/water/gas — last 3 months), Ration Card, Voter ID, Driving License, Rent Agreement with notarization

> For a complete list and detailed guide, see: [How to Apply for Aadhaar Card Online](/guide/aadhaar-card-apply-online)

### For Aadhaar Updates

- **Address change:** New address proof document — [Complete guide to Aadhaar address change](/guide/aadhaar-address-change-online)
- **Mobile/Email update:** Your current mobile phone (for OTP) — [Update mobile & email guide](/guide/aadhaar-update-mobile-email)
- **Name correction:** Supporting document with correct name
- **Biometric update:** No document needed, just visit the centre
...
1. **Book an appointment** — walk-ins often face 2-3 hour waits
2. **Visit early morning** — centres are least crowded between 9:30 AM and 11:00 AM
3. **Avoid month-end** — many people rush for updates before deadlines
4. **Carry originals** — photocopies alone are not accepted
5. **Clean your fingers** — dirt or moisture can affect fingerprint scanning. Wash and dry hands before biometric capture
6. **Remove contact lenses** — coloured lenses can interfere with iris scanning
7. **Dress children comfortably** — for [Baal Aadhaar](/guide/baal-aadhaar-child-aadhaar-card), ensure the child is calm and cooperative
8. **Collect the acknowledgement slip** — this contains your Enrolment ID (EID) needed to track and download your Aadhaar
9. **Verify details on screen** — before submitting, check all information displayed on the operator's screen
10. **Beware of touts** — never pay anyone outside the centre for "fast processing." All services have fixed fees
...
Visit [appointments.uidai.gov.in](https://appointments.uidai.gov.in) and use the centre locator by selecting your state and district. Soon, you'll also be able to search on Google Maps through UIDAI's new partnership.
...
New Aadhaar enrolment is **free**. Demographic updates cost **₹50** and biometric updates cost **₹100**. There is no charge for mandatory biometric updates at ages 5 and 15.
...
Ensure your documents are originals and match the UIDAI-approved list. If a valid document is rejected, you can file a complaint on [uidai.gov.in](https://uidai.gov.in) or call the helpline at **1947**. You may also visit a different centre.
