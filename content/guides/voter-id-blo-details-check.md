...
## Who is a BLO (Booth Level Officer)?
...
### Method 1: Via voters.eci.gov.in (Recommended)

#### Step 1: Visit the Voter Portal
Go to [voters.eci.gov.in](https://voters.eci.gov.in)
...
If you have filed [Form 6](/guide/voter-id-card-apply-online) for a new Voter ID and the BLO hasn't visited for verification.

### 2. Voter ID Corrections
If your [Form 8 correction](/guide/voter-id-correction-online) (name, photo, address, date of birth) is pending for more than 30 days.

### 3. Duplicate Entry Deletion
If you filed [Form 7](/guide/voter-id-delete-duplicate) to delete a duplicate entry and need to expedite verification.
...
> **Before every election:** Verify your polling booth location on [voters.eci.gov.in](https://voters.eci.gov.in) using the "Search in Electoral Roll" feature.
...
Visit [voters.eci.gov.in](https://voters.eci.gov.in), click "Know Your BLO," and search using your EPIC number or address. The BLO's mobile number will be displayed.
