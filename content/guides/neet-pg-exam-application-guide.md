...
# NEET PG — Application Process, Eligibility, Exam Pattern & Counselling Guide
...
> **Disclaimer:** CitizenNest is an independent informational platform and is not affiliated with NBEMS, NMC, or any government body.

## What is NEET PG?

NEET PG replaced the earlier AIPGMEE and is now the sole entrance exam for:

- **MD (Doctor of Medicine)** — Clinical and non-clinical specialties
- **MS (Master of Surgery)** — Surgical specialties
- **PG Diploma** — Various medical diploma courses
- **DNB (Diplomate of National Board)** — Through NBE counselling
...
1. **Visit NBEMS Portal** — Go to [natboard.edu.in](https://natboard.edu.in) or [nbe.edu.in](https://nbe.edu.in)
2. **New Registration** — Create an account with email and mobile number
3. **Fill Application Form** — Enter personal, educational, and internship details
4. **Upload Documents** — Upload photograph, signature, and certificates as per specifications
5. **Select Exam Cities** — Choose preferred test cities (usually 3-4 options)
6. **Pay Application Fee** — Pay online via credit/debit card, net banking, or UPI
7. **Submit Application** — Review all details and submit
8. **Download Confirmation** — Save/print the application confirmation page
9. **Admit Card** — Download from the portal 10-15 days before the exam
10. **Appear for Exam** — Carry admit card and valid photo ID to the exam centre

## Application Fees

| Category | Fee |
|----------|-----|
| General / OBC / EWS | ₹4,250 (approx.) |
| SC / ST / PwD | ₹3,250 (approx.) |
...
### AIQ (All India Quota) Counselling — via MCC

1. **Registration** on [mcc.nic.in](https://mcc.nic.in)
2. **Choice Filling** — Select preferred colleges and courses in order of preference
3. **Seat Allotment** — Based on NEET PG rank and preferences
4. **Reporting** — Report to the allotted institution with original documents
5. **Multiple Rounds** — Usually 4 rounds of counselling (Round 1, 2, Mop-up, Stray vacancy)
...
1. **Start Early Preparation** — Begin at least 6-8 months before the exam date.
2. **Focus on Clinical Subjects** — They constitute 55% of the exam.
3. **Practice MCQs** — Solve previous years' papers and mock tests regularly.
4. **Time Management** — With negative marking, avoid random guessing.
5. **Keep Documents Updated** — Ensure NMC/SMC registration is valid before counselling.
...
*Last updated: February 2026. Exam pattern and fees may change. Always verify current details on [natboard.edu.in](https://natboard.edu.in).*
