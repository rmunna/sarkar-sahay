...
keywords:
  ...
  - "e-sign OTP"
  - "electronic signature India"
  - "eSign service provider"
---

# Aadhaar-Based e-Sign — How to Use Online
...
- **OTP-based** — no hardware token needed
- **Instant** — signature is applied in seconds
- **Secure** — signing keys are destroyed immediately after use
- **Works online** — sign from anywhere using a browser or app
...
1. **You (the signer)** — the person signing the document
2. **Application Service Provider (ASP)** — the website or app where you sign (e.g., Income Tax portal, MCA portal)
3. **e-Sign Service Provider (ESP)** — the licensed backend provider that handles the actual signing (e.g., eMudhra, Protean/NSDL, C-DAC)
...
There are no age restrictions or fees for the end user in most cases — the ASP (application provider) typically bears the cost.

If your mobile number is not linked to Aadhaar, you must update it first. See our [Aadhaar card guide](/guide/aadhaar-card-apply-online) for instructions on updating your Aadhaar details.
...
An OTP will be sent to your **Aadhaar-linked mobile number**. This is not the mobile number registered on the platform — it must be the one linked with UIDAI.

### Step 5: Enter OTP

Enter the 6-digit OTP within the time limit (usually 3–10 minutes depending on the platform).
...
For **end users**, e-Sign is typically free — the cost is borne by the Application Service Provider (ASP).
...
- **eMudhra Ltd.** — [emudhra.com](https://www.emudhra.com)
- **Protean (formerly NSDL e-Gov)** — [protean-tinpan.com](https://www.protean-tinpan.com)
- **C-DAC** — [cdac.in](https://www.cdac.in)
- **Capricorn Identity Services**
- **Verasys**

The full list of empanelled ESPs is available at [cca.gov.in/service-providers.html](https://cca.gov.in/service-providers.html).
...
| **Validity** | Single use (30 min certificate) | 1–3 years |
| **Cost to user** | Usually free | ₹500–₹2,000+ per year |
...
For most individuals, e-Sign is sufficient. If you sign documents frequently or need a Class 3 DSC for tenders and audits, see our [Digital Signature Certificate guide](/guide/digital-signature-certificate-dsc).
...
**No.** e-Sign specifically relies on Aadhaar e-KYC for identity authentication. Without a valid Aadhaar with a linked mobile number, you cannot use this service. You may need to use a [Digital Signature Certificate](/guide/digital-signature-certificate-dsc) instead.
...
- CCA e-Sign page: [https://cca.gov.in/eSign.html](https://cca.gov.in/eSign.html)
- List of e-Sign Service Providers: [https://cca.gov.in/service-providers.html](https://cca.gov.in/service-providers.html)
- UIDAI (Aadhaar): [https://uidai.gov.in](https://uidai.gov.in)
