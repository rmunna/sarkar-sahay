...
# Indira Gandhi National Pension Scheme — IGNOAPS, IGNWPS, IGNDPS
...
- **Aadhaar Card** — required for identity verification and Direct Benefit Transfer (DBT). See our [Aadhaar guide](/guide/aadhaar-card-apply-online) for help.
- **BPL Ration Card** or BPL certificate — proof that you belong to a Below Poverty Line household. See our [ration card guide](/guide/ration-card-apply-online) for details.
...
4. **Track your application** — Use the NSAP portal ([nsap.nic.in](https://nsap.nic.in/)) to check the status of your pension application.
...
Yes, some states support online applications through the [NSAP portal](https://nsap.nic.in/) or their state portals. You can also apply offline at your Gram Panchayat or Municipal office.
...
- [Ration Card — How to Apply Online](/guide/ration-card-apply-online)
- [PM Kisan Samman Nidhi — Complete Guide](/guide/pm-kisan-samman-nidhi)

---

> **Disclaimer:** CitizenNest is an independent informational platform and is **not affiliated with any government body**. Information is compiled from official sources and may change. Always verify details on the [official NSAP website](https://nsap.nic.in/) or with your local government office.
