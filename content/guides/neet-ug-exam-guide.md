...
> **Related:** [SSC CGL Exam Guide](/guides/ssc-cgl-exam-guide) | [UPSC Civil Services Guide](/guides/upsc-civil-services-exam-guide)
...
**Pro Tip:** NCERT is the bible for NEET. Read every line, diagram, and example in NCERT Biology — around 90% of Biology questions come directly from NCERT.
...
1. **Visit** the official NTA website: [neet.nta.nic.in](https://neet.nta.nic.in)
2. **Register** with your email ID and mobile number
3. **Fill the application form** — personal details, educational qualifications, exam centre preferences
4. **Upload documents** — passport-size photo, signature, Class 10 certificate, category certificate (if applicable)
5. **Pay the fee:**
   - General: ₹1,700
...
- Revise NCERT one more time — especially Biology
- Focus on high-weightage chapters
- Practice time management — aim to finish in 3 hours

### Subject-wise Tips

- **Biology:** Easiest to score. Read NCERT line by line. Practice diagrams. Focus on Human Physiology, Genetics, and Ecology.
- **Chemistry:** Physical Chemistry needs practice. Organic Chemistry needs understanding of reactions. Inorganic — memorise from NCERT.
- **Physics:** Most students find this tough. Focus on Mechanics, Optics, and Electrostatics. Solve numerical problems daily.

### Recommended Resources
- **NCERT Textbooks** (Class 11 and 12) — non-negotiable
- **Previous Year Papers** — available free on NTA website
- **MTG Objective Biology / DC Pandey Physics / MS Chouhan Organic Chemistry** — for extra practice
...
- **Round 1:** Register on [mcc.nic.in](https://mcc.nic.in), fill choices, seat allotment
...
- Keep original documents ready — Class 10, Class 12 marksheet, NEET scorecard, category certificate, domicile certificate
...
| Correction Window | March – April 2026 |
...
| AIQ Counselling Starts | July – August 2026 |
| State Counselling | August – October 2026 |

**Always check [neet.nta.nic.in](https://neet.nta.nic.in) for confirmed dates.**
...
2. **Solve previous year papers** — You'll notice repeated topics and question patterns. Last 10 years' papers are a goldmine.

3. **Don't ignore negative marking** — At −1 per wrong answer, random guessing can cost you. Skip questions you're unsure about.

4. **Take mock tests seriously** — Simulate real exam conditions. Sit for the full 3 hours 20 minutes without breaks.

5. **Biology is your scoring subject** — Most toppers score 340+ in Biology. Give it the attention it deserves.

6. **Stay physically and mentally healthy** — NEET preparation is a marathon. Sleep well, eat properly, take short breaks, and don't burn out.

7. **Keep documents ready early** — Collect all certificates, photos, and ID proofs well before counselling starts. Missing documents can cost you a seat.
...
Yes. NEET UG is available in 13 languages — English, Hindi, Assamese, Bengali, Gujarati, Kannada, Malayalam, Marathi, Odia, Punjabi, Tamil, Telugu, and Urdu.
...
This guide is for **informational purposes only**. Exam details, dates, fees, and rules may change. Always verify from the official NTA website ([neet.nta.nic.in](https://neet.nta.nic.in)) and MCC portal ([mcc.nic.in](https://mcc.nic.in)) before making any decisions. CitizenNest is not affiliated with NTA or any government body.
