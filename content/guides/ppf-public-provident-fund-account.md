---
title: "How to Open PPF Account Online — Public Provident Fund Guide"
description: "Learn how to open a PPF account online. Complete guide on PPF interest rate, tax benefits under 80C, eligibility, and withdrawal rules."
keywords:
...
relatedGuides:
  - "/guide/sukanya-samriddhi-yojana"
  - "/guide/senior-citizen-savings-scheme"
  - "/guide/income-tax-return-file-online"
  - "/guide/open-bank-account-online"
---

# How to Open PPF Account Online — Public Provident Fund Guide
...
- **Government guaranteed** — zero risk of default
- **EEE tax status** — Exempt at investment, exempt on interest, exempt at maturity
- **Long-term wealth building** — 15-year lock-in with extension options

## PPF Account — Key Details at a Glance
...
> **Note:** The PPF interest rate is reviewed and set by the Government of India every quarter. Always check the latest rate on the [NSI website](https://www.nsiindia.gov.in/InternalPage.aspx?Id_Pk=89).
...
1. Log in to **SBI Internet Banking** (onlinesbi.sbi) or the **YONO SBI** app
2. Go to **Deposits & Investments → PPF → Open a PPF Account**
3. Select whether the account is for **Self** or **Minor**
4. Enter your **PAN number** and **nomination details**
5. Choose the **initial deposit amount** (minimum ₹500)
6. Verify details and **confirm with OTP**
7. Your PPF account number is generated instantly
8. Download the **acknowledgement slip** for your records
...
2. Navigate to the **PPF / Government Schemes** section
3. Fill in personal details, PAN, and nominee information
4. Make the initial deposit and confirm

### Option 3: Open PPF Account at Post Office

1. Visit your nearest **post office** with KYC documents
2. Fill **Form A** (PPF account opening form)
3. Submit **Aadhaar card, PAN card**, and a **passport-size photo**
4. Make the initial deposit (minimum ₹500, cash or cheque)
5. Receive your **PPF passbook** within a few days

## PPF Tax Benefits — Complete Breakdown

PPF enjoys **EEE (Exempt-Exempt-Exempt)** tax status, the most favourable tax treatment in India:

| Stage | Tax Treatment |
|---|---|
| **Investment** | Deduction under Section 80C up to ₹1,50,000 per year |
| **Interest Earned** | Fully exempt from income tax |
| **Maturity Amount** | Completely tax-free — no capital gains tax |

This means if you invest ₹1.5 lakh per year for 15 years, both the interest earned (~₹18.18 lakh at 7.1%) and the maturity amount (~₹40.68 lakh) are **100% tax-free**.

## PPF Withdrawal Rules

- **Partial withdrawal** allowed from the **7th financial year** onwards
- Maximum withdrawal: **50% of the balance** at the end of the 4th year preceding the year of withdrawal, or the balance at the end of the preceding year — whichever is lower
...
1. **Withdraw the full amount** — tax-free
2. **Extend in blocks of 5 years** — with or without fresh contributions

If extending with contributions, you must submit **Form H** within one year of maturity.

## PPF vs FD vs NPS vs SSY — Comparison Table
...
| **Tax on Investment** | 80C deduction | 80C only for 5-year tax saver FD | 80C + 80CCD(1B) extra ₹50K | 80C deduction |
...
1. **Deposit before the 5th of every month** — interest is calculated on the lowest balance between the 5th and the last day of the month
2. **Invest the full ₹1.5 lakh** to maximise both tax savings and corpus
3. **Make a lump sum deposit in April** (before April 5th) to earn interest for the full year
...
### 6. What happens if I don't deposit the minimum ₹500 in a year?

Your PPF account becomes **inactive/discontinued**. To revive it, you must pay the minimum ₹500 for each missed year plus a **₹50 penalty per year** of default.
...
**Related Guides:**
- [Sukanya Samriddhi Yojana — Complete Guide](/guide/sukanya-samriddhi-yojana)
...
- [How to Open Bank Account Online](/guide/open-bank-account-online)
