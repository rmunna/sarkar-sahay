...
keywords:
  ...
  - seva sindhu rejection reasons
  - seva sindhu karnataka fix
  - seva sindhu document upload error
  - seva sindhu re-apply
  - karnataka certificate rejected
  - seva sindhu caste certificate rejected
  - seva sindhu income certificate rejected
  - seva sindhu status rejected
  - seva sindhu application correction
readingTime: 10 min
...
# Seva Sindhu Application Rejected Karnataka — Reasons & How to Fix
...
You may see these status messages on the [Seva Sindhu portal](https://sevasindhu.karnataka.gov.in/):

- **"Application Rejected — Document not readable"** — uploaded file is blurry or too small
- **"Application Rejected — Invalid document"** — wrong document type uploaded
- **"Application Rejected — Details mismatch"** — name/address doesn't match supporting documents
- **"Application Rejected — Incomplete application"** — mandatory fields left blank
- **"Application Rejected by Tahsildar"** — rejected during verification at the Tahsildar office
- **"Application Rejected — Already exists"** — duplicate application for the same certificate
- **"Application Rejected — Not eligible"** — applicant does not meet eligibility criteria
...
- **File is blurry or unreadable** — scanned at very low resolution
- **Wrong file format** — portal accepts PDF/JPEG/PNG; other formats are rejected
- **File size exceeds limit** — typically 1-2 MB per document
- **Wrong document uploaded** — e.g., uploading a ration card when income proof is needed
- **Document is expired** — some documents like income certificates have a validity period
...
1. Go to [sevasindhu.karnataka.gov.in](https://sevasindhu.karnataka.gov.in/)
...
- If there's a genuine mismatch between documents, first get the documents corrected (e.g., [update your Aadhaar](/guide/aadhaar-card-apply-online))
- Use the same spelling across all fields

**For incomplete applications:**
- Fill every mandatory field — look for red asterisks (*)
...
1. Log in to [Seva Sindhu](https://sevasindhu.karnataka.gov.in/) with your credentials
...
### Step 4 — Track Your New Application
...
1. **Scan documents clearly** — use a scanner app like Adobe Scan or CamScanner for clean copies
2. **Match names exactly** — spelling on the form must match Aadhaar letter by letter
3. **Use recent documents** — income certificates, salary slips should be from the current financial year
4. **Fill the form in one sitting** — saving and resuming can sometimes cause data loss
5. **Keep file sizes small** — compress PDFs to under 500 KB for faster upload and fewer errors
...
- **Portal:** [sevasindhu.karnataka.gov.in](https://sevasindhu.karnataka.gov.in/) → Grievance section
- **In person:** Visit your nearest Nadakacheri / Karnataka One centre

---

## Related Guides

- [Seva Sindhu Karnataka Portal — Complete Guide](/guide/seva-sindhu-karnataka-portal-guide)
- [Karnataka Caste Certificate — How to Apply Online](/guide/karnataka-caste-certificate-online-apply)
- [Karnataka Income Certificate — How to Apply Online](/guide/karnataka-income-certificate-online-apply)
...
Go to [sevasindhu.karnataka.gov.in](https://sevasindhu.karnataka.gov.in/), click "Track Application," and enter your reference number. The rejection reason and officer remarks will be displayed in the status page.
...
Yes, the standard application fee applies for each fresh application. The fee for most certificates on Seva Sindhu ranges from ₹10 to ₹25.

### What documents do I need for a Karnataka caste certificate?

You typically need Aadhaar card, parent's caste certificate (if available), ration card, SSLC marks card, and a recent passport-size photo. Check our [Karnataka Caste Certificate guide](/guide/karnataka-caste-certificate-online-apply) for the complete list.

---

*Disclaimer: CitizenNest is an independent informational website and is not affiliated with the Government of Karnataka or the Seva Sindhu portal. Information is compiled from official sources and may change. Always verify on [sevasindhu.karnataka.gov.in](https://sevasindhu.karnataka.gov.in/) for the latest requirements.*
