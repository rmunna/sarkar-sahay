---
title: "How to Block ATM Card — Lost Debit Card Block and Reissue (All Banks)"
description: "Lost your ATM or debit card? Learn how to block it instantly via mobile banking, net banking, SMS, customer care, or branch visit for all major banks."
keywords:
  - block ATM card
  - how to block debit card
  - lost debit card block
  - block ATM card online
  - debit card reissue
  - block stolen ATM card
  - bank card block number
category: "Tax & Finance"
author: "CitizenNest Team"
date: "2026-02-28"
lastUpdated: "2026-02-28"
readingTime: "8 min"
slug: "block-atm-debit-card-lost-reissue"
officialLinks:
  ...
  - "https://rfrfrbi.org.in/"
---

# How to Block ATM Card — Lost Debit Card Block and Reissue (All Banks)
...
- **Prevent unauthorised transactions** — Fraudsters can use your card at ATMs, POS machines, or for online purchases
- **Limit financial liability** — Under RBI guidelines, if you report card loss within 3 days, your liability is limited to ₹10,000 (for savings accounts). If reported within 4–7 days, liability goes up to ₹25,000
- **Protect linked accounts** — Your debit card is directly linked to your bank account, unlike a credit card
- **Block online misuse** — Even without the physical card, stored card details can be misused online

> ⚠️ **Important:** The sooner you block your card, the less you are liable for fraudulent transactions. Report immediately and file a complaint if any money is debited. You can also [file a cyber crime complaint online](/guide/cyber-crime-complaint-online) for fraud cases.

---

## How to Block ATM Card — 5 Methods
...
This method works even without internet access — ideal for emergencies.
...
> 💡 Save your bank's helpline number in your phone **right now** so you can call instantly in an emergency.
...
2. Go to **Cards → Apply for Replacement Card**
3. Choose card type (Classic, Platinum, etc.)
4. Confirm your delivery address
5. The new card is usually delivered in **7–10 working days**
...
|------|--------------------------|
| SBI | ₹200 – ₹350 + GST |
| HDFC Bank | ₹200 – ₹500 + GST |
| ICICI Bank | ₹200 – ₹500 + GST |
| Axis Bank | ₹250 – ₹500 + GST |
| PNB | ₹100 – ₹300 + GST |
| Bank of Baroda | ₹150 – ₹350 + GST |
| Kotak Mahindra | ₹200 – ₹499 + GST |
...
- **Never share your PIN, CVV, or OTP** with anyone — banks never ask for these
- **Enable SMS and email alerts** for all transactions — [check your bank balance regularly](/guide/bank-balance-check-online-all-banks)
...
1. **Block first, then file a police complaint** if the card was stolen — this helps in dispute resolution
2. **Note the date and time** of when you reported the loss — RBI's zero liability policy depends on reporting timelines
...
6. If money was stolen, [file a cyber crime complaint](/guide/cyber-crime-complaint-online) at cybercrime.gov.in
...
Typically **7–10 working days** from the date of application. Some banks offer **express delivery** in 3–5 days for an additional fee.
...
Without the **PIN**, ATM withdrawals are not possible. However, some online transactions can be done using just the card number, expiry, and CVV — which is why blocking quickly is critical.
...
For more banking guides, check out:
- [How to Check Bank Balance Online — All Banks](/guide/bank-balance-check-online-all-banks)
- [How to File a Cyber Crime Complaint Online](/guide/cyber-crime-complaint-online)
