...
PM GatiShakti National Master Plan is a transformative initiative launched in October 2021 to break departmental silos and bring **integrated planning** of infrastructure development across India. The ₹100 lakh crore plan provides a digital platform that connects **16 ministries** for unified infrastructure planning.
...
GatiShakti is not a scheme that citizens apply for — it's an infrastructure governance framework that impacts every citizen through better roads, railways, ports, airports, and logistics.
...
- Bharatmala Pariyojana — 65,000 km national highway development
- Expressway development — Delhi-Mumbai, Amritsar-Jamnagar
...
### 6. Waterways (Inland)
- National Waterway 1 (Ganga) — Varanasi to Haldia
...
- Shows **200+ data layers** — roads, railways, industrial zones, forest areas, land records
...
### Who Uses It
- **Central ministries** — For project planning and approval
- **State governments** — For state-level infrastructure planning
- **District administrations** — For local connectivity and development
- **Businesses** — For understanding upcoming infrastructure (through public layers)

### How to Access
- The main portal [pmgatishakti.gov.in](https://pmgatishakti.gov.in) has limited public access
...
- See our [MSME Udyam registration guide](/guide/msme-udyam-registration) for business benefits

### Industrial Corridor Development
- **Delhi-Mumbai Industrial Corridor (DMIC)** — 1,504 km
...
2. Railway ministry plans a rail line in same area — unaware of road plan
...
2. Coordinated planning — utilities laid in same trench
...
1. **Track upcoming projects** near your area through government press releases — property values rise near new highways, airports, and industrial corridors
...
5. **GatiShakti is long-term** — Infrastructure plans span 5-25 years; plan business and investment accordingly
...
GatiShakti identifies connectivity gaps in rural areas and prioritises projects for last-mile connectivity — roads, broadband, and transport services that connect villages to markets and services.
...
By planning infrastructure holistically — connecting industrial zones to ports via the shortest multi-modal routes, building logistics parks at strategic junctions, and reducing unnecessary trans-shipment through direct connectivity.
