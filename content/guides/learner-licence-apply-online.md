---
title: "Learner's Licence Apply Online: Step-by-Step Guide"
description: >-
  Apply for a learner's licence online via the Sarathi Parivahan portal.
  Complete guide with age eligibility, documents, fee ₹200, and LL test tips.
category: Utilities
keywords:
  ...
  - Sarathi portal learner licence
  - learner licence fee
  - learner licence test
  - learner licence age limit
  - how to get learner licence
  - learner driving licence online
readingTime: 8 min
...
- **Age proof** — Birth certificate, Class 10 mark sheet, [Aadhaar card](/guide/aadhaar-card-apply-online), or passport
...
3. Select the **vehicle class** you want to learn:
...
1. Upload scanned copies of:
   ...
   - Signature
2. File format: JPEG/JPG/PNG
3. File size: As specified on the portal (typically 10KB–200KB per document)

### Step 4: Book LL Test Slot

1. Select your preferred RTO
2. Choose a date and time slot for the LL test
3. Some states allow the test to be taken online (at-home LL test)

### Step 5: Pay Fee Online

1. **Fee: ₹200** (learner's licence fee)
2. Additional service charges may apply (₹50–₹100)
3. Payment modes: Debit card, credit card, net banking, UPI
4. Download and save the payment receipt
...
1. If you pass the test, your LL is generated immediately
2. Download the LL from the Sarathi portal or DigiLocker
3. You can also receive it by post (some states)
4. The LL is valid for **6 months** from the date of issue
...
1. **Prepare for the test** — Study traffic signs, road markings, and basic traffic rules. The Sarathi portal has a practice test section
2. **Keep documents ready** — Ensure all uploaded documents are clear and legible to avoid rejection
3. **Apply early** — Don't wait until you need the permanent licence; the LL must be at least 30 days old before you can apply for a DL
4. **Check state-specific rules** — Some states offer online LL tests that you can take from home
5. **Download from DigiLocker** — Your LL will be available on [DigiLocker](https://digilocker.gov.in/) and the mParivahan app
...
*Disclaimer: This guide is for informational purposes only. CitizenNest is not affiliated with any government department. Verify details on the official [Sarathi Parivahan portal](https://sarathi.parivahan.gov.in/) or your state transport website.*
