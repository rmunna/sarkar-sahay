...
> **Related:** Already familiar with the adult passport process? Check our [How to apply for passport](/guide/passport-apply-online) guide.
...
- Go to [passportindia.gov.in](https://www.passportindia.gov.in)
...
1. **Counter A** — Token and document check
2. **Counter B** — Document verification
3. **Counter C** — Biometrics (photo; fingerprints for children 5+ years)
4. **Counter D** — Final verification by Passport Officer (Granting Officer)
...
- Track your application using the [passport status tracking](/guide/passport-application-status-track) tool
...
- Appointments are booked online only through [passportindia.gov.in](https://www.passportindia.gov.in)
...
✅ Application receipt
✅ Original documents + 2 photocopies each
✅ Annexure D (signed by both parents, or Annexure G/H as applicable)
...
2. Log in and select **"Re-issue of Passport"**
3. Choose the reason: **"Validity expired"** or **"Change in existing details"** (like appearance change as the child grows)
4. Fill in the updated details
5. Pay the re-issue fee (same as fresh passport fee)
6. Book an appointment and visit the PSK with the child
...
For detailed renewal steps, see our [Passport renewal guide](/guide/passport-renewal-online-india).
...
- 📘 [How to Apply for Passport Online](/guide/passport-apply-online) — Complete adult passport guide
- 🔄 [How to Renew Your Passport Online](/guide/passport-renewal-online-india) — Step-by-step renewal process
- 📍 [Track Your Passport Application Status](/guide/passport-application-status-track) — Check where your passport is
