---
title: How to Get Voter ID Card for First Time
description: >-
  Step-by-step guide for first-time voters to get a Voter ID card. Covers Form 6
  filing, documents needed, age eligibility, and EPIC delivery.
category: Identity Documents
keywords:
  - first time voter ID registration
  - voter ID card for 18 year old
  - Form 6 online
  - new voter registration India
  - EPIC card first time
readingTime: 7 min
...
This guide is specifically for people registering for the very first time. If you already have a Voter ID and need changes, see our [guide to correcting Voter ID details](/guide/voter-id-correction-online).
...
> **Tip:** If you have an [Aadhaar card](/guide/aadhaar-card-apply-online), it can serve as both age and address proof, simplifying the process.
...
### Method 1: Voters Portal (voters.eci.gov.in) — Recommended

This is the ECI's primary portal and the most reliable method.

1. **Visit** [voters.eci.gov.in](https://voters.eci.gov.in) and click **"Register as a New Voter"**
...
7. **Aadhaar linking** — you will be asked to provide your Aadhaar number. While not mandatory, linking is recommended. See our [Aadhaar-Voter ID linking guide](/guide/aadhaar-voter-id-linking-online) for details
...
1. Go to [www.nvsp.in](https://www.nvsp.in)
...
1. **Online:** Visit [voters.eci.gov.in](https://voters.eci.gov.in) → "Search in Electoral Roll" → enter your name, age, and constituency details
...
1. Log in at [voters.eci.gov.in](https://voters.eci.gov.in)
...
Log in to [voters.eci.gov.in](https://voters.eci.gov.in) and go to **"Track Application Status."** Enter your reference ID to see the current status.
