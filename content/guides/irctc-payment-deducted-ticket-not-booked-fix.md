---
title: "IRCTC Payment Deducted But Ticket Not Booked — How to Get Refund"
description: "Payment deducted but IRCTC ticket not booked? Learn how to check status, get auto-refund, file TDR, and raise complaints step by step."
category: "Utilities"
keywords:
  - "irctc payment deducted ticket not booked"
  - "irctc double payment"
  - "irctc refund not received"
  - "irctc payment failed refund"
  - "irctc transaction failed money deducted"
  - "irctc tdr refund"
  - "railway ticket payment failed"
...
## What Is the "Payment Deducted But Ticket Not Booked" Issue?
...
Don't panic — in most cases, your money will be refunded automatically. This guide explains exactly what to do.

## Why Does This Happen?

There are several reasons why your payment may be deducted without a ticket being booked:

1. **Server Timeout:** IRCTC servers experience heavy load, especially during Tatkal booking hours (10:00 AM – 11:00 AM). The payment goes through but the booking confirmation fails due to server timeout.
...
1. Log in to [irctc.co.in](https://www.irctc.co.in) or the IRCTC Rail Connect app
2. Go to **My Transactions** → **Booked Ticket History**
3. Check if the ticket appears with a PNR number
4. Also check **My Transactions** → **Failed Transaction History** — if it appears here, IRCTC has already flagged it for a refund
...
3. Note down the **transaction reference number**, **date**, and **amount** — you'll need these for complaints

## Step 3: Wait for Auto-Refund (5–7 Working Days)
...
- **Standard auto-refund timeline:** 5–7 working days from the date of the failed transaction
...
1. Log in to [irctc.co.in](https://www.irctc.co.in)
2. Go to **My Transactions** → **Booked Ticket History**
...
4. You'll receive a complaint number — track the status online
...
- **Your bank's customer care** — raise a dispute for the transaction
...
- Or visit [consumerhelpline.gov.in](https://consumerhelpline.gov.in)
...
- **Compensation:** If the bank fails to reverse the amount within T+5 days, the customer is entitled to **₹100 per day** as compensation until the refund is processed
...
> **Reference:** RBI circular on "Harmonisation of Turn Around Time (TAT) and Customer Compensation for Failed Transactions" — available on [rbi.org.in](https://www.rbi.org.in)

## Important Tips

1. **Don't click "Pay" multiple times** — even if the page seems stuck, wait for at least 2–3 minutes before retrying
...
Most auto-refunds are processed within 5–7 working days. UPI refunds are usually faster (2–5 days), while credit card refunds may take up to 10 working days.
...
Yes. If IRCTC's system shows the transaction as failed, the refund is automatically initiated. Wait 5–7 working days. If not received, contact IRCTC customer care.

### Q4: Can I file a complaint with RBI if the bank doesn't refund my money?
Yes. If your bank doesn't reverse the failed transaction within T+5 working days, you can file a complaint with the RBI Banking Ombudsman at [cms.rbi.org.in](https://cms.rbi.org.in).

### Q5: Is there a way to prevent this issue during Tatkal booking?
Use a stable internet connection, avoid multiple clicks on the payment button, and consider using IRCTC eWallet for faster processing. See our [Tatkal booking troubleshooting guide](/guide/irctc-tatkal-booking-not-working-fix) for more tips.

### Q6: What if I don't receive the refund even after 15 days?
Raise a complaint on [RailMadad](https://railmadad.indianrailways.gov.in) and simultaneously contact your bank to raise a transaction dispute. If unresolved after 30 days, approach the [National Consumer Helpline](https://consumerhelpline.gov.in).
