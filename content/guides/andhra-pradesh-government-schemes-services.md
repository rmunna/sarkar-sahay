...
keywords:
  ...
  - andhra pradesh schemes for farmers
  - AP education schemes
  - andhra pradesh pension schemes
  - AP housing scheme
...
- **AP State Portal** – [ap.gov.in](https://www.ap.gov.in/) – Official state government website
- **Grama/Ward Sachivalayam** – [gramawardsachivalayam.ap.gov.in](https://gramawardsachivalayam.ap.gov.in/) – Village/ward-level service delivery portal
- **MeeSeva** – [meeseva.ap.gov.in](https://meeseva.ap.gov.in/) – Online citizen services for certificates and documents
- **AP Land Records (WebLand)** – [meebhoomi.ap.gov.in](https://meebhoomi.ap.gov.in/) – Land records, Adangal, 1-B, FMB
- **AP CFMS** – Comprehensive Financial Management System for government payments
...
- **Pre-Matric and Post-Matric Scholarships** for SC, ST, BC, and minority students
- **Overseas Vidya Nidhi** – Financial support for studying abroad
- See also: [Post-Matric and Pre-Matric Scholarships](/guide/scholarship-post-matric-pre-matric-apply)

## Health Schemes

### NTR Vaidya Seva / Aarogyasri

AP's flagship health insurance scheme providing cashless treatment up to ₹5 lakh per family at empanelled hospitals. Integrated with Ayushman Bharat for broader coverage.

**Coverage:**
- 2,000+ medical and surgical procedures
- Cashless treatment at government and private hospitals
- BPL and lower-income families eligible

See: [Ayushman Bharat vs State Health Schemes](/guide/ayushman-bharat-vs-state-health-schemes)

### 108 and 104 Health Services

- **108 Emergency Ambulance** – Free emergency medical transport
- **104 Health Helpline** – Medical advice, health information, and grievance redressal

### Village Health Clinics

Primary healthcare delivery through village and ward sachivalayam health clinics with ANMs, ASHA workers, and mid-level health providers.

## Housing Schemes

### NTR Housing Scheme / Pedalandariki Illu

Housing for economically weaker sections with financial assistance for construction of pucca houses. Beneficiaries receive phased payments linked to construction milestones.

**Eligibility:**
- Houseless families from BPL category
- Priority to SC/ST, widows, disabled, and elderly
- Land patta holders or those allocated house sites

### Pradhan Mantri Awas Yojana (PMAY) in AP

Central housing scheme implemented in AP for both urban and rural areas. Subsidy ranges from ₹1.5 lakh to ₹2.5 lakh for house construction.
...
### Free Bore Wells and Micro Irrigation

Subsidized bore wells and drip/sprinkler irrigation systems for farmers to improve water access and reduce dependency on rain-fed agriculture.
...
Financial assistance for the marriage of women from economically weaker families.

### AP Mahila Shakti

Women's self-help group empowerment and micro-credit programme.
...
AP distributes subsidized rice and essential commodities through the PDS:

- **Rice at ₹1/kg** for white ration card holders
...
AP certificates are available through MeeSeva and Grama Sachivalayam:
...
- **Meebhoomi** – [meebhoomi.ap.gov.in](https://meebhoomi.ap.gov.in/) – Adangal, 1-B, FMB, pahani
- [Land Records Online – All States](/guide/land-records-bhulekh-online)
- [Property Registration](/guide/property-registration-online)
- [Property Mutation](/guide/property-mutation-online)
- [Encumbrance Certificate](/guide/encumbrance-certificate-online)

## Government Jobs and Exams in AP

- [APPSC Exam Guide](/guide/appsc-exam-guide) – AP Public Service Commission
- [AP Police Constable Exam](/guide/ap-police-constable-exam-guide)
- [AP TET Exam Guide](/guide/ap-tet-exam-guide)

## Important Helpline Numbers

| Service | Helpline Number |
|---------|----------------|
| AP Government Helpline | 1902 |
| Women Helpline | 181 |
| Police Emergency | 112 |
| Child Helpline | 1098 |
| 108 Ambulance | 108 |
| Health Helpline | 104 |
| Farmer Helpline | 1800-425-4440 |
| Anti-Corruption (ACB) | 1064 |
| Disaster Management | 1070 |
| MeeSeva Helpline | 1100 |

## How to Apply for AP Government Schemes

### Online Application

1. **Visit the relevant portal** – MeeSeva, Grama Sachivalayam, or scheme-specific websites
2. **Register/Login** – Using Aadhaar or mobile number
...
6. **Submit** – Note the application number for tracking

### Offline Application (Grama/Ward Sachivalayam)

1. Visit your nearest **Grama Sachivalayam** (village) or **Ward Sachivalayam** (urban)
2. Meet the relevant **Village/Ward Volunteer**
3. Submit application with required documents
4. Collect acknowledgment receipt
5. Track through the Sachivalayam portal

### Common Documents Required

- Aadhaar card
- White ration card (for BPL schemes)
- Income certificate
...
**Is ration card mandatory for AP welfare schemes?**
For most welfare and subsidy schemes, a white ration card (BPL equivalent) is required. Apply for one first if you don't have it.
