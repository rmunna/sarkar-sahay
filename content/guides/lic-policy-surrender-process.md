---
title: "LIC Policy Surrender — How to Surrender LIC Policy and Get Money Back"
description: "Learn how to surrender your LIC policy online or at a branch. Understand surrender value calculation, tax rules, documents needed, and better alternatives."
...
officialLinks:
  ...
  - https://licindia.in/Home/existing-policyholder
---

## What is LIC Policy Surrender?

Surrendering an LIC policy means **terminating your life insurance policy before its maturity date** and receiving a lump sum amount called the **surrender value**. Once you surrender, the policy ends — you lose the life cover, future bonuses, and all other benefits attached to it.

People surrender their LIC policies for various reasons:
- **Financial emergencies** — urgent need for cash
- **Unable to pay premiums** — can't afford continued payments
- **Better investment options** — found higher-return alternatives
- **Policy no longer needed** — life circumstances changed

> ⚠️ **Important:** Surrendering a policy almost always results in a financial loss compared to holding it till maturity. Consider alternatives like making the policy paid-up or taking a loan against it before surrendering.
...
**GSV = (Total Premiums Paid × Surrender Value Factor) + Surrender Value of Vested Bonuses**

- The **Surrender Value Factor** depends on how many premiums you've paid versus total premiums payable
- Typically ranges from **30% to 90%** of premiums paid — increases as the policy matures
...
**SSV = (Sum Assured + Vested Bonuses) × Special Surrender Value Factor**
...
**Key points:**
- If you haven't paid the minimum required premiums, you get **nothing** — the policy simply lapses
...
1. **Visit** the LIC customer portal at [customer.licindia.in](https://customer.licindia.in/)
...
9. **Submit** — you'll receive a reference number

> 💡 If you haven't registered on the LIC portal yet, you'll need to create an account first. Check our guide on [LIC policy status check online](/guide/lic-policy-status-check-online) for portal registration steps.
...
- ✅ **PAN card** (mandatory if surrender value exceeds ₹1,00,000 for TDS purposes)
- ✅ **NEFT mandate form** with bank details
...
- Premium: ₹50,000/year
- Premiums Paid: 10 years (₹5,00,000 total)
- Vested Bonus: ₹3,00,000

**GSV Calculation:**
- Surrender Value Factor (after 10 of 20 years): ~50%
- GSV = (₹5,00,000 – first year premium ₹50,000) × 50% + Bonus Surrender Value
- GSV ≈ ₹2,25,000 + ₹90,000 = **₹3,15,000** (approximate)

**SSV Calculation:**
- SSV Factor (for 50% term completed): ~45%
- SSV = (₹10,00,000 + ₹3,00,000) × 45%
- SSV ≈ **₹5,85,000** (approximate)

**You receive:** ₹5,85,000 (higher of GSV and SSV)

> 📌 Actual values depend on the specific policy plan, term, and LIC's published surrender value factors. Contact your LIC branch or check the portal for exact figures.
...
- **Annual premium is ≤ 10% of sum assured** (for policies issued after 1 April 2012)
- **Annual premium is ≤ 20% of sum assured** (for policies issued before 1 April 2012)
...
### Section 194DA — TDS on Surrender

- LIC deducts **5% TDS** on the taxable portion (surrender value minus total premiums paid) if the amount exceeds ₹1,00,000
...
For policies issued **after 1 April 2023** with annual premium exceeding **₹5 lakh**, the surrender value is taxable regardless of the 10% rule. Only the gain (surrender value minus premiums paid) is taxed.

> 💡 Always keep your PAN linked with your LIC policy to avoid higher TDS deduction. Check our guide on [LIC premium payment online](/guide/lic-premium-payment-online) for keeping your policy details updated.
...
**Paid-Up Value = (Sum Assured × Premiums Paid / Total Premiums) + Vested Bonuses**
...
- Repay the loan at your convenience — it's deducted from maturity/claim amount if unpaid
...
1. **Check your surrender value first** — call LIC (1800 258 6400) or check the customer portal before deciding
2. **Wait if close to maturity** — the closer you are to maturity, the more you lose by surrendering
3. **Compare alternatives** — paid-up and loan options may serve you better
4. **Consider tax impact** — surrender proceeds may be taxable; consult a tax advisor
5. **Update bank details** — ensure your bank account linked to the policy is active
6. **Keep all documents safe** — especially the original policy bond
...
It depends on your policy terms. If annual premium is within 10% of sum assured (for policies after April 2012), the surrender value is **tax-free** under Section 10(10D). Otherwise, the gain is taxable as income. TDS at 2-5% is deducted on taxable surrender amounts exceeding ₹1 lakh.

### Can I cancel my LIC policy within 15 days?

Yes! LIC offers a **15-day free-look period** (30 days for online purchases) from the date of receiving the policy document. During this period, you can cancel and get a **full refund** minus stamp duty and medical examination charges. This is not a surrender — it's a cancellation.

### How do I check my LIC surrender value online?

Log in to the LIC customer portal at [customer.licindia.in](https://customer.licindia.in/), go to your policy details, and look for the surrender value option. You can also call **LIC helpline 1800 258 6400** (toll-free) for surrender value enquiry.
