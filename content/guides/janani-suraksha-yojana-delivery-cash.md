...
keywords:
  ...
  - "jsy cash benefit delivery"
  - "janani suraksha yojana documents"
  - "jsy amount rural urban"
  - "asha worker jsy"
  - "government hospital delivery cash"
...
1. **Register your pregnancy** at the nearest government Sub-Centre / Primary Health Centre (PHC) / ASHA worker
2. Attend antenatal checkups (ANC) at least 3 times during pregnancy (helps ASHA worker update your records)
3. **Deliver at a government hospital** — Government PHC, CHC, District Hospital, or accredited private hospital
4. At the time of delivery, the hospital staff / ASHA worker registers your delivery in the JSY system
5. **Cash is given within 7 days** of delivery — either by the hospital or via bank transfer through the ASHA worker
...
1. **Aadhaar card** (or any government photo ID if Aadhaar not available)
2. **BPL card / Ration card** (required in LPS states for some cases)
3. **MCP (Mother and Child Protection) card** — issued during antenatal registration
4. **Bank account details** (if payment is by bank transfer)
...
- NHM JSY scheme page: [nhm.gov.in](https://nhm.gov.in)
