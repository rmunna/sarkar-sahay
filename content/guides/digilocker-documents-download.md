---
title: "Digitize Your Documents with DigiLocker"
description: "Complete guide to DigiLocker — India's digital document wallet. Learn how to sign up, download Aadhaar, PAN, marksheets, and access 500+ documents online."
category: "Utilities"
keywords: ["digilocker", "digilocker documents download", "digital documents india", "digilocker aadhaar", "digilocker driving licence", "digilocker marksheet"]
readingTime: "6 min"
officialLinks:
...
- **Reduce paperwork** — DigiLocker documents are legally valid under the IT Act 2000
...
| Issued Documents | Fetched directly from government databases — no upload needed |
...
1. Go to [digilocker.gov.in](https://www.digilocker.gov.in)
2. Click **"Sign Up"**
...
- **Ministry of Road Transport** — Driving licence, vehicle RC
- **CBSE** — Class 10 and 12 marksheets
- **Universities** — Degree certificates
- **EPFO** — UAN card and passbook
- **Insurance companies** — Policy documents
...
1. **Aadhaar Card** — Fetch using Aadhaar number + OTP
2. **PAN Card** — Fetch using PAN number + date of birth
3. **Driving Licence** — Fetch using DL number + date of birth
4. **Vehicle Registration Certificate (RC)** — Fetch using registration number
...
4. Choose the file from your device (PDF, JPEG, PNG — max 10 MB)
...
Yes. You can log in from any device — mobile, tablet, or computer. Your documents are stored in the cloud and accessible from anywhere.
...
- [How to Apply for Driving Licence](/guides/driving-licence-apply-online)
