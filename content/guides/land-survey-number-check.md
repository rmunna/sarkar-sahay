...
keywords:
  ...
  - land survey number
  - village map survey number
  - state wise land record portal
  - topo sheet land survey
  - survey number check india
  - land record by survey number
  - revenue survey number
  - land survey online check
readingTime: "10 min"
lastUpdated: "2026-03-06"
officialLinks:
  - "https://dilrmp.gov.in/"
  - "https://bhunaksha.gov.in/"
  - "https://upbhulekh.gov.in/"
  - "https://bhulekh.mahabhumi.gov.in/"
  - "https://eservices.tn.gov.in/eservicesnew/land/chitta_new.html"
---

# Land Survey Number Check Online: State-Wise Guide
...
1. **Sale deed or title deed** — The survey number is mentioned in your property purchase documents
2. **Property tax receipt** — Municipal or panchayat tax receipts include the survey number
3. **Revenue records** — Pahani, 7/12 extract, Patta, Khatauni, or RTC documents
4. **Online land record portals** — Each state has a dedicated website
5. **Village map (Bhu Naksha)** — Geo-referenced maps showing survey numbers
6. **Topo sheet** — Survey of India topographic sheets contain survey boundaries

## State-Wise Land Record Portals

### 1. Uttar Pradesh — Bhulekh UP

- **Portal:** [upbhulekh.gov.in](https://upbhulekh.gov.in/)
- **Search by:** Khasra/Gata number, Khatauni, owner name
- **Steps:** Select District → Tehsil → Village → Enter Khasra number → View record
- See our [Bhulekh UP guide](/guide/bhulekh-up-land-record) for detailed steps

### 2. Maharashtra — Bhulekh Maharashtra

- **Portal:** [bhulekh.mahabhumi.gov.in](https://bhulekh.mahabhumi.gov.in/)
- **Search by:** Survey number, Gat number, owner name
- **Steps:** Select Division → District → Taluka → Village → Enter survey number

### 3. Tamil Nadu — Patta Chitta

- **Portal:** [eservices.tn.gov.in](https://eservices.tn.gov.in/eservicesnew/land/chitta_new.html)
- **Search by:** Survey number, Patta number, owner name
- **Steps:** Select District → Taluk → Village → Enter survey number → View Chitta
- See our [Patta Chitta guide](/guide/patta-chitta-apply-online) for detailed steps

### 4. Karnataka — Bhoomi

- **Portal:** [landrecords.karnataka.gov.in](https://landrecords.karnataka.gov.in/service3/)
- **Search by:** Survey number, owner name, Khata number
- **Steps:** Select District → Taluk → Hobli → Village → Enter survey number

### 5. Rajasthan — Apna Khata

- **Portal:** [apnakhata.rajasthan.gov.in](https://apnakhata.rajasthan.gov.in/)
- **Search by:** Khasra number, Khata number, name
- **Steps:** Select District on map → Tehsil → Village → Enter Khasra number

### 6. Madhya Pradesh — Bhu Abhilekh

- **Portal:** [mpbhulekh.gov.in](https://mpbhulekh.gov.in/viewFreeROR.do)
- **Search by:** Khasra number, owner name, plot number
- **Steps:** Select District → Tehsil → Village → Enter Khasra number

### 7. Haryana — Jamabandi

- **Portal:** [jamabandi.nic.in](https://jamabandi.nic.in/)
- **Search by:** Khewat/Khatoni number, owner name, survey number
- See our [Jamabandi guide](/guide/jamabandi-check-online) for detailed steps

### 8. Telangana — Dharani

- **Portal:** [dharani.telangana.gov.in](https://dharani.telangana.gov.in/)
- **Search by:** Survey number, Pattadar passbook, Aadhaar number

### 9. Andhra Pradesh — Meebhoomi

- **Portal:** [meebhoomi.ap.gov.in](https://meebhoomi.ap.gov.in/)
- **Search by:** Survey number, Aadhaar, owner name

### 10. West Bengal — Banglarbhumi

- **Portal:** [banglarbhumi.gov.in](https://banglarbhumi.gov.in/)
- **Search by:** Plot number, Khatian number, owner name
...
1. Visit your state's Bhu Naksha portal (e.g., [bhunaksha.gov.in](https://bhunaksha.gov.in/))
...
1. Visit the **Survey of India** portal at [surveyofindia.gov.in](https://surveyofindia.gov.in/)
...
2. **Check encumbrance** — Visit the sub-registrar office or use the online EC portal to ensure the survey number is free from legal liabilities
3. **Download and save** RoR documents and village maps for your records
4. **Revenue village vs municipal area** — Survey numbers work differently in rural (revenue) and urban (municipal) areas
...
Revenue records (7/12, RTC, Pahani) indicate the **land classification** — whether it is private (patta land), government land, forest land, or reserved. Check the remarks column in the RoR document.
