---
title: "UPI Payment Refund Not Received — How to Fix"
description: "UPI payment deducted but not received by the receiver? Learn how to track your refund, raise complaints on NPCI, and escalate to RBI ombudsman."
category: "Utilities"
keywords: ["UPI refund not received", "UPI money deducted not credited", "UPI refund time", "UPI complaint NPCI", "UPI payment stuck", "UPI refund 48 hours", "RBI ombudsman UPI", "UPI dispute process"]
readingTime: "9 min"
...
## What Happens When UPI Money Is Deducted but Not Credited?

Sometimes a UPI payment gets **debited from your bank account** but the receiver never gets the money. This is called a **"deemed declined" transaction** — where the transaction fails midway but your account is already debited.
...
> **Key RBI Rule:** Under RBI's circular on "Harmonisation of Turn Around Time (TAT)" dated September 2019, banks must auto-reverse failed UPI transactions within **T+1 business day**. For delays beyond this, the bank must pay ₹100/day as compensation to the customer.
...
1. Open **Google Pay** → tap your **profile picture**
2. Go to **"Activity"** or **"See all payment activity"**
3. Find the transaction and tap on it
4. Check the status:
   - **"Completed"** — money was sent successfully; check with the receiver
   - **"Pending"** — transaction is still being processed; wait up to 48 hours
   - **"Failed"** or **"Refund initiated"** — refund should arrive within 3-5 business days
5. Note down the **UPI Transaction ID** (starts with a number string) and **UTR number**

### PhonePe

1. Open **PhonePe** → go to **"History"** (clock icon)
2. Find and tap the transaction
3. Check the status — look for **"Refund Pending"** or **"Failed"**
4. Tap **"Need Help"** or **"Raise Issue"** if the refund is delayed
5. Copy the **Transaction ID** and **UTR number** from the details page

### Paytm

1. Open **Paytm** → tap **"Balance & History"** or **"Passbook"**
...
1. Open **BHIM** → go to **"Transactions"**
...
- Do **NOT** retry the same payment — you might get double-charged
...
4. You'll receive a **complaint reference number** — save it

### PhonePe
1. Open the transaction → tap **"Need Help"**
2. Select the relevant issue
3. You can also go to **Help → UPI Transactions → Payment Issues**
4. Submit and note the **ticket number**

### Paytm
1. Go to **Help & Support** → **UPI & Payments**
...
1. **Call your bank's customer care** — find the number on the back of your debit card or the bank's website
2. Provide:
...
If neither the app nor the bank resolves your issue, escalate to **NPCI** (National Payments Corporation of India) — the organization that manages UPI.

1. Visit [NPCI Dispute Redressal](https://www.npci.org.in/register-a-complaint)
...
1. Visit the [RBI Complaint Management System (CMS)](https://cms.rbi.org.in)
2. Click **"File a Complaint"**
3. Select complaint type: **"Deficiency in digital payment services — UPI"**
4. Fill in:
   - Your bank details
...
6. Submit — you'll receive a **complaint tracking number**
...
- **Compensation:** If the bank is found at fault, you may receive:
  ...
  - ₹100/day compensation for each day of delay beyond T+1
  - Additional compensation for mental agony (in some cases, up to ₹1 lakh)

## Important Things to Remember

- **Never share your UPI PIN, OTP, or password** with anyone claiming to help with refunds — this is a common scam
- **Screenshot everything** — transaction details, bank statements, complaint numbers
...
As per RBI rules, UPI refunds for failed transactions must be processed within **T+1 business day** (effectively 24-48 hours). If it takes longer, you're entitled to ₹100/day compensation.
