...
- ✅ **Low interest rate** — effective rate of just **4% per annum** (with subvention)
- ✅ **Flexible withdrawals** — draw money anytime within your limit
- ✅ **No need to apply for a new loan** each season
- ✅ **Crop insurance** — automatic coverage under **PMFBY** (Pradhan Mantri Fasal Bima Yojana)
- ✅ **Personal accident insurance** — coverage up to ₹50,000 (death) and ₹25,000 (disability)
- ✅ **ATM-enabled card** — withdraw cash from ATMs
- ✅ **Loan limit increases** every year (up to 10% annual increase)
- ✅ **Simple one-page form** for PM Kisan beneficiaries
- ✅ **No collateral** needed for loans up to ₹1.60 lakh
...
If you are a [PM Kisan beneficiary](/guide/pm-kisan-samman-nidhi), you can apply for KCC through the PM Kisan portal at [pmkisan.gov.in](https://pmkisan.gov.in).
...
> **Haven't registered for PM Kisan yet?** Read our guide on [how to register for PM Kisan Samman Nidhi](/guide/pm-kisan-samman-nidhi). You can also [check your PM Kisan beneficiary status](/guide/pm-kisan-status-check-beneficiary-list).
...
> Apply at your nearest bank branch with proof of your animal husbandry or fisheries activity. The Department of Animal Husbandry ([dahd.nic.in](https://dahd.nic.in)) and Department of Fisheries ([dof.gov.in](https://dof.gov.in)) oversee these extensions of KCC.
...
**Yes.** PM Kisan beneficiaries can apply using a **simplified one-page form**. Their details are already in the government database, making the process faster. [Check your PM Kisan status here](/guide/pm-kisan-status-check-beneficiary-list).

---

*This guide is for informational purposes. For the latest details, visit [pmkisan.gov.in](https://pmkisan.gov.in), [nabard.org](https://www.nabard.org), or contact your nearest bank branch.*
