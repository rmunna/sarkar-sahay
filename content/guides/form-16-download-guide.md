---
title: "Form 16 Download Guide — How to Get and Understand Your Form 16"
description: "Complete guide to Form 16 in India. Learn how to download Form 16 from employer or TRACES, understand its parts, and use it for ITR filing."
category: "Tax & Finance"
keywords: ["Form 16 download", "Form 16 online", "how to get Form 16", "Form 16 Part A Part B", "TDS certificate", "TRACES Form 16"]
readingTime: "8 min"
officialLinks:
...
- **Part A** — Contains employer and employee details, TAN, PAN, TDS deducted, and deposited details (generated from TRACES)
- **Part B** — Contains detailed salary breakup, deductions claimed, and tax computation
...
- **HR portal or HRMS** — Log in to your company's employee self-service portal
- **Email** — Some employers email it directly
- **Physical copy** — Smaller organizations may hand it over in person
...
1. Visit [TRACES](https://www.tdscpc.gov.in)
2. Register as a **Taxpayer** using your PAN
3. Log in and go to **Downloads** → **Form 16**
...
1. Log in to [Income Tax e-filing portal](https://www.incometax.gov.in)
...
- **Challan details** — BSR code, date, amount deposited with government
...
### Income Details
- **Gross Salary** — Basic, HRA, special allowance, bonus, etc.
- **Exempt allowances** — HRA exemption, LTA, etc.
- **Net Salary** — After exempt allowances
- **Income from other sources** (if declared to employer)

### Deductions
- **Standard Deduction** — ₹75,000 (under new regime) or ₹50,000 (old regime)
- **Professional Tax** — Amount deducted by state; see our [professional tax guide](/guide/professional-tax-india)
- **Section 80C** — PF, PPF, ELSS, life insurance, etc.; check our [80C deductions guide](/guide/section-80c-deductions-guide)
- **Section 80D** — Health insurance premium
- **Other Chapter VI-A deductions** — 80E, 80G, 80TTA, etc.
...
1. **Choose the correct ITR form** — ITR-1 for most salaried employees
2. **Enter salary details** from Part B of Form 16
3. **Enter TDS details** from Part A — TAN of employer, TDS amount
...
- **Request formally** — Send a written/email request to HR citing Section 203 of Income Tax Act
- **Check TRACES** — Download Part A directly from TRACES portal
- **Use salary slips** — Compile monthly salary slips to create your own income computation
- **File complaint** — If employer refuses, complain to the local Income Tax office

The employer can face a penalty of **₹100 per day** of default for not issuing Form 16 on time (under Section 272A).
...
1. **Keep Form 16 for at least 6 years** after the relevant assessment year — it may be needed for scrutiny
2. **Cross-verify with Form 26AS** and Annual Information Statement (AIS) before filing ITR
3. **Multiple employers** — If you changed jobs during the year, collect Form 16 from each employer
4. **Don't rely solely on Form 16** for ITR — Report ALL income sources including interest, rental, and capital gains
5. **Password protection** — Form 16 downloaded from TRACES is typically password-protected with your date of birth in DDMMYYYY format
...
No, Form 16 is only for salary income (Section 192). For contractual/freelance payments, the deductor issues **Form 16A**. If you're a freelancer, see our [freelancer tax guide](/guide/freelancer-tax-guide-india).
