...
readingTime: "10 min"
keywords:
  - ration card BPL to APL
  - APL to BPL ration card
  - ration card category change
  - BPL card apply
  - ration card priority change
...
|----------|-----------|-------------|---------------------|
| **AAY** | Antyodaya Anna Yojana | 35 kg per family/month at ₹2/kg wheat, ₹3/kg rice | Poorest of the poor |
| **PHH / BPL** | Priority Household (Below Poverty Line) | 5 kg per person/month at ₹2/kg wheat, ₹3/kg rice | Below state-defined poverty line (varies: ₹15,000-₹1,00,000/year by state) |
...
> **Note:** The exact income limits vary significantly by state. Check your state's Food & Civil Supplies department for current thresholds. See our [Ration Card Types guide](/guide/ration-card-types-aph-bpl-aay) for detailed comparison.
...
- **Supporting evidence** — job loss letter, death certificate of earning member, disability certificate, etc.
...
3. **Go to "Services"** → "Category Change" or "Card Modification"
4. **Select the change type** — APL to BPL or BPL to APL
5. **Fill in the application form** with family details, income details, and reason for change
6. **Upload documents** — income certificate, Aadhaar, supporting proof
...
2. **Fill the form** with complete details — ration card number, family members, current category, requested category, reason
...
6. **Await verification** — a food inspector or designated officer will visit your home for verification
...
1. **Document verification** — the Food Inspector verifies submitted documents
2. **Field visit** — an inspector may visit your home to assess living conditions
3. **Income assessment** — cross-verification with income certificate and bank records
4. **Socio-Economic Survey** — in some states, your application is processed only during periodic BPL surveys (SECC data is used)
5. **Committee approval** — a district-level committee reviews and approves/rejects the application
6. **Notification** — you receive an SMS or letter about the decision
...
| Income certificate | **Free** to ₹50 (varies by state) |
...
1. **Income certificate is key** — for APL to BPL change, the income certificate from the Tehsildar/SDM is the most important document. Get it issued before applying
2. **Don't rely on agents/middlemen** — the process is free; avoid paying anyone for "guaranteed BPL card"
3. **Keep all receipts** — save the acknowledgement receipt and track your application regularly
4. **State surveys matter** — in many states, BPL status is determined by periodic government surveys (like SECC). Individual applications may only be processed during survey periods
5. **Appeal if rejected** — if your application is rejected, you can appeal to the District Supply Officer or the District Collector within 30 days
...
**A:** The income limit varies by state. Generally, it ranges from ₹15,000 to ₹1,00,000 per year. For example, in UP it is around ₹56,460/year for rural and ₹67,000/year for urban. Check your state's Food Department for exact limits.
...
**A:** AAY (Antyodaya Anna Yojana) is for the poorest families and provides 35 kg of grains per family per month. BPL/PHH provides 5 kg per person per month. AAY families are identified from among BPL households. See our [Ration Card Types guide](/guide/ration-card-types-aph-bpl-aay) for details.
