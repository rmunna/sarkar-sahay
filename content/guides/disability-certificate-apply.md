...
The government has introduced the **UDID (Unique Disability ID) Card** — a universal ID for all PwD in India — which is now the standard disability certificate. The UDID card contains:
...
12. Intellectual disability (mental retardation)
13. Specific learning disabilities (dyslexia, etc.)

### Mental Disabilities
14. Mental illness (schizophrenia, bipolar disorder, etc.)

### Disability Due to Chronic Conditions
15. Chronic neurological conditions (Parkinson's, multiple sclerosis)
16. Blood disorders (haemophilia, thalassemia, sickle cell)
17. Multiple disabilities (combination of two or more)
...
- No age restriction — applicable from birth
...
- **Government job reservation** — 4% reservation in government posts
- **Educational concessions** — Fee waiver, scholarships, reservations — see our [National Scholarship Portal guide](/guide/national-scholarship-portal)
- **Income tax deduction** — Under Section 80U (₹75,000 for 40-79% disability; ₹1,25,000 for 80%+ disability)
- **Travel concessions** — Railway, air, and road transport discounts
- **Free/subsidized assistive devices** — Hearing aids, wheelchairs, prosthetics
- **Pension schemes** — State disability pensions
- **Skill development** — Under PM Daksh, DDRS schemes
- **Land allotment** — Priority in government housing/land schemes
- **Business concessions** — Under Stand Up India and MSME schemes
...
3. Fill the registration form:
   - Personal details — Name, date of birth, gender, Aadhaar
   - Address — Current and permanent
   - Disability details — Type of disability
...
1. Based on the medical board's assessment:
   - If disability is **40% or above** — Certificate and UDID card are issued
   - If disability is **below 40%** — Certificate may be issued with the percentage noted, but benchmark disability benefits won't apply
...
- **Medical reports** — Previous diagnosis, treatment records, prescriptions
...
- **Permanent disability** — Certificate is valid for life (no renewal needed)
- **Temporary disability** — Valid for the period specified by the medical board (typically 1-5 years)
- **Renewal** — Apply through the UDID portal with updated medical reports before expiry
- **Reassessment** — Can request reassessment if disability percentage changes
...
4. View current status — Applied, Medical Assessment Scheduled, Under Process, Issued

## Important Tips

1. **Apply online through UDID portal** — It's faster and creates a digital record accessible anywhere
2. **Carry all medical documents** to the assessment — Previous reports help the board make accurate assessment
3. **Don't delay** — Many government benefits have deadlines; get the certificate as soon as possible
4. **UDID card is universally valid** — No need for separate certificates for different purposes
5. **Free of cost** — The entire process including medical assessment is free at government hospitals
...
Yes, the medical board assessment at government hospitals is completely free. Do not pay anyone for the assessment or certificate — it's a free government service.
