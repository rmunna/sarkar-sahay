---
title: "Voter ID for NRI: How to Register as Overseas Voter in India"
description: >-
  Complete guide for NRIs to register as overseas voters using Form 6A. Passport
  requirement, overseas electors list, voting rights, and application process.
category: Identity Documents
keywords:
  - NRI voter registration
  - overseas voter India
  - Form 6A voter registration
  - NRI voter ID apply
  - overseas electors list
  - NRI voting rights India
  - voter registration for NRI
  - overseas Indian voter
  - NRI voter id card
  - overseas voter registration online
readingTime: 8 min
...
- **Residing abroad** — not ordinarily resident in India
...
- **Valid Indian passport** (mandatory — this is the only accepted identity and address proof)
- **Passport-size photograph** (recent, colour)
- **Self-declaration** regarding overseas residence
- **Details of current foreign address**

No other identity or address proof is accepted — the passport serves as both.
...
Go to [voters.eci.gov.in](https://voters.eci.gov.in/) and select **"Overseas Voter Registration"** or **"Form 6A"**.
...
### Step 3: Fill Form 6A
1. **Personal details** — Full name (as in passport), date of birth, gender
2. **Passport details** — Passport number, date of issue, place of issue, date of expiry
3. **Address in passport** — This determines your constituency
4. **Current overseas address** — Country, city, and full address abroad
5. **Contact details** — Mobile number, email
...
Download Form 6A from [voters.eci.gov.in](https://voters.eci.gov.in/) or collect it from an Indian Embassy/Consulate.
...
1. Travel to your constituency in India
2. Visit your assigned polling booth
3. Carry your valid Indian passport as ID
4. Cast your vote

**Note:** The Government has proposed extending postal ballot facility to overseas voters, but as of 2026, the in-person requirement remains. Check [eci.gov.in](https://www.eci.gov.in/) for the latest updates on overseas voting methods.
...
1. **Only Indian passport holders can register** — OCI/PIO card holders with foreign citizenship are not eligible
2. **Your constituency is fixed** by your passport address — you cannot choose a different constituency
3. **Renew your passport before applying** if it is expired — an expired passport cannot be used for registration
4. **Register well before elections** — don't wait for election announcements as the registration process takes time
5. **Check your status regularly** at [voters.eci.gov.in](https://voters.eci.gov.in/) to ensure your name remains in the overseas electors list
...
Visit [voters.eci.gov.in](https://voters.eci.gov.in/) and search the electoral roll using your name or passport details. Overseas electors are listed in a separate supplement to the constituency's electoral roll.

---

*Disclaimer: CitizenNest is an independent informational platform and is not affiliated with the Election Commission of India or the Ministry of External Affairs. For official information, visit [voters.eci.gov.in](https://voters.eci.gov.in/) or [eci.gov.in](https://www.eci.gov.in/).*
