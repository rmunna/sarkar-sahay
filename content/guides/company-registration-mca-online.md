...
Ideal for solo entrepreneurs who want limited liability without a partner. Requires only **1 director and 1 shareholder** (same person). You must nominate a second person as nominee director. OPC has been made more accessible — there is no turnover or paid-up capital threshold for conversion.
...
For organizations with charitable or social objectives — promotion of arts, science, education, sports, research, social welfare, etc. Profits must be used for the company's objectives and **cannot be distributed as dividends**. Requires a licence from the Central Government before incorporation.
...
- **PAN card** of all directors (mandatory for Indian nationals) — [Apply for PAN online](/guide/pan-card-apply-online) if you don't have one
...
1. Apply through a Certifying Authority licensed by CCA (Controller of Certifying Authorities) — such as eMudhra, Sify, or NSDL
2. Complete video-based KYC or in-person verification
3. DSC is typically issued within **1–2 working days**
4. Cost: **₹800–₹2,000** depending on validity (1–3 years)

Register your DSC on the MCA portal by going to **My Profile → Manage DSC** after logging into your MCA account.

### Step 2: Register on MCA Portal

1. Visit the MCA portal at [mca.gov.in](https://www.mca.gov.in)
2. Click **"Register"** to create a new business user account
3. Fill in your name, email, mobile number, and create a password
4. Verify via OTP sent to your email and mobile
5. Log in to your MCA account

### Step 3: Reserve Your Company Name (RUN — Reserve Unique Name)

Before filing SPICe+, reserve your company name using the **RUN (Reserve Unique Name)** web service:

1. Go to **MCA Services → Company Services → Reserve Unique Name**
2. You can propose **up to 2 names** in a single application
3. RUN fee: **₹1,000** (re-submission after rejection is ₹1,000 again)
4. Name is reserved for **20 days** upon approval
...
### Step 4: File SPICe+ Form (Part A — Name Reservation)

SPICe+ is divided into **two parts**:

**Part A** handles name reservation:

1. Log in to MCA portal → **MCA Services → Company Services → SPICe+**
2. Select company type (Private/OPC/Section 8)
3. Propose up to **2 company names** with significance/meaning
4. Submit Part A — approval usually takes **1–3 working days**

### Step 5: File SPICe+ Form (Part B — Incorporation)

Once your name is approved, proceed with **Part B**:

1. **Company details:** Registered office address, main business activity (NIC code), authorized and paid-up share capital
2. **Director details:** DIN (Director Identification Number) is **auto-allotted** through SPICe+ — no separate DIN application needed. Enter details for each director including name, address, PAN, and Aadhaar
3. **Subscriber details:** Details of shareholders and their share allocation
4. **Stamp duty:** E-stamp duty is paid online within the form (varies by state)
...
- **AOA (INC-34):** Contains rules for internal management — meetings, voting rights, director appointments, dividend policy
...
1. Attach all required documents (DSC, identity proofs, address proofs, NOC)
2. Digitally sign the form using the **DSC of all directors and a practicing professional** (CA/CS/Cost Accountant)
3. Pay the incorporation fee online
4. Submit the form — MCA processes and issues the **Certificate of Incorporation** typically within **3–7 working days**
...
- **PAN and TAN** — auto-allotted by the Income Tax Department (no separate application needed)
- **DIN** for all directors who didn't already have one
- **GSTIN** — if applied through AGILE-PRO-S. You may need to complete GST registration separately if additional details are required. See our [GST registration guide](/guide/gst-registration-online)
- **EPFO and ESIC registration** — employer codes allotted automatically through AGILE-PRO-S. Learn more about [EPF processes](/guide/epf-pf-withdrawal-online)
...
| ₹10,00,001 – ₹50,00,000 | ₹10,000 |
| Above ₹50,00,000 | ₹15,000+ |

**Additional costs:**

- DSC: ₹800–₹2,000 per director
- Professional fee (CA/CS): ₹5,000–₹15,000 (if hiring a professional)
- Stamp duty: Varies by state (₹1,000–₹5,000 typically)
- RUN fee (if filed separately): ₹1,000

**Total estimated cost for a basic Private Limited Company:** ₹7,000–₹20,000 depending on professional fees and state stamp duty.
...
1. Log in to the [GST portal](https://www.gst.gov.in) to complete your registration
2. Upload additional documents (bank account details, business premises proof)
3. The provisional ID converts to a final GSTIN after verification

For detailed steps, see our [complete GST registration guide](/guide/gst-registration-online).
...
Also allotted through AGILE-PRO-S for applicable establishments. ESIC is mandatory for businesses with 10+ employees (in some states) where employee wages are up to ₹21,000/month.
...
- **File INC-20A** (Declaration for Commencement of Business) — mandatory before starting business operations

### Within 180 Days

- **Appoint an auditor** — file **ADT-1** with MCA within 15 days of the AGM at which the auditor is appointed. First auditor must be appointed within 30 days of incorporation
...
If your company qualifies as a Micro, Small, or Medium Enterprise, register on the [Udyam portal](/guide/udyam-msme-registration-online) to avail benefits like priority lending, reduced fees, and government tender preferences.

## Common Mistakes to Avoid

1. **Not registering DSC on MCA portal** before filing SPICe+ — leads to form rejection
2. **Choosing a name too similar** to an existing company or trademark — causes delays
3. **Incorrect NIC code** for business activity — difficult to change later
4. **Not filing INC-20A** — your company cannot commence business without it, and directors face penalties
5. **Missing DIR-3 KYC deadline** — DIN gets deactivated, requiring ₹5,000 penalty for reactivation

## Frequently Asked Questions

### How long does company registration take in India?

With SPICe+, the entire process typically takes **7–15 working days** — including DSC procurement (1–2 days), name approval (1–3 days), and incorporation approval (3–7 days). If documents are in order, some registrations complete in as few as 3–4 days.
...
There is **no minimum paid-up capital requirement** for Private Limited Companies or OPCs. You can start with as low as ₹1,000. However, authorized capital affects the MCA registration fee.
...
Yes, you can change the company name by passing a **special resolution** and filing **INC-24** with MCA. The new name must be approved through RUN. A fee of ₹1,000 applies for name reservation plus form filing fees.
...
*Company registration in India has been significantly simplified through the SPICe+ integrated process. With proper documentation and a clear understanding of the steps, you can incorporate your business digitally without visiting any government office. For related registrations, check our guides on [GST registration](/guide/gst-registration-online), [Udyam MSME registration](/guide/udyam-msme-registration-online), and [PAN card application](/guide/pan-card-apply-online).*
