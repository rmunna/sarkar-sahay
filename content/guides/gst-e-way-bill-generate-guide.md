---
title: "E-Way Bill Generate Online: Step-by-Step GST Guide"
description: >-
  Learn how to generate e-way bill online on the GST portal. Complete guide
  covering when required, validity by distance, Part A & B, and penalties.
...
An E-Way Bill (Electronic Way Bill) is a mandatory document for the movement of goods worth more than ₹50,000 under GST. It must be generated on the E-Way Bill portal before goods are transported. This guide explains when an e-way bill is required, how to generate it, validity rules, and penalties for non-compliance.

> **Disclaimer:** CitizenNest is an independent informational platform and is not affiliated with or endorsed by the Government of India. Verify details on the [official E-Way Bill portal](https://ewaybillgst.gov.in/).

## When is an E-Way Bill Required?

An e-way bill must be generated when:
- Goods worth **more than ₹50,000** are being transported
- Movement is **inter-state** or **intra-state** (most states follow ₹50,000 threshold)
- Goods are transported by **road, rail, air, or ship**

### When is E-Way Bill NOT Required?

- Goods value is **₹50,000 or less** (except for certain specified goods)
...
- Goods specified in **Annexure to Rule 138(14)** — e.g., LPG, kerosene, postal baggage, currency, used personal household effects
- Transit cargo to/from Nepal or Bhutan

### Special Cases (E-Way Bill Required Even Below ₹50,000)
...
| **Unregistered person** | Must generate if making supply exceeding ₹50,000 (or get recipient to generate) |

## How to Generate E-Way Bill Online: Step-by-Step

### Prerequisites
- Valid **GSTIN** and registration on the [E-Way Bill portal](https://ewaybillgst.gov.in/)
- **Invoice/bill of supply/challan** details
- **Transport details** (vehicle number or transporter ID)

### Step 1: Register and Log In
1. Visit [https://ewaybillgst.gov.in/](https://ewaybillgst.gov.in/)
2. If first time, click **Registration → E-Way Bill Registration**
3. Enter your **GSTIN** — details auto-populate from the GST portal
4. Complete **OTP verification** and set username/password
5. Log in with your credentials

### Step 2: Generate New E-Way Bill
1. Click **Generate New** from the left menu (or E-Way Bill → Generate New)
...
2. Select **Document Type** — Tax Invoice, Bill of Supply, Bill of Entry, Challan, or Others
3. Enter **Document Number** and **Document Date**
4. Enter **From** details — GSTIN, name, address, state, pin code
5. Enter **To** details — GSTIN (if registered), name, address, state, pin code
...
7. Select **Transport Mode** — Road, Rail, Ship, Air
...
3. For rail/air/ship — enter **Railway Receipt/Airway Bill/Bill of Lading** number and date
...
1. Log in to [E-Way Bill portal](https://ewaybillgst.gov.in/)
...
| Violation | Penalty |
|---|---|
| Moving goods without e-way bill | **₹10,000 or tax sought to be evaded**, whichever is higher |
...
1. Go to **Consolidated EWB → Generate New**
...
1. **Always verify Part B** — An e-way bill without Part B is not valid for movement
2. **Update vehicle number** if it changes during transit using the **Update Vehicle Number** option
3. **Keep a printed copy** or e-copy on your mobile — officers may check during transit
4. **Generate before movement** — The e-way bill must be generated before goods start moving
5. **Check state-specific rules** — Some states have lower thresholds (e.g., ₹1 lakh for some states for intra-state)
...
E-way bill is required when the value of goods exceeds **₹50,000** in a single consignment. Some states may have different thresholds for intra-state movement.
...
Yes, if the value exceeds ₹50,000. The principal can generate the e-way bill for goods sent to a job worker under a delivery challan.
