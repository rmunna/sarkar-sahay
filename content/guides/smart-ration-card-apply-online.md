...
- **Portability** — collect rations from any FPS in India under [One Nation One Ration Card (ONORC)](/guide/one-nation-one-ration-card-onorc)
...
> For a detailed walkthrough of the application process, see our [Ration Card Apply Online Guide](/guide/ration-card-apply-online).

### Step 2: Register and Fill the Application

1. Create an account using your **mobile number** and **Aadhaar OTP**
2. Fill in household details — head of family, all members, address
3. Select ration card category (AAY / PHH / NPHH based on eligibility)
4. Enter **Aadhaar numbers of all family members** (mandatory for smart card issuance)
...
After submission, you receive a reference number. Track your application status on the same portal or via the [NFSA portal](https://nfsa.gov.in).

> Check our [Ration Card Status, Download & Update Guide](/guide/ration-card-status-download-update) for tracking instructions.
...
1. **Aadhaar seeding** — Ensure all family members' Aadhaar numbers are linked to your ration card (see below)
2. **Biometric verification** — Visit your FPS or a designated centre for one-time biometric capture
3. **Data correction** — Fix any spelling errors, wrong details via your state portal or CSC (Common Service Centre)
...
> You need a valid [Aadhaar card](/guide/aadhaar-card-apply-online) for all family members. If any member doesn't have Aadhaar, apply for it first.

### Check Aadhaar Seeding Status

Visit the **NFSA portal** → [nfsa.gov.in](https://nfsa.gov.in) → "Know Your Ration Card Details" → Enter your state and ration card number to see if Aadhaar is linked.
...
1. Visit your designated FPS (or any FPS under ONORC)
2. The dealer enters your ration card number or scans it
3. You authenticate using **fingerprint or iris scan** on the ePoS device
4. The machine displays your **entitlement** (quantity and type of grains)
5. Grains are dispensed and the transaction is recorded digitally
...
1. **NFSA Portal:** Visit [nfsa.gov.in](https://nfsa.gov.in) → "Know Your Entitlement" → Select state, district, FPS
2. **IMPDS Portal:** Visit [impds.nic.in](https://impds.nic.in) for Integrated Management of PDS data — transaction history and portability details
3. **State Portal:** Each state portal has a section to check entitlement and distribution records
4. **Mera Ration App:** Download the official "Mera Ration" mobile app (available on Google Play) to check entitlement, find nearby FPS, and view transaction history

## Adding or Removing Family Members

### To Add a Member

1. Log into your state food portal
2. Navigate to "Add Member" or "Modify Ration Card"
3. Enter the new member's details — name, age, relationship, Aadhaar number
4. Upload supporting documents (birth certificate for newborn, marriage certificate for spouse)
...
- **Nationwide portability** — Collect rations from any FPS in India via [ONORC](/guide/one-nation-one-ration-card-onorc), especially useful for migrant workers
...
> The exact status changes frequently. Check [impds.nic.in](https://impds.nic.in) for the latest state-wise data on ePoS transactions and ONORC portability.
...
Yes, Aadhaar seeding is mandatory for all family members to receive subsidised grains under NFSA. If a member doesn't have Aadhaar, they should [apply for one](/guide/aadhaar-card-apply-online) immediately. Temporary provisions exist for those awaiting Aadhaar.

### Can I collect rations from any Fair Price Shop in India?

Yes, under the **One Nation One Ration Card (ONORC)** scheme, you can collect your entitled grains from any ePoS-enabled FPS across India. This is particularly beneficial for migrant workers. Learn more in our [ONORC guide](/guide/one-nation-one-ration-card-onorc).
...
Visit [nfsa.gov.in](https://nfsa.gov.in), click on "Know Your Ration Card Details," select your state, and enter your ration card number. The portal shows Aadhaar seeding status for each family member.
...
Processing time varies by state — typically **15 to 45 days** from application submission. You can track status on your state portal or [check your ration card status online](/guide/ration-card-status-download-update).
