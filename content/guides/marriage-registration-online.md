...
readingTime: "7 min"
officialLinks:
  - https://marriageregistration.irctc.co.in
  - https://igrsup.gov.in
...
- **Special Marriage Act, 1954** — for inter-faith marriages and civil marriages
...
- **No religion restriction** — applicable to all
...
### Mandatory Documents
- **[Aadhaar card](/guide/aadhaar-card-apply-online)** of both bride and groom
- **Age proof** — birth certificate, school certificate, or passport
- **Address proof** — Aadhaar, voter ID, or utility bill
- **Passport-size photographs** — 2-4 each of bride and groom (joint photo may also be required)
...
- **Witness identity proof** — [Aadhaar](/guide/aadhaar-card-apply-online) or Voter ID of **2-3 witnesses**
- **Divorce decree** (if previously married)
- **Death certificate** of former spouse (if widowed)
- **No Objection Certificate** from parents (in some states) — see our [NOC guide](/guide/no-objection-certificate-noc)
...
1. Create an account on the portal (if new user)
2. Log in with your credentials
3. Select **"Marriage Registration"** service

### Step 3: Fill the Application Form
1. Enter **groom's details** — name, DOB, religion, occupation, address
2. Enter **bride's details** — same information
3. Enter **marriage details** — date, place, and type of marriage
4. Enter **witness details** — name, age, address, and relationship (minimum 2-3)
5. Upload **required documents** (scanned copies)

### Step 4: Pay the Fee
- Pay the registration fee online via **net banking, debit/credit card, or UPI**
- Fee varies by state (typically ₹100-500)
...
1. Visit on the appointed date with **all original documents**
2. Both parties and witnesses must be present
3. The Sub-Registrar will verify documents and identities
4. Sign the marriage register
5. Under Special Marriage Act, there's a **30-day notice period** before the final registration
...
|-------|-----------------|------------------|
| Delhi | ₹100-200 | ₹50 |
| Uttar Pradesh | ₹100-500 | ₹50 |
| Maharashtra | ₹100-200 | ₹50 |
| Karnataka | ₹500 | ₹100 |
| Tamil Nadu | ₹100 | ₹50 |
| West Bengal | ₹100 | ₹25 |
...
1. **Register within 1 year** of marriage to avoid extra documentation and potential court orders
2. **Keep multiple copies** of the marriage certificate — you'll need it for many government services
3. **Upload clear documents** — blurry scans cause rejection
4. **Ensure witness availability** on the appointment date — their physical presence is mandatory
5. **Special Marriage Act** requires a 30-day notice period — plan accordingly for inter-faith marriages
...
Yes, NRIs can register marriages performed in India. They may also register at Indian consulates abroad. The [passport](/guide/tatkal-passport-apply) or OCI card is required as additional ID proof.
