...
1. **Immigration ease** — Airport officers are more familiar with OCI cards
2. **No confusion** — Some banks and institutions may not recognize old PIO cards
3. **Updated records** — Your details get linked to your current passport
4. **Digital tracking** — OCI is digitally linked in the immigration system
5. **Re-issue benefits** — Future changes (passport renewal, name change) are easier with OCI
...
Go to [ociservices.gov.in](https://ociservices.gov.in) and register or log in to your account.
...
- Enter your personal information — name, date of birth, nationality
- Current foreign passport details
- **PIO card details** — card number, date of issue, place of issue
...
- **Passport-size photograph** (as per specifications — white background, 2x2 inches)
- **Signature** scan
...
- **PIO cards do not need renewal** — They are deemed lifelong OCI now
- **No deadline for conversion** — You can convert anytime, there is no last date
- **Children born to PIO holders** should apply for fresh OCI (not conversion)
- **If PIO card is lost** — Apply for fresh OCI with a police report and declaration
