...
keywords:
  ...
  - ration card for new family
  - ration card split after marriage
  - divide ration card
  - ration card separation
  - new ration card married
  - ration card split process
  - ration card split documents
...
# Ration Card Split: How to Get Separate Card for New Family
...
1. **After marriage** — married son/daughter setting up a separate household
2. **Family separation** — joint family splitting into nuclear families
3. **Separate kitchen** — family members living in the same house but maintaining separate kitchens
4. **Death of head of family** — surviving members forming new households
5. **Divorce/separation** — spouse setting up an independent household
...
- Must have [Aadhaar card](/guide/aadhaar-card-apply-online) for all members of the new family
...
| Separate kitchen declaration | Affidavit on stamp paper (₹10-50) |
...
3. **Attach all documents** — photocopies of Aadhaar, marriage certificate, income certificate, address proof
4. **Get the NOC** signed by the existing card holder
5. **Submit the form** at the Tehsil/Taluk/Food & Supply office
6. **Field verification** — a supply inspector will visit your address to verify the separate kitchen/household
...
| Affidavit/declaration | ₹10-50 (stamp paper) |
| Income certificate | Free to ₹50 |
| Processing fee | Free to ₹5 (varies by state) |

## Important Tips

1. **Women as head** — Under NFSA, the eldest woman (18+) in the new family should be the head of household on the new ration card
2. **Aadhaar linking** is mandatory — ensure all members have Aadhaar before applying
3. **Income certificate** determines your card category (BPL/PHH/AAY). Get it from the Tehsildar before applying
4. **Field verification** is the most common bottleneck — ensure someone is present at the address when the inspector visits
5. If applying online, keep scanned copies under 200KB per document (JPG/PDF format)

## Frequently Asked Questions

### Q1. Can I split my ration card without the consent of the existing card holder?
...
Yes, if your income qualifies for BPL/PHH category. You will need to submit a fresh income certificate. Check the [ration card eligibility guide](/guide/ration-card-eligibility-income) for income limits.
