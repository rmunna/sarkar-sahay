...
This guide walks you through the complete trademark registration process in India — from understanding what qualifies as a trademark to filing your application on the IP India portal and receiving your registration certificate.
...
- **Word Mark** — A brand name in plain text (e.g., "Amul", "Tata"). Protects the word itself regardless of font or style.
- **Logo / Device Mark** — A graphical symbol, emblem, or design (e.g., the Apple logo). Protects the visual identity.
- **Combined Mark** — A combination of word and logo elements together.
- **Sound Mark** — A unique sound associated with a brand (e.g., the Yahoo! yodel). Must be represented in musical notation or sonogram.
- **Shape Mark / 3D Mark** — The distinctive shape of a product or its packaging (e.g., the Coca-Cola bottle shape).
- **Colour Mark** — A specific colour or combination of colours used distinctively in branding.

> **Tip:** If you are just starting out, file a word mark first — it offers the broadest protection since it covers the name in any style or font.
...
- **Classes 1–34** — Goods (e.g., chemicals, clothing, electronics, food products)
- **Classes 35–45** — Services (e.g., advertising, education, legal services, IT services)
...
1. Visit the **Trade Mark Registry Public Search** portal at [tmrsearch.ipindia.gov.in](https://tmrsearch.ipindia.gov.in/eregister/eregister.aspx)
2. Select **National/IRDI Number** or **Wordmark** search
3. Enter your proposed trademark name
4. Filter by relevant class(es)
5. Review results — check for identical or phonetically similar marks
...
1. Go to [ipindiaonline.gov.in](https://ipindiaonline.gov.in/eregister/eregister.aspx)
2. Click on **New User Registration**
3. Fill in your details — name, email, mobile number, and address
4. Verify your email and mobile via OTP
5. Set a password and log in
...
1. Log in to the IP India e-filing portal
2. Select **Trade Marks** → **Apply for Trademark (Form TM-A)**
3. Fill in the application details:
   - **Applicant name and address** — Individual, company, partnership, or LLP
   - **Type of mark** — Word, logo, combined, sound, etc.
   - **Trademark representation** — Upload your logo (if applicable) in JPEG format
   - **Goods/Services description** — Specify the exact goods or services
   - **Class(es)** — Select the appropriate Nice Classification class(es)
   - **User date** — The date from which you have been using the mark (if applicable)
   - **Priority claim** — If filing based on a foreign application (Convention filing)
...
- **Logo/mark representation** — JPEG format, minimum 5 cm × 5 cm, maximum 8 cm × 8 cm
- **Signed Form TM-48** — Power of Attorney (if filing through a trademark agent or attorney)
- **MSME/Startup certificate** — For availing reduced fees (DPIIT recognition certificate or Udyam registration)
- **Proof of use** — Invoices, packaging, advertisements (if claiming prior use)

If you have DPIIT startup recognition, check out our guide on [Startup India DPIIT Registration](/guide/startup-india-dpiit-registration) to ensure your certificate is valid.
...
| Other entities (Company, LLP, Trust, etc.) | ₹9,000 |

**Key points about fees:**

- Fees are charged **per class** — filing in 3 classes costs 3× the fee
- **Startups** recognised under DPIIT and **small enterprises** registered under MSME get 50% concession
- Physical filing attracts higher fees (₹5,000 and ₹10,000 respectively) — always prefer online filing
...
A trademark examiner reviews your application within **30–60 days** of filing. The examiner checks for:
...
- **Accepted** — The mark proceeds to publication
- **Objected** — The examiner raises objections in an Examination Report. You must respond within **30 days** or attend a hearing
...
The ™ symbol can be used from the date of filing, but the **® symbol** may only be used after the registration certificate is granted.

## Timeline for Trademark Registration

| Stage | Estimated Duration |
|-------|--------------------|
| Filing to examination | 30–60 days |
| Response to objections (if any) | 30 days (extendable) |
| Publication in Journal | 4 months |
| Opposition period | 4 months |
| Registration (if no opposition) | 2–3 months after publication |
| **Total (no objections/opposition)** | **12–18 months** |
...
- Renewal fee: ₹9,000 (online) for individuals/startups, ₹18,000 for others
...
- **Legal protection** — Exclusive right to use the mark across India
- **Deterrence** — Use of ® symbol deters infringers
- **Asset value** — Registered trademarks can be licensed, franchised, or sold
- **E-commerce protection** — Required for brand registry on Amazon, Flipkart, etc.
- **Global expansion** — Serves as basis for international filings under the Madrid Protocol

## Related Guides

- [Company Registration on MCA Portal](/guide/company-registration-mca-online) — Register your company before filing a trademark
- [Startup India DPIIT Registration](/guide/startup-india-dpiit-registration) — Get DPIIT recognition to avail reduced trademark fees
- [GST Registration Online](/guide/gst-registration-online) — GST registration is essential for businesses selling goods or services
...
The typical timeline is **12 to 18 months** if there are no objections or oppositions. If the examiner raises objections or a third party files opposition, it can take longer — sometimes 2 to 3 years.

### What is the difference between ™ and ® symbols?

The **™ symbol** can be used by anyone to indicate a claim to a trademark, even without registration. The **® symbol** can only be used after the trademark is officially registered. Using ® without registration is an offence under the Trade Marks Act.
