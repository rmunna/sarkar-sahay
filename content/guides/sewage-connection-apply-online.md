---
title: "How to Apply for Sewage Connection Online"
description: "Step-by-step guide to apply for municipal sewage or drainage connection online in India. Documents required, fees, process, and timeline."
category: "Utilities"
keywords: ["sewage connection apply", "drainage connection", "municipal sewage", "sewer connection online", "nagar nigam sewage"]
readingTime: "5 min"
officialLinks:
...
- **Mandatory for building approval** — new constructions must have sewage provision
- **Hygiene and health** — prevents waterborne diseases
- **Legal requirement** — open drainage is penalized under municipal laws
- **Property value** — proper sewage increases property value
- **Environment** — prevents groundwater and soil pollution
...
1. **Application form** — from municipal corporation office or website
2. **Property ownership proof** — sale deed, registry, or allotment letter
3. **Building plan approval** — sanctioned plan from municipal authority
4. **Identity proof** — Aadhaar card, voter ID, or passport
5. **Property tax receipt** — latest paid receipt
6. **NOC from neighbours** (in some municipalities) — if sewer line passes through adjacent property
7. **Plumber's certificate** — certifying internal drainage is as per standards
8. **Site plan** — showing proposed connection point to the main sewer line
...
- Enter property details — ward number, property ID, address
- Owner details — name, contact, Aadhaar number
- Connection type — domestic, commercial, or industrial
...
Pay the processing fee online through net banking, UPI, or card payment. Fees vary from ₹200 to ₹2,000 depending on the city and connection type.
...
| Connection charges | ₹2,000 – ₹10,000 |
| Road cutting charges | ₹1,000 – ₹5,000 |
| Inspection fee | ₹100 – ₹500 |
| Refundable security deposit | ₹500 – ₹2,000 |
...
- **Domestic connection** — for houses, flats, apartments
- **Commercial connection** — for shops, offices, restaurants, hotels
- **Industrial connection** — for factories (requires pollution control board NOC)
- **Bulk connection** — for housing societies and complexes

## Important Rules

- **Do not connect** rainwater drains to the sewage line — these are separate systems
