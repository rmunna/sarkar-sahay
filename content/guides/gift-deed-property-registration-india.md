---
title: "Gift Deed for Property in India — Process, Stamp Duty & Tax Implications"
description: "Complete guide to property transfer via gift deed in India. Stamp duty rates, tax under Section 56, registration process and documents."
category: "Property & Legal"
keywords: ["gift deed for property", "gift deed registration", "stamp duty on gift deed", "property gift tax India", "Section 56 gift tax", "gift deed format", "property transfer to relative"]
readingTime: "10 min"
...
A **gift deed** is a legal document used to transfer ownership of immovable property (land, house, flat) from one person (donor) to another (donee) **without any monetary consideration** — i.e., as a gift. Under Indian law, a gift of immovable property must be:
...
- Must act **voluntarily** — gifts made under coercion/fraud are void
- Can be an individual, HUF karta, or any person competent to contract

### Donee (Person Receiving)
- Can be **any person** — relative or non-relative
...
- **Proof of relationship** (if claiming relative exemption) — birth certificate, marriage certificate, family tree
...
## Stamp Duty on Gift Deed — State-Wise Rates
...
| **Karnataka** | ₹5,000 (fixed, to family) | 5.6% of market value |
| **Delhi** | 4% (male) / 2% (female) | 6% (male) / 4% (female) |
| **Uttar Pradesh** | ₹5,000-₹10,000 (to blood relatives) | 7% of circle rate |
...
## Tax Implications of Gift Deed — Section 56(2)(x)
...
### Gifts from Non-Relatives — Taxable
If the donor is **not a relative**, and the **stamp duty value** of the property exceeds **₹50,000**, the **entire stamp duty value** is taxable as **"Income from Other Sources"** in the hands of the donee.

### Key Tax Points

| Scenario | Tax Treatment |
|----------|--------------|
| Gift from relative | **Exempt** — no limit |
| Gift on marriage | **Exempt** (from anyone) |
| Gift from non-relative (value ≤ ₹50,000) | **Exempt** |
| Gift from non-relative (value > ₹50,000) | **Fully taxable** as income |
...
1. **Always get a lawyer** to draft the gift deed — errors in the deed can lead to legal complications
2. **Verify the property title** is clear before gifting — check for encumbrances, pending litigation, and unpaid taxes. See our [property title verification guide](/guide/property-title-verification-search)
3. **Keep proof of relationship** ready if claiming stamp duty concession for relatives
4. **Complete mutation** after registration — the gift deed alone doesn't update revenue records
5. **Consider tax implications carefully** — gifts to non-relatives can attract heavy tax liability for the donee
...
Yes, stamp duty is payable in all cases, but most states offer **significantly reduced rates** for gifts to close relatives (blood relations). Some states like Karnataka charge a nominal fixed amount (₹5,000) for family gifts.
