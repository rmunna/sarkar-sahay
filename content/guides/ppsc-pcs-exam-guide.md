...
# Punjab PCS Exam Guide — Punjab Public Service Commission (PPSC)
...
- **Punjab PCS (Combined Competitive Exam)** — Deputy Commissioner, ETO, DSP, BDPO, Tehsildar
- **Sub Divisional Engineer** — Engineering posts
- **Punjab Police** — DSP and other police recruitment
- **Other Posts** — Naib Tehsildar, Cooperative Inspector, and various departmental posts
...
- Paper 2 qualifying (33% minimum) — only Paper 1 counts for cutoff
...
- **Merit Papers Total:** 1000 marks (Papers 3–7)
...
- Current events — national and Punjab
- History — Indian and Punjab history
- Geography — Indian and Punjab
- Polity — Indian Constitution, Punjab governance
- Economy — Indian and Punjab economy
- Science & Technology
...
1. Visit [www.ppsc.gov.in](https://www.ppsc.gov.in)
...
| Category | Fee |
|----------|-----|
| General | ₹1500 (Prelims) + ₹750 (Mains) |
| SC/ST/PwD/Ex-Servicemen (Punjab) | ₹375 (Prelims) + ₹375 (Mains) |

**Payment Mode:** Online via Net Banking, Debit Card, Credit Card

## Important Dates Pattern

- **Notification:** Generally released annually or every 1–2 years
- **Prelims:** 2–4 months after application deadline
- **Mains:** 4–6 months after prelims result
...
Prelims has 1/4 negative marking — stricter than many other PSCs. Attempt selectively.
...
| Sikh History | J.S. Grewal — The Sikhs of the Punjab |
...
Punjab PCS typically advertises 100–350 posts per notification, covering Group A and B services.
...
Punjab PCS officers (Group A) start at approximately ₹56,100 basic pay per month plus DA, HRA, and allowances. Total monthly compensation is ₹75,000–₹95,000 initially.
