---
title: "National Scholarship Portal (NSP) — How to Apply & Benefits"
...
# National Scholarship Portal (NSP) — Registration, Application & Renewal Guide
...
NSP ([scholarships.gov.in](https://scholarships.gov.in)) was launched by the Ministry of Electronics and Information Technology (MeitY) to provide a single unified platform for students to discover and apply for scholarships. The portal ensures transparent, efficient, and timely disbursement of scholarship amounts directly to beneficiary bank accounts via DBT (Direct Benefit Transfer).
...
- **Family Income:** Varies per scheme (typically ₹1 lakh to ₹8 lakh per annum)
...
1. **Pre-Matric Scholarships** — For students in Classes 1 to 10
2. **Post-Matric Scholarships** — For students in Class 11 onwards (including UG, PG, PhD)
3. **Merit-Cum-Means Scholarships** — Based on both academic merit and financial need
4. **Top Class Scholarships** — For SC/ST students in premier institutions
...
1. **Visit the NSP Portal** — Go to [scholarships.gov.in](https://scholarships.gov.in)
2. **New Registration** — Click "New Registration" and read the guidelines
3. **Fill Registration Form** — Enter your name (as per Aadhaar), date of birth, mobile number, email, and bank details
4. **OTP Verification** — Verify via OTP sent to your registered mobile number
5. **Get Application ID** — Note down your Application ID and password
6. **Login** — Use your Application ID and password to log in
7. **Fill Application Form** — Select the scholarship scheme and fill in academic, personal, and income details
8. **Upload Documents** — Upload scanned copies of all required documents (JPEG/PDF, under 200 KB each)
9. **Submit Application** — Review all details carefully and submit
10. **Institute Verification** — Your institute verifies the application
11. **District/State Verification** — Nodal officers at district/state level verify and approve
12. **Track Status** — Check application status via "Track Your Application" on the portal
...
- **Pre-Matric:** ₹1,000 to ₹6,000 per annum
- **Post-Matric:** ₹3,000 to ₹25,000+ per annum (includes tuition + maintenance)
- **Merit-Cum-Means:** Up to ₹20,000 per annum
- **Top Class:** Full tuition + maintenance allowance at premier institutions

## Important Tips

1. **Apply Early** — Don't wait until the last date. Server traffic increases near deadlines, causing issues.
2. **Aadhaar-Bank Linking** — Ensure your Aadhaar is seeded/linked to your bank account for DBT.
3. **Correct Details** — Name on Aadhaar, bank account, and college records must match exactly.
4. **Institute Verification** — Follow up with your college's scholarship nodal officer to ensure timely verification.
5. **Keep Documents Ready** — Scan all documents in advance in the required format and size.
...
Log in to [scholarships.gov.in](https://scholarships.gov.in) with your Application ID or use the "Track Your Application" feature. You can also call the NSP helpline at 0120-6619540.
...
*Last updated: February 2026. Information is based on official NSP guidelines. Always verify current details on [scholarships.gov.in](https://scholarships.gov.in).*
