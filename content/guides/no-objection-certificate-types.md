...
This guide covers all major types of NOCs, when you need them, and how to obtain each one. For a detailed process guide on the most common NOC applications, see our [NOC application guide](/guide/noc-certificate-apply).
...
### How to Get
1. Apply online on [parivahan.gov.in](https://parivahan.gov.in) or visit RTO
...
- Different from [Police Clearance Certificate (PCC)](/guide/police-clearance-certificate) which is for international purposes
