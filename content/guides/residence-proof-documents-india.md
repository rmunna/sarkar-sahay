---
title: "Residence Proof Documents in India — Complete List and How to Get Them"
description: "Comprehensive list of valid residence proof documents accepted in India for Aadhaar, passport, bank, and government services with tips on how to obtain each."
category: "Certificates"
keywords: ["residence proof India", "address proof documents", "valid address proof", "address proof for Aadhaar", "address proof for passport", "residence certificate"]
readingTime: "8 min"
officialLinks:
  - https://uidai.gov.in
...
- **Aadhaar card** enrolment and address update — see our [Aadhaar guide](/guide/aadhaar-card-apply-online)
- **PAN card** application — see our [PAN guide](/guide/pan-card-apply-online)
- **Passport** application — see our [passport guide](/guide/passport-apply-online)
...
### 1. Aadhaar Card
- **Most widely accepted** address proof in India
- Accepted by: All government services, banks, telecom, etc.
- Issued by: UIDAI
- How to get: [Aadhaar application guide](/guide/aadhaar-card-apply-online)
- Update address: [Aadhaar address change guide](/guide/aadhaar-address-change-online)

### 2. Voter ID Card (EPIC)
- Issued by: Election Commission of India
- Accepted by: Government services, banks, passport office
- How to get: Apply at [voters.eci.gov.in](https://voters.eci.gov.in) using Form 6
- Processing: 15-30 days

### 3. Passport
- Issued by: Ministry of External Affairs
- Accepted by: All organizations
- How to get: [Passport application guide](/guide/passport-apply-online)
...
- How to get: Apply at [parivahan.gov.in](https://parivahan.gov.in)
...
- **Landlord NOC** on stamp paper — see our [NOC guide](/guide/noc-certificate-apply)
- Some Aadhaar centres accept **consent letter from head of family**

### For NRIs
- **Overseas address proof** — Foreign passport, utility bill, bank statement
- **Indian address proof** — Previous Aadhaar, property documents, family member's utility bill
...
1. **Keep Aadhaar address updated** — It's the most universally accepted document; update whenever you move
2. **Utility bills in your name** — When possible, get at least one utility connection in your name
3. **Register your rent agreement** — Unregistered agreements are weak address proof
4. **DigiLocker** — Store digital copies of address proof documents in [DigiLocker](https://www.digilocker.gov.in) for easy access
5. **Maintain consistency** — Ensure your address is the same across all documents to avoid verification issues
