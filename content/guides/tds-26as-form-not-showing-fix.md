---
title: "26AS Form Not Updated? How to Fix TDS Credit Statement Issues"
description: >-
  Fix 26AS form not showing TDS credit. Learn reasons for delays, check TRACES
  portal, compare AIS vs 26AS, resolve mismatches, and file complaints online.
category: Tax & Finance
keywords:
  - 26as form not showing tds
  - 26as not updated
  - tds not reflecting in 26as
  - form 26as tds credit
  - traces portal 26as
  - ais vs 26as
  - tds mismatch 26as
  - 26as form download
  - tds credit statement fix
  - 26as not showing salary tds
readingTime: 8 min
lastUpdated: "2026-03-06"
officialLinks:
  - "https://www.incometax.gov.in/"
  - "https://contents.tdscpc.gov.in/"
  - "https://contents.tdscpc.gov.in/en/view-26as.html"
---
...
> **Disclaimer:** CitizenNest is an independent informational platform and is not affiliated with or endorsed by the Government of India. Verify details on the [Income Tax e-Filing portal](https://www.incometax.gov.in/).
...
1. Visit [https://www.incometax.gov.in/](https://www.incometax.gov.in/)
...
1. Visit [https://contents.tdscpc.gov.in/](https://contents.tdscpc.gov.in/)
2. Log in as **Taxpayer**
3. Enter your **PAN, password, and date of birth**
4. Go to **My Account → View Form 26AS**
...
| **Feedback option** | No | Yes — you can submit feedback on incorrect entries |
| **Detail level** | Summary | More detailed and granular |
| **Access** | TRACES portal | Income Tax e-Filing portal → AIS |
| **Status** | Still active | Gradually replacing 26AS |

### How to Access AIS
1. Log in to [https://www.incometax.gov.in/](https://www.incometax.gov.in/)
...
1. Visit [TRACES portal](https://contents.tdscpc.gov.in/)
2. Log in as **Taxpayer**
3. Go to **Grievance → Register Grievance**
...
1. Visit [https://www.incometax.gov.in/](https://www.incometax.gov.in/)
2. Go to **Grievance → Submit Grievance** (or use e-Nivaran)
...
2. **Identify the mismatch** — wrong amount, wrong quarter, wrong section code
...
1. **Check 26AS quarterly** — Don't wait until ITR filing season; check after each quarter's TDS return due date
2. **Keep TDS certificates safe** — Form 16 (salary) and Form 16A (non-salary) are your proof of TDS deduction
3. **Use AIS alongside 26AS** — AIS provides more comprehensive information and allows you to flag errors
4. **PAN is critical** — Ensure your employer and all deductors have your correct PAN
5. **File ITR on time** — Even if 26AS is not fully updated, file ITR by the due date and rectify later
...
You can access 26AS through your **bank's net banking** portal (most major banks offer this service). You can also register on the Income Tax e-Filing portal — registration is free and requires only your PAN and basic details.
