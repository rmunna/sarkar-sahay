---
title: "Aadhaar Superseded? What It Means & How to Fix It"
description: >-
...
keywords:
  - aadhaar superseded meaning
  - aadhaar superseded status
  - duplicate aadhaar card
  - aadhaar merged
  - aadhaar superseded fix
  - uidai grievance
  - aadhaar deactivated
  - aadhaar number cancelled
  - aadhaar superseded resolve
  - two aadhaar cards same person
readingTime: 7 min
lastUpdated: 2026-03-06
officialLinks:
  - "https://uidai.gov.in/"
  - "https://myaadhaar.uidai.gov.in/"
  - "https://resident.uidai.gov.in/grievance-redressal"
---

## What Does Aadhaar Superseded Mean?
...
1. **Duplicate enrolment** — You enrolled for Aadhaar more than once at different centres, unknowingly or intentionally
2. **Multiple enrolments by family members** — A child was enrolled twice (once by each parent at different centres)
3. **Technical errors** — System glitches during enrolment leading to duplicate entries
4. **Biometric match detected** — UIDAI's de-duplication system matched your biometrics with another Aadhaar record
...
1. Visit [myAadhaar portal](https://myaadhaar.uidai.gov.in/)
...
You can also check by trying to download your e-Aadhaar — a superseded Aadhaar will show an error.
...
If you had two Aadhaar numbers, one will still be active. Try verifying both numbers on the [myAadhaar portal](https://myaadhaar.uidai.gov.in/) to find which one is still valid.
...
1. Visit the [UIDAI Grievance Portal](https://resident.uidai.gov.in/grievance-redressal)
...
5. Describe your issue clearly — mention that the wrong Aadhaar was superseded
...
1. Find the nearest Aadhaar Seva Kendra on [UIDAI website](https://uidai.gov.in/)
...
1. File a grievance immediately via the [UIDAI portal](https://resident.uidai.gov.in/grievance-redressal)
...
This process may take **30–90 days** depending on the complexity of the case.

## How to Update Services After Superseded Aadhaar

Once you have identified or recovered your active Aadhaar, update it in:

- **Bank accounts** — Visit your bank branch with new Aadhaar
- **PAN card** — Update via [Income Tax e-filing portal](https://www.incometax.gov.in/)
- **Mobile SIM** — Visit the telecom store with Aadhaar
...
1. **Never enrol for Aadhaar more than once** — each person is entitled to only one Aadhaar for life
2. **Keep your Aadhaar updated** — if you need changes, use the update process instead of re-enrolling
3. **Save your grievance reference number** — you'll need it to track your complaint
4. **Be patient** — UIDAI may take 30–90 days to resolve superseded cases
5. **Check Aadhaar status periodically** — especially if you enrolled at multiple centres in the past
...
No. You will use the Aadhaar number that was retained (not superseded). UIDAI does not issue new Aadhaar numbers in such cases — one of the existing numbers will remain active.

### Q3. My Aadhaar was superseded but I never applied twice. What happened?

This can happen due to biometric matching errors. Your fingerprints or iris may have matched another person's records. File a grievance with UIDAI immediately — they will re-verify your biometrics.
...
Check both numbers on the [myAadhaar verification page](https://myaadhaar.uidai.gov.in/). The one that shows "Active" or "Valid" is your retained Aadhaar.
...
*Disclaimer: CitizenNest is an independent informational platform and is not affiliated with UIDAI or the Government of India. Information is sourced from official UIDAI resources and may change. Always verify with [uidai.gov.in](https://uidai.gov.in/) for the latest updates.*
