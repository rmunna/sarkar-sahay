---
title: "PM-KUSUM Solar Pump Scheme — How to Apply, Subsidy & Eligibility"
description: "Complete guide to PM-KUSUM Yojana — get solar pumps with 60% subsidy for farmers. Learn eligibility, 3 components, how to apply, documents & state-wise status."
category: "Government Schemes"
keywords:
  - "PM-KUSUM scheme"
  - "solar pump subsidy"
  - "PM-KUSUM apply online"
  - "solar pump for farmers"
  - "KUSUM Yojana eligibility"
  - "solar pump subsidy India"
...
- **Rajasthan:** [rreclmis.energy.rajasthan.gov.in](https://rreclmis.energy.rajasthan.gov.in)
- **Maharashtra:** [kusum.mahaurja.com](https://kusum.mahaurja.com)
- **Madhya Pradesh:** [cmsolarpump.mp.gov.in](https://cmsolarpump.mp.gov.in)
- **Uttar Pradesh:** [upneda.org.in](https://upneda.org.in)
- **Haryana:** [pmkusum.hareda.gov.in](https://pmkusum.hareda.gov.in)
- **Gujarat, Punjab, Chhattisgarh, Karnataka** — Check respective state renewable energy development agency websites

You can also visit the national portal at **[pmkusum.mnre.gov.in](https://pmkusum.mnre.gov.in)** for state-wise links.

### Step 2 — Register Online

1. Visit your state's PM-KUSUM portal
2. Click on **"New Registration"** or **"Apply Online"**
3. Enter your **Aadhaar number**, mobile number, and basic details
4. Select the **component** (B or C) and desired **pump capacity**
5. Upload required documents (see below)
6. Submit the application and note down your **application ID**
...
1. **Site survey** — Vendor assesses water table depth, sun exposure, and pump placement
2. **Solar panel mounting** — Panels installed on a ground-mounted structure near the borewell or water source
3. **Pump and controller setup** — Submersible or surface pump connected with a solar controller/inverter
4. **Wiring and testing** — System wired, tested, and handed over to the farmer
5. **Commissioning** — State agency inspects and issues a certificate
...
Yes. Applications are accepted online through state nodal agency portals. Visit **[pmkusum.mnre.gov.in](https://pmkusum.mnre.gov.in)** for your state's application link. You need Aadhaar, land documents, and a bank account to apply.
...
Yes. Several banks including **SBI, Bank of Baroda, PNB,** and **Nabard-affiliated institutions** offer loans to cover the farmer's 40% contribution. You can also use your [Kisan Credit Card](/guide/kisan-credit-card-apply) for financing.
...
Visit your state's portal or **[pmkusum.mnre.gov.in](https://pmkusum.mnre.gov.in)** to start your application today.
