---
title: "SSC CGL 2026 Notification — Dates, Vacancies, Eligibility & How to Apply Online"
description: "SSC CGL 2026 notification expected in March. Check tentative dates, expected vacancies, eligibility criteria, exam pattern, and how to apply on ssc.gov.in."
...
2. Complete **One Time Registration (OTR)** on the MySSC portal or MySSC mobile app (if not already registered)
3. Log in and fill the SSC CGL 2026 application form
4. Upload required documents — photograph, signature, and other certificates
...
1. **Tier 1 — Computer-Based Test (Preliminary):** 60 minutes, 200 marks
2. **Tier 2 — Computer-Based Test (Mains):** 2 hours 15 minutes
...
1. **Start early** — Begin with NCERT books for basics in Maths, Reasoning, and General Awareness
2. **Practice previous year papers** — SSC often repeats question patterns. Solve at least 5 years of past papers
3. **Focus on speed** — Tier 1 gives only 60 minutes for the entire paper. Practice with a timer
4. **Current affairs matter** — Read a daily newspaper or follow a current affairs app for General Awareness
5. **Take mock tests weekly** — Online mock tests help you get comfortable with the computer-based format

## Frequently Asked Questions

### Q: When will SSC CGL 2026 notification come out?

The notification is expected in **March 2026** as per the SSC Calendar 2026-27. Keep checking [ssc.gov.in](https://ssc.gov.in) for the official announcement.
...
> ⚠️ **Disclaimer:** This page is based on the SSC Calendar 2026-27 and previous years' patterns. All information will be updated once the official SSC CGL 2026 notification is released. Always verify details on [ssc.gov.in](https://ssc.gov.in) before applying.
