...
const GOVT_KEYWORDS = [
  ...
  'nta', 'ugc', 'gate', 'cat ', 'clat', 'cuet', 'kvs', 'kendriya vidyalaya',
  'icai', 'chartered accountant', 'ca result', 'rbse', 'bser', 'ctet',
  'rrb ntpc', 'rrb group d', 'dsssb', 'kvs recruitment', 'navodaya',
