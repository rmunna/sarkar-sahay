# Content Backlog — Auto-Generation Queue
# Midas picks batches from here, generates via pipeline, marks done
...
- [ ] fd-calculator — FD maturity calculator
- [ ] ppf-calculator — PPF maturity calculator
- [ ] sukanya-samriddhi-calculator — SSY maturity calculator
- [ ] salary-calculator — In-hand salary calculator
- [ ] rent-receipt-generator — Rent receipt PDF generator
