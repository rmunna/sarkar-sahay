...
import { getSchemeBySlug, getHindiSchemeSlugs, getRelatedSchemes, getGuideForScheme, getSchemeDetail } from "@/lib/schemes-data";
...
export async function generateStaticParams() {
  return getHindiSchemeSlugs().map((slug) => ({ slug }));
}
