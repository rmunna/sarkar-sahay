    ...
    <>
      ...
      <div className="lg:grid lg:grid-cols-[1fr_240px] lg:gap-10">
        ...
        <article>
          ...
          {/* Affiliate CTA Box — category-aware */}
          {guide.category === "Jobs & Exams" && (
            <div className="mt-10 rounded-2xl border border-amber-200 bg-gradient-to-br from-amber-50 to-orange-50 p-6">
              <p className="text-xs font-bold uppercase tracking-widest text-amber-600 mb-1">Sponsored</p>
              <h3 className="text-lg font-bold text-gray-900 mb-1">Prepare Smarter — Free Mock Tests</h3>
              <p className="text-sm text-gray-600 mb-4">
                Thousands of government job aspirants use these platforms for free mock tests, previous year papers and
                live courses.
              </p>
              <div className="flex flex-wrap gap-3">
                <a
                  href="https://testbook.com/pass"
                  target="_blank"
                ...
                >
                  Free Study Material on Adda247
                </a>
              </div>
            </div>
          )}

          {guide.category === "Tax & Finance" && (
            <div className="mt-10 rounded-2xl border border-purple-200 bg-gradient-to-br from-purple-50 to-blue-50 p-6">
              <p className="text-xs font-bold uppercase tracking-widest text-purple-600 mb-1">Sponsored</p>
              <h3 className="text-lg font-bold text-gray-900 mb-1">Open a Free Zero-Commission Demat Account</h3>
              <p className="text-sm text-gray-600 mb-4">
